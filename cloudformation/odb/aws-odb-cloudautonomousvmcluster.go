...
// CloudAutonomousVmCluster AWS CloudFormation Resource (AWS::ODB::CloudAutonomousVmCluster)
...
type CloudAutonomousVmCluster struct {
	...
	// AutonomousDataStorageSizeInTBs AWS CloudFormation Property
	// Required: false
	...
	// CpuCoreCountPerNode AWS CloudFormation Property
	// Required: false
	...
	IamRoles []CloudAutonomousVmCluster_IamRole `json:"IamRoles,omitempty"`

	// IsMtlsEnabledVmCluster AWS CloudFormation Property
	// Required: false
	...
	// MemoryPerOracleComputeUnitInGBs AWS CloudFormation Property
	// Required: false
	...
	// ScanListenerPortNonTls AWS CloudFormation Property
	// Required: false
	...
	// ScanListenerPortTls AWS CloudFormation Property
	// Required: false
	...
	// TotalContainerDatabases AWS CloudFormation Property
	// Required: false
...
func (r *CloudAutonomousVmCluster) AWSCloudFormationType() string {
	return "AWS::ODB::CloudAutonomousVmCluster"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CloudAutonomousVmCluster) MarshalJSON() ([]byte, error) {
	type Properties CloudAutonomousVmCluster
...
func (r *CloudAutonomousVmCluster) UnmarshalJSON(b []byte) error {
	type Properties CloudAutonomousVmCluster
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CloudAutonomousVmCluster(*res.Properties)
	}
