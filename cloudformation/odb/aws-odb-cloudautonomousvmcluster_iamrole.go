...
// CloudAutonomousVmCluster_IamRole AWS CloudFormation Resource (AWS::ODB::CloudAutonomousVmCluster.IamRole)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-odb-cloudautonomousvmcluster-iamrole.html
type CloudAutonomousVmCluster_IamRole struct {
...
func (r *CloudAutonomousVmCluster_IamRole) AWSCloudFormationType() string {
	return "AWS::ODB::CloudAutonomousVmCluster.IamRole"
}
