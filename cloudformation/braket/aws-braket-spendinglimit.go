...
type SpendingLimit struct {
	...
	// SpendingLimit AWS CloudFormation Property
	// Required: true
	...
	TimePeriod *SpendingLimit_TimePeriod `json:"TimePeriod,omitempty"`
...
func (r *SpendingLimit) AWSCloudFormationType() string {
	return "AWS::Braket::SpendingLimit"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SpendingLimit) MarshalJSON() ([]byte, error) {
	type Properties SpendingLimit
...
func (r *SpendingLimit) UnmarshalJSON(b []byte) error {
	type Properties SpendingLimit
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SpendingLimit(*res.Properties)
	}
