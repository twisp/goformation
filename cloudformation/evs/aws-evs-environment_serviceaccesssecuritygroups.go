...
// Environment_ServiceAccessSecurityGroups AWS CloudFormation Resource (AWS::EVS::Environment.ServiceAccessSecurityGroups)
...
func (r *Environment_ServiceAccessSecurityGroups) AWSCloudFormationType() string {
	return "AWS::EVS::Environment.ServiceAccessSecurityGroups"
}
