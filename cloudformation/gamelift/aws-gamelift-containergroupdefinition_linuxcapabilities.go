...
// ContainerGroupDefinition_LinuxCapabilities AWS CloudFormation Resource (AWS::GameLift::ContainerGroupDefinition.LinuxCapabilities)
...
type ContainerGroupDefinition_LinuxCapabilities struct {
...
func (r *ContainerGroupDefinition_LinuxCapabilities) AWSCloudFormationType() string {
	return "AWS::GameLift::ContainerGroupDefinition.LinuxCapabilities"
}
