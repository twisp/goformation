...
// Fleet_PlayerGatewayConfiguration AWS CloudFormation Resource (AWS::GameLift::Fleet.PlayerGatewayConfiguration)
...
type Fleet_PlayerGatewayConfiguration struct {

	// GameServerIpProtocolSupported AWS CloudFormation Property
	// Required: false
...
func (r *Fleet_PlayerGatewayConfiguration) AWSCloudFormationType() string {
	return "AWS::GameLift::Fleet.PlayerGatewayConfiguration"
}
