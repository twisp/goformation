...
// RegistryScanningConfiguration AWS CloudFormation Resource (AWS::ECR::RegistryScanningConfiguration)
...
type RegistryScanningConfiguration struct {
	...
	Rules []RegistryScanningConfiguration_ScanningRule `json:"Rules"`
...
func (r *RegistryScanningConfiguration) AWSCloudFormationType() string {
	return "AWS::ECR::RegistryScanningConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RegistryScanningConfiguration) MarshalJSON() ([]byte, error) {
	type Properties RegistryScanningConfiguration
...
func (r *RegistryScanningConfiguration) UnmarshalJSON(b []byte) error {
	type Properties RegistryScanningConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = RegistryScanningConfiguration(*res.Properties)
	}
