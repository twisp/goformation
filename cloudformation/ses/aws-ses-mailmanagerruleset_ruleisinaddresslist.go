...
// MailManagerRuleSet_RuleIsInAddressList AWS CloudFormation Resource (AWS::SES::MailManagerRuleSet.RuleIsInAddressList)
...
func (r *MailManagerRuleSet_RuleIsInAddressList) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerRuleSet.RuleIsInAddressList"
}
