...
// MailManagerTrafficPolicy_IngressStringToEvaluate AWS CloudFormation Resource (AWS::SES::MailManagerTrafficPolicy.IngressStringToEvaluate)
...
func (r *MailManagerTrafficPolicy_IngressStringToEvaluate) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerTrafficPolicy.IngressStringToEvaluate"
}
