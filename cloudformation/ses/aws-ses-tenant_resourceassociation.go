...
// Tenant_ResourceAssociation AWS CloudFormation Resource (AWS::SES::Tenant.ResourceAssociation)
...
func (r *Tenant_ResourceAssociation) AWSCloudFormationType() string {
	return "AWS::SES::Tenant.ResourceAssociation"
}
