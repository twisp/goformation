...
// MailManagerIngressPoint AWS CloudFormation Resource (AWS::SES::MailManagerIngressPoint)
...
type MailManagerIngressPoint struct {
	...
	// IngressPointConfiguration AWS CloudFormation Property
	// Required: false
	...
	// IngressPointName AWS CloudFormation Property
	// Required: false
	...
	// RuleSetId AWS CloudFormation Property
	// Required: true
	...
	// StatusToUpdate AWS CloudFormation Property
	// Required: false
	...
	// TrafficPolicyId AWS CloudFormation Property
	// Required: true
...
func (r *MailManagerIngressPoint) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerIngressPoint"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MailManagerIngressPoint) MarshalJSON() ([]byte, error) {
	type Properties MailManagerIngressPoint
...
func (r *MailManagerIngressPoint) UnmarshalJSON(b []byte) error {
	type Properties MailManagerIngressPoint
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = MailManagerIngressPoint(*res.Properties)
	}
