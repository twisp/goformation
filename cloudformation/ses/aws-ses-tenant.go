...
// Tenant AWS CloudFormation Resource (AWS::SES::Tenant)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ses-tenant.html
type Tenant struct {

	// ResourceAssociations AWS CloudFormation Property
	// Required: false
	...
	// TenantName AWS CloudFormation Property
	// Required: true
...
func (r *Tenant) AWSCloudFormationType() string {
	return "AWS::SES::Tenant"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Tenant) MarshalJSON() ([]byte, error) {
