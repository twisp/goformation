...
// MailManagerTrafficPolicy_IngressIpv6Expression AWS CloudFormation Resource (AWS::SES::MailManagerTrafficPolicy.IngressIpv6Expression)
...
type MailManagerTrafficPolicy_IngressIpv6Expression struct {
	...
	Evaluate *MailManagerTrafficPolicy_IngressIpv6ToEvaluate `json:"Evaluate"`
...
func (r *MailManagerTrafficPolicy_IngressIpv6Expression) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerTrafficPolicy.IngressIpv6Expression"
}
