...
// MultiRegionEndpoint_RouteDetailsItems AWS CloudFormation Resource (AWS::SES::MultiRegionEndpoint.RouteDetailsItems)
...
func (r *MultiRegionEndpoint_RouteDetailsItems) AWSCloudFormationType() string {
	return "AWS::SES::MultiRegionEndpoint.RouteDetailsItems"
}
