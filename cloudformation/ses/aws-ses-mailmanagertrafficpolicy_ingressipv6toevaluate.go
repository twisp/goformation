...
// MailManagerTrafficPolicy_IngressIpv6ToEvaluate AWS CloudFormation Resource (AWS::SES::MailManagerTrafficPolicy.IngressIpv6ToEvaluate)
...
func (r *MailManagerTrafficPolicy_IngressIpv6ToEvaluate) AWSCloudFormationType() string {
	return "AWS::SES::MailManagerTrafficPolicy.IngressIpv6ToEvaluate"
}
