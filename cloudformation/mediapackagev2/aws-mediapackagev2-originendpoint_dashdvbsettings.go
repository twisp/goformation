...
// OriginEndpoint_DashDvbSettings AWS CloudFormation Resource (AWS::MediaPackageV2::OriginEndpoint.DashDvbSettings)
...
type OriginEndpoint_DashDvbSettings struct {
	...
	// ErrorMetrics AWS CloudFormation Property
	// Required: false
	...
	// FontDownload AWS CloudFormation Property
	// Required: false
...
func (r *OriginEndpoint_DashDvbSettings) AWSCloudFormationType() string {
	return "AWS::MediaPackageV2::OriginEndpoint.DashDvbSettings"
}
