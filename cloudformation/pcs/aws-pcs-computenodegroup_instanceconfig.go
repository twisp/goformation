...
// ComputeNodeGroup_InstanceConfig AWS CloudFormation Resource (AWS::PCS::ComputeNodeGroup.InstanceConfig)
...
func (r *ComputeNodeGroup_InstanceConfig) AWSCloudFormationType() string {
	return "AWS::PCS::ComputeNodeGroup.InstanceConfig"
}
