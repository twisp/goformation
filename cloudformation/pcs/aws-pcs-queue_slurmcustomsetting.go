...
// Queue_SlurmCustomSetting AWS CloudFormation Resource (AWS::PCS::Queue.SlurmCustomSetting)
...
func (r *Queue_SlurmCustomSetting) AWSCloudFormationType() string {
	return "AWS::PCS::Queue.SlurmCustomSetting"
}
