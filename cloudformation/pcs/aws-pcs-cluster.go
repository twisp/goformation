...
// Cluster AWS CloudFormation Resource (AWS::PCS::Cluster)
...
type Cluster struct {
	...
	Networking *Cluster_Networking `json:"Networking"`

	// Scheduler AWS CloudFormation Property
	// Required: true
	// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-pcs-cluster.html#cfn-pcs-cluster-scheduler
	Scheduler *Cluster_Scheduler `json:"Scheduler"`
