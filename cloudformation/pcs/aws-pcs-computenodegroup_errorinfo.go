...
// ComputeNodeGroup_ErrorInfo AWS CloudFormation Resource (AWS::PCS::ComputeNodeGroup.ErrorInfo)
...
func (r *ComputeNodeGroup_ErrorInfo) AWSCloudFormationType() string {
	return "AWS::PCS::ComputeNodeGroup.ErrorInfo"
}
