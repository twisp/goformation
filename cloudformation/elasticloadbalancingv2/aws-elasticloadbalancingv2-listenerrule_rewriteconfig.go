...
// ListenerRule_RewriteConfig AWS CloudFormation Resource (AWS::ElasticLoadBalancingV2::ListenerRule.RewriteConfig)
...
type ListenerRule_RewriteConfig struct {
	...
	// Replace AWS CloudFormation Property
	// Required: true
...
func (r *ListenerRule_RewriteConfig) AWSCloudFormationType() string {
	return "AWS::ElasticLoadBalancingV2::ListenerRule.RewriteConfig"
}
