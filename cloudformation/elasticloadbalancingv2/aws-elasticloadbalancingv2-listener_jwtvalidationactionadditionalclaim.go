...
// Listener_JwtValidationActionAdditionalClaim AWS CloudFormation Resource (AWS::ElasticLoadBalancingV2::Listener.JwtValidationActionAdditionalClaim)
...
func (r *Listener_JwtValidationActionAdditionalClaim) AWSCloudFormationType() string {
	return "AWS::ElasticLoadBalancingV2::Listener.JwtValidationActionAdditionalClaim"
}
