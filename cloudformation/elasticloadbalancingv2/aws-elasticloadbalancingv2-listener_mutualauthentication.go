...
// Listener_MutualAuthentication AWS CloudFormation Resource (AWS::ElasticLoadBalancingV2::Listener.MutualAuthentication)
...
type Listener_MutualAuthentication struct {
	...
	// IgnoreClientCertificateExpiry AWS CloudFormation Property
	// Required: false
...
func (r *Listener_MutualAuthentication) AWSCloudFormationType() string {
	return "AWS::ElasticLoadBalancingV2::Listener.MutualAuthentication"
}
