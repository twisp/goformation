...
// ComputationModel AWS CloudFormation Resource (AWS::IoTSiteWise::ComputationModel)
...
type ComputationModel struct {
	...
	// ComputationModelConfiguration AWS CloudFormation Property
	// Required: true
	...
	ComputationModelConfiguration *ComputationModel_ComputationModelConfiguration `json:"ComputationModelConfiguration"`

	// ComputationModelDataBinding AWS CloudFormation Property
	// Required: true
	...
	ComputationModelDataBinding map[string]ComputationModel_ComputationModelDataBindingValue `json:"ComputationModelDataBinding"`

	// ComputationModelDescription AWS CloudFormation Property
	// Required: false
	...
	// ComputationModelName AWS CloudFormation Property
	// Required: true
	...
	ComputationModelName string `json:"ComputationModelName"`
...
func (r *ComputationModel) AWSCloudFormationType() string {
	return "AWS::IoTSiteWise::ComputationModel"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ComputationModel) MarshalJSON() ([]byte, error) {
	type Properties ComputationModel
...
func (r *ComputationModel) UnmarshalJSON(b []byte) error {
	type Properties ComputationModel
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ComputationModel(*res.Properties)
	}
