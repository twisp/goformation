...
// Dataset AWS CloudFormation Resource (AWS::IoTSiteWise::Dataset)
...
type Dataset struct {
	...
	// DatasetSource AWS CloudFormation Property
	// Required: true
	...
	DatasetSource *Dataset_DatasetSource `json:"DatasetSource"`
