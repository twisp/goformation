...
// Dataset_DatasetSource AWS CloudFormation Resource (AWS::IoTSiteWise::Dataset.DatasetSource)
...
type Dataset_DatasetSource struct {
	...
	// SourceDetail AWS CloudFormation Property
	// Required: false
	...
	// SourceFormat AWS CloudFormation Property
	// Required: true
...
func (r *Dataset_DatasetSource) AWSCloudFormationType() string {
	return "AWS::IoTSiteWise::Dataset.DatasetSource"
}
