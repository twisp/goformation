...
// Dataset_KendraSourceDetail AWS CloudFormation Resource (AWS::IoTSiteWise::Dataset.KendraSourceDetail)
...
func (r *Dataset_KendraSourceDetail) AWSCloudFormationType() string {
	return "AWS::IoTSiteWise::Dataset.KendraSourceDetail"
}
