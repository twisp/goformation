...
// Workflow_ScheduleConfiguration AWS CloudFormation Resource (AWS::MWAAServerless::Workflow.ScheduleConfiguration)
...
func (r *Workflow_ScheduleConfiguration) AWSCloudFormationType() string {
	return "AWS::MWAAServerless::Workflow.ScheduleConfiguration"
}
