...
// Workflow_NetworkConfiguration AWS CloudFormation Resource (AWS::MWAAServerless::Workflow.NetworkConfiguration)
...
func (r *Workflow_NetworkConfiguration) AWSCloudFormationType() string {
	return "AWS::MWAAServerless::Workflow.NetworkConfiguration"
}
