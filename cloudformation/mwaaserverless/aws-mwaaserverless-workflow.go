...
// Workflow AWS CloudFormation Resource (AWS::MWAAServerless::Workflow)
...
type Workflow struct {
	...
	DefinitionS3Location *Workflow_S3Location `json:"DefinitionS3Location"`
	...
	EncryptionConfiguration *Workflow_EncryptionConfiguration `json:"EncryptionConfiguration,omitempty"`
	...
	LoggingConfiguration *Workflow_LoggingConfiguration `json:"LoggingConfiguration,omitempty"`
	...
	NetworkConfiguration *Workflow_NetworkConfiguration `json:"NetworkConfiguration,omitempty"`
...
func (r *Workflow) AWSCloudFormationType() string {
	return "AWS::MWAAServerless::Workflow"
}
