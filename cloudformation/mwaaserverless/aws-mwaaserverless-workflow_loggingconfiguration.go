...
// Workflow_LoggingConfiguration AWS CloudFormation Resource (AWS::MWAAServerless::Workflow.LoggingConfiguration)
...
func (r *Workflow_LoggingConfiguration) AWSCloudFormationType() string {
	return "AWS::MWAAServerless::Workflow.LoggingConfiguration"
}
