...
// Workflow_EncryptionConfiguration AWS CloudFormation Resource (AWS::MWAAServerless::Workflow.EncryptionConfiguration)
...
func (r *Workflow_EncryptionConfiguration) AWSCloudFormationType() string {
	return "AWS::MWAAServerless::Workflow.EncryptionConfiguration"
}
