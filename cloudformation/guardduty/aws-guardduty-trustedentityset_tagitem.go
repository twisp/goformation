...
// TrustedEntitySet_TagItem AWS CloudFormation Resource (AWS::GuardDuty::TrustedEntitySet.TagItem)
...
func (r *TrustedEntitySet_TagItem) AWSCloudFormationType() string {
	return "AWS::GuardDuty::TrustedEntitySet.TagItem"
}
