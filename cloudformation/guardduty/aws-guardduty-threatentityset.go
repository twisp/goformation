...
// ThreatEntitySet AWS CloudFormation Resource (AWS::GuardDuty::ThreatEntitySet)
...
func (r *ThreatEntitySet) AWSCloudFormationType() string {
	return "AWS::GuardDuty::ThreatEntitySet"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ThreatEntitySet) MarshalJSON() ([]byte, error) {
	type Properties ThreatEntitySet
...
func (r *ThreatEntitySet) UnmarshalJSON(b []byte) error {
	type Properties ThreatEntitySet
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ThreatEntitySet(*res.Properties)
	}
