...
// PublishingDestination AWS CloudFormation Resource (AWS::GuardDuty::PublishingDestination)
...
type PublishingDestination struct {
	...
	// DestinationProperties AWS CloudFormation Property
	// Required: true
	...
	DestinationProperties *PublishingDestination_CFNDestinationProperties `json:"DestinationProperties"`
...
func (r *PublishingDestination) AWSCloudFormationType() string {
	return "AWS::GuardDuty::PublishingDestination"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PublishingDestination) MarshalJSON() ([]byte, error) {
	type Properties PublishingDestination
...
func (r *PublishingDestination) UnmarshalJSON(b []byte) error {
	type Properties PublishingDestination
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PublishingDestination(*res.Properties)
	}
