...
// TrustedEntitySet AWS CloudFormation Resource (AWS::GuardDuty::TrustedEntitySet)
...
func (r *TrustedEntitySet) AWSCloudFormationType() string {
	return "AWS::GuardDuty::TrustedEntitySet"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TrustedEntitySet) MarshalJSON() ([]byte, error) {
	type Properties TrustedEntitySet
...
func (r *TrustedEntitySet) UnmarshalJSON(b []byte) error {
	type Properties TrustedEntitySet
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TrustedEntitySet(*res.Properties)
	}
