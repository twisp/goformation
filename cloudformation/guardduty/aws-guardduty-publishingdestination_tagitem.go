...
// PublishingDestination_TagItem AWS CloudFormation Resource (AWS::GuardDuty::PublishingDestination.TagItem)
...
func (r *PublishingDestination_TagItem) AWSCloudFormationType() string {
	return "AWS::GuardDuty::PublishingDestination.TagItem"
}
