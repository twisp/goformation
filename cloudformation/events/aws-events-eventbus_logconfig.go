...
// EventBus_LogConfig AWS CloudFormation Resource (AWS::Events::EventBus.LogConfig)
...
type EventBus_LogConfig struct {
	...
	// IncludeDetail AWS CloudFormation Property
	// Required: false
...
func (r *EventBus_LogConfig) AWSCloudFormationType() string {
	return "AWS::Events::EventBus.LogConfig"
}
