...
// Project_EnvironmentConfigurationUserParameter AWS CloudFormation Resource (AWS::DataZone::Project.EnvironmentConfigurationUserParameter)
...
type Project_EnvironmentConfigurationUserParameter struct {
	...
	// EnvironmentConfigurationName AWS CloudFormation Property
	// Required: false
	...
	// EnvironmentParameters AWS CloudFormation Property
	// Required: false
	...
	EnvironmentParameters []Project_EnvironmentParameter `json:"EnvironmentParameters,omitempty"`
...
func (r *Project_EnvironmentConfigurationUserParameter) AWSCloudFormationType() string {
	return "AWS::DataZone::Project.EnvironmentConfigurationUserParameter"
}
