...
// FormType AWS CloudFormation Resource (AWS::DataZone::FormType)
...
type FormType struct {
	...
	Model *FormType_Model `json:"Model"`
	...
	// OwningProjectIdentifier AWS CloudFormation Property
	// Required: true
	...
	OwningProjectIdentifier string `json:"OwningProjectIdentifier"`
...
func (r *FormType) AWSCloudFormationType() string {
	return "AWS::DataZone::FormType"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r FormType) MarshalJSON() ([]byte, error) {
	type Properties FormType
...
func (r *FormType) UnmarshalJSON(b []byte) error {
	type Properties FormType
	res := &struct {
		Type                string
		Properties          *Properties
