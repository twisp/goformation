...
// Connection_MlflowPropertiesInput AWS CloudFormation Resource (AWS::DataZone::Connection.MlflowPropertiesInput)
...
type Connection_MlflowPropertiesInput struct {
	...
	// TrackingServerArn AWS CloudFormation Property
	// Required: false
...
func (r *Connection_MlflowPropertiesInput) AWSCloudFormationType() string {
	return "AWS::DataZone::Connection.MlflowPropertiesInput"
}
