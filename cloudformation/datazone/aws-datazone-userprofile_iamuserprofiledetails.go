...
// UserProfile_IamUserProfileDetails AWS CloudFormation Resource (AWS::DataZone::UserProfile.IamUserProfileDetails)
...
type UserProfile_IamUserProfileDetails struct {
	...
	// GroupProfileId AWS CloudFormation Property
	// Required: false
	...
	// SessionName AWS CloudFormation Property
	// Required: false
...
func (r *UserProfile_IamUserProfileDetails) AWSCloudFormationType() string {
	return "AWS::DataZone::UserProfile.IamUserProfileDetails"
}
