...
// GroupProfile AWS CloudFormation Resource (AWS::DataZone::GroupProfile)
...
func (r *GroupProfile) AWSCloudFormationType() string {
	return "AWS::DataZone::GroupProfile"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r GroupProfile) MarshalJSON() ([]byte, error) {
...
func (r *GroupProfile) UnmarshalJSON(b []byte) error {
	type Properties GroupProfile
	res := &struct {
		Type                string
		Properties          *Properties
