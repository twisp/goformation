...
// Connection_LineageSyncSchedule AWS CloudFormation Resource (AWS::DataZone::Connection.LineageSyncSchedule)
...
func (r *Connection_LineageSyncSchedule) AWSCloudFormationType() string {
	return "AWS::DataZone::Connection.LineageSyncSchedule"
}
