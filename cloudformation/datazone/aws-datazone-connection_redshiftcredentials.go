...
// Connection_RedshiftCredentials AWS CloudFormation Resource (AWS::DataZone::Connection.RedshiftCredentials)
...
type Connection_RedshiftCredentials struct {
	...
	// UsernamePassword AWS CloudFormation Property
	// Required: false
...
func (r *Connection_RedshiftCredentials) AWSCloudFormationType() string {
	return "AWS::DataZone::Connection.RedshiftCredentials"
}
