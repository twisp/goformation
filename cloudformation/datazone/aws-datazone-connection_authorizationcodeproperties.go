...
// Connection_AuthorizationCodeProperties AWS CloudFormation Resource (AWS::DataZone::Connection.AuthorizationCodeProperties)
...
func (r *Connection_AuthorizationCodeProperties) AWSCloudFormationType() string {
	return "AWS::DataZone::Connection.AuthorizationCodeProperties"
}
