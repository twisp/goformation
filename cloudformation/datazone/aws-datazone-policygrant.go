...
// PolicyGrant AWS CloudFormation Resource (AWS::DataZone::PolicyGrant)
...
type PolicyGrant struct {
	...
	// Detail AWS CloudFormation Property
	// Required: false
...
func (r *PolicyGrant) AWSCloudFormationType() string {
	return "AWS::DataZone::PolicyGrant"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PolicyGrant) MarshalJSON() ([]byte, error) {
	type Properties PolicyGrant
...
func (r *PolicyGrant) UnmarshalJSON(b []byte) error {
	type Properties PolicyGrant
	res := &struct {
		Type                string
		Properties          *Properties
