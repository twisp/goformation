...
// DomainUnit AWS CloudFormation Resource (AWS::DataZone::DomainUnit)
...
type DomainUnit struct {
	...
	// ParentDomainUnitIdentifier AWS CloudFormation Property
	// Required: true
	...
	ParentDomainUnitIdentifier string `json:"ParentDomainUnitIdentifier"`
...
func (r *DomainUnit) AWSCloudFormationType() string {
	return "AWS::DataZone::DomainUnit"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DomainUnit) MarshalJSON() ([]byte, error) {
	type Properties DomainUnit
...
func (r *DomainUnit) UnmarshalJSON(b []byte) error {
	type Properties DomainUnit
	res := &struct {
		Type                string
		Properties          *Properties
