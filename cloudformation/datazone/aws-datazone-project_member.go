...
// Project_Member AWS CloudFormation Resource (AWS::DataZone::Project.Member)
...
func (r *Project_Member) AWSCloudFormationType() string {
	return "AWS::DataZone::Project.Member"
}
