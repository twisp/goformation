...
// Connection_AmazonQPropertiesInput AWS CloudFormation Resource (AWS::DataZone::Connection.AmazonQPropertiesInput)
...
func (r *Connection_AmazonQPropertiesInput) AWSCloudFormationType() string {
	return "AWS::DataZone::Connection.AmazonQPropertiesInput"
}
