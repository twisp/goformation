...
// PolicyGrant_DomainUnitFilterForProject AWS CloudFormation Resource (AWS::DataZone::PolicyGrant.DomainUnitFilterForProject)
...
type PolicyGrant_DomainUnitFilterForProject struct {
	...
	DomainUnit string `json:"DomainUnit"`
...
func (r *PolicyGrant_DomainUnitFilterForProject) AWSCloudFormationType() string {
	return "AWS::DataZone::PolicyGrant.DomainUnitFilterForProject"
}
