...
// PhoneNumber_MandatoryKeyword AWS CloudFormation Resource (AWS::SMSVOICE::PhoneNumber.MandatoryKeyword)
...
func (r *PhoneNumber_MandatoryKeyword) AWSCloudFormationType() string {
	return "AWS::SMSVOICE::PhoneNumber.MandatoryKeyword"
}
