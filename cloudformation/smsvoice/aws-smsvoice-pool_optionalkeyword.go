...
// Pool_OptionalKeyword AWS CloudFormation Resource (AWS::SMSVOICE::Pool.OptionalKeyword)
...
func (r *Pool_OptionalKeyword) AWSCloudFormationType() string {
	return "AWS::SMSVOICE::Pool.OptionalKeyword"
}
