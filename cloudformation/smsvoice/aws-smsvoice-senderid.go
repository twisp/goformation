...
// SenderId AWS CloudFormation Resource (AWS::SMSVOICE::SenderId)
...
func (r *SenderId) AWSCloudFormationType() string {
	return "AWS::SMSVOICE::SenderId"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SenderId) MarshalJSON() ([]byte, error) {
	type Properties SenderId
...
func (r *SenderId) UnmarshalJSON(b []byte) error {
	type Properties SenderId
	res := &struct {
		Type                string
		Properties          *Properties
