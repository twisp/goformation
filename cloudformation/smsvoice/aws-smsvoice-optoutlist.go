...
// OptOutList AWS CloudFormation Resource (AWS::SMSVOICE::OptOutList)
...
func (r *OptOutList) AWSCloudFormationType() string {
	return "AWS::SMSVOICE::OptOutList"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OptOutList) MarshalJSON() ([]byte, error) {
	type Properties OptOutList
...
func (r *OptOutList) UnmarshalJSON(b []byte) error {
	type Properties OptOutList
	res := &struct {
		Type                string
		Properties          *Properties
