...
// Pool AWS CloudFormation Resource (AWS::SMSVOICE::Pool)
...
type Pool struct {
	...
	MandatoryKeywords *Pool_MandatoryKeywords `json:"MandatoryKeywords"`
	...
	// OriginationIdentities AWS CloudFormation Property
	// Required: true
	...
	OriginationIdentities []string `json:"OriginationIdentities"`
	...
	// SharedRoutesEnabled AWS CloudFormation Property
	// Required: false
...
func (r *Pool) AWSCloudFormationType() string {
	return "AWS::SMSVOICE::Pool"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Pool) MarshalJSON() ([]byte, error) {
	type Properties Pool
...
func (r *Pool) UnmarshalJSON(b []byte) error {
	type Properties Pool
	res := &struct {
		Type                string
		Properties          *Properties
