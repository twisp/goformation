...
// ConfigurationSet_KinesisFirehoseDestination AWS CloudFormation Resource (AWS::SMSVOICE::ConfigurationSet.KinesisFirehoseDestination)
...
func (r *ConfigurationSet_KinesisFirehoseDestination) AWSCloudFormationType() string {
	return "AWS::SMSVOICE::ConfigurationSet.KinesisFirehoseDestination"
}
