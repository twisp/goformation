...
// ProtectConfiguration AWS CloudFormation Resource (AWS::SMSVOICE::ProtectConfiguration)
...
type ProtectConfiguration struct {
	...
	// CountryRuleSet AWS CloudFormation Property
	// Required: false
...
func (r *ProtectConfiguration) AWSCloudFormationType() string {
	return "AWS::SMSVOICE::ProtectConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ProtectConfiguration) MarshalJSON() ([]byte, error) {
	type Properties ProtectConfiguration
...
func (r *ProtectConfiguration) UnmarshalJSON(b []byte) error {
	type Properties ProtectConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ProtectConfiguration(*res.Properties)
	}
