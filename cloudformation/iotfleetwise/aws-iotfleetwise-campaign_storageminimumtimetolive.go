...
// Campaign_StorageMinimumTimeToLive AWS CloudFormation Resource (AWS::IoTFleetWise::Campaign.StorageMinimumTimeToLive)
...
func (r *Campaign_StorageMinimumTimeToLive) AWSCloudFormationType() string {
	return "AWS::IoTFleetWise::Campaign.StorageMinimumTimeToLive"
}
