...
// Campaign_DataPartitionUploadOptions AWS CloudFormation Resource (AWS::IoTFleetWise::Campaign.DataPartitionUploadOptions)
...
func (r *Campaign_DataPartitionUploadOptions) AWSCloudFormationType() string {
	return "AWS::IoTFleetWise::Campaign.DataPartitionUploadOptions"
}
