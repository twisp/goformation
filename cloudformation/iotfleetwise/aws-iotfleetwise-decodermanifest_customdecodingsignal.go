...
// DecoderManifest_CustomDecodingSignal AWS CloudFormation Resource (AWS::IoTFleetWise::DecoderManifest.CustomDecodingSignal)
...
func (r *DecoderManifest_CustomDecodingSignal) AWSCloudFormationType() string {
	return "AWS::IoTFleetWise::DecoderManifest.CustomDecodingSignal"
}
