...
// DecoderManifest_CustomDecodingInterface AWS CloudFormation Resource (AWS::IoTFleetWise::DecoderManifest.CustomDecodingInterface)
...
func (r *DecoderManifest_CustomDecodingInterface) AWSCloudFormationType() string {
	return "AWS::IoTFleetWise::DecoderManifest.CustomDecodingInterface"
}
