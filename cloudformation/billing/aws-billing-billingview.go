...
// BillingView AWS CloudFormation Resource (AWS::Billing::BillingView)
...
type BillingView struct {
	...
	// DataFilterExpression AWS CloudFormation Property
	// Required: false
	...
	// SourceViews AWS CloudFormation Property
	// Required: true
	...
	SourceViews []string `json:"SourceViews"`
...
func (r *BillingView) AWSCloudFormationType() string {
	return "AWS::Billing::BillingView"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BillingView) MarshalJSON() ([]byte, error) {
	type Properties BillingView
...
func (r *BillingView) UnmarshalJSON(b []byte) error {
	type Properties BillingView
	res := &struct {
		Type                string
		Properties          *Properties
