...
// LandingZone AWS CloudFormation Resource (AWS::ControlTower::LandingZone)
...
type LandingZone struct {
	...
	// RemediationTypes AWS CloudFormation Property
	// Required: false
...
func (r *LandingZone) AWSCloudFormationType() string {
	return "AWS::ControlTower::LandingZone"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LandingZone) MarshalJSON() ([]byte, error) {
	type Properties LandingZone
...
func (r *LandingZone) UnmarshalJSON(b []byte) error {
	type Properties LandingZone
	res := &struct {
		Type                string
		Properties          *Properties
