...
type Key struct {
	...
	// Exportable AWS CloudFormation Property
	// Required: true
	...
	KeyAttributes *Key_KeyAttributes `json:"KeyAttributes"`
	...
	// ReplicationRegions AWS CloudFormation Property
	// Required: false
