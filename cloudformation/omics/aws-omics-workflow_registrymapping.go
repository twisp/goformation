...
// Workflow_RegistryMapping AWS CloudFormation Resource (AWS::Omics::Workflow.RegistryMapping)
...
func (r *Workflow_RegistryMapping) AWSCloudFormationType() string {
	return "AWS::Omics::Workflow.RegistryMapping"
}
