...
// Configuration_RunConfigurations AWS CloudFormation Resource (AWS::Omics::Configuration.RunConfigurations)
...
type Configuration_RunConfigurations struct {
	...
	VpcConfig *Configuration_VpcConfig `json:"VpcConfig,omitempty"`
...
func (r *Configuration_RunConfigurations) AWSCloudFormationType() string {
	return "AWS::Omics::Configuration.RunConfigurations"
}
