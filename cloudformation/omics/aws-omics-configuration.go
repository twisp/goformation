...
// Configuration AWS CloudFormation Resource (AWS::Omics::Configuration)
...
type Configuration struct {
	...
	// RunConfigurations AWS CloudFormation Property
	// Required: true
	...
	RunConfigurations *Configuration_RunConfigurations `json:"RunConfigurations"`
...
func (r *Configuration) AWSCloudFormationType() string {
	return "AWS::Omics::Configuration"
}
