...
// WorkflowVersion_WorkflowParameter AWS CloudFormation Resource (AWS::Omics::WorkflowVersion.WorkflowParameter)
...
func (r *WorkflowVersion_WorkflowParameter) AWSCloudFormationType() string {
	return "AWS::Omics::WorkflowVersion.WorkflowParameter"
}
