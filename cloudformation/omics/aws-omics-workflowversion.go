...
// WorkflowVersion AWS CloudFormation Resource (AWS::Omics::WorkflowVersion)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-omics-workflowversion.html
type WorkflowVersion struct {

	// Accelerators AWS CloudFormation Property
	// Required: false
	...
	// Main AWS CloudFormation Property
	// Required: false
...
func (r *WorkflowVersion) AWSCloudFormationType() string {
	return "AWS::Omics::WorkflowVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r WorkflowVersion) MarshalJSON() ([]byte, error) {
	type Properties WorkflowVersion
...
func (r *WorkflowVersion) UnmarshalJSON(b []byte) error {
	type Properties WorkflowVersion
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = WorkflowVersion(*res.Properties)
	}
