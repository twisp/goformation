...
// AutomationRuleV2_OcsfBooleanFilter AWS CloudFormation Resource (AWS::SecurityHub::AutomationRuleV2.OcsfBooleanFilter)
...
type AutomationRuleV2_OcsfBooleanFilter struct {
	...
	Filter *AutomationRuleV2_BooleanFilter `json:"Filter"`
...
func (r *AutomationRuleV2_OcsfBooleanFilter) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AutomationRuleV2.OcsfBooleanFilter"
}
