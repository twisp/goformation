...
// AutomationRuleV2_OcsfMapFilter AWS CloudFormation Resource (AWS::SecurityHub::AutomationRuleV2.OcsfMapFilter)
...
type AutomationRuleV2_OcsfMapFilter struct {
	...
	Filter *AutomationRuleV2_MapFilter `json:"Filter"`
...
func (r *AutomationRuleV2_OcsfMapFilter) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AutomationRuleV2.OcsfMapFilter"
}
