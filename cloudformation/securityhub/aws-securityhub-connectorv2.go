...
// ConnectorV2 AWS CloudFormation Resource (AWS::SecurityHub::ConnectorV2)
...
type ConnectorV2 struct {
	...
	Provider *ConnectorV2_Provider `json:"Provider"`
...
func (r *ConnectorV2) AWSCloudFormationType() string {
	return "AWS::SecurityHub::ConnectorV2"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ConnectorV2) MarshalJSON() ([]byte, error) {
	type Properties ConnectorV2
...
func (r *ConnectorV2) UnmarshalJSON(b []byte) error {
	type Properties ConnectorV2
	res := &struct {
		Type                string
		Properties          *Properties
