...
// HubV2 AWS CloudFormation Resource (AWS::SecurityHub::HubV2)
...
func (r *HubV2) AWSCloudFormationType() string {
	return "AWS::SecurityHub::HubV2"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r HubV2) MarshalJSON() ([]byte, error) {
	type Properties HubV2
...
func (r *HubV2) UnmarshalJSON(b []byte) error {
	type Properties HubV2
	res := &struct {
		Type                string
		Properties          *Properties
