...
// AutomationRuleV2_OcsfFindingFilters AWS CloudFormation Resource (AWS::SecurityHub::AutomationRuleV2.OcsfFindingFilters)
...
type AutomationRuleV2_OcsfFindingFilters struct {
	...
	// CompositeFilters AWS CloudFormation Property
	// Required: false
	...
	// CompositeOperator AWS CloudFormation Property
	// Required: false
...
func (r *AutomationRuleV2_OcsfFindingFilters) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AutomationRuleV2.OcsfFindingFilters"
}
