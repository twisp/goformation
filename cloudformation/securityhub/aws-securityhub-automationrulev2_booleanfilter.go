...
// AutomationRuleV2_BooleanFilter AWS CloudFormation Resource (AWS::SecurityHub::AutomationRuleV2.BooleanFilter)
...
func (r *AutomationRuleV2_BooleanFilter) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AutomationRuleV2.BooleanFilter"
}
