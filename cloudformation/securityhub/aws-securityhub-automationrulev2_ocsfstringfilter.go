...
// AutomationRuleV2_OcsfStringFilter AWS CloudFormation Resource (AWS::SecurityHub::AutomationRuleV2.OcsfStringFilter)
...
type AutomationRuleV2_OcsfStringFilter struct {
	...
	Filter *AutomationRuleV2_StringFilter `json:"Filter"`
...
func (r *AutomationRuleV2_OcsfStringFilter) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AutomationRuleV2.OcsfStringFilter"
}
