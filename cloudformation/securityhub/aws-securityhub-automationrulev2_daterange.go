...
// AutomationRuleV2_DateRange AWS CloudFormation Resource (AWS::SecurityHub::AutomationRuleV2.DateRange)
...
func (r *AutomationRuleV2_DateRange) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AutomationRuleV2.DateRange"
}
