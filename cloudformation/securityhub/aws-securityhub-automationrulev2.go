...
// AutomationRuleV2 AWS CloudFormation Resource (AWS::SecurityHub::AutomationRuleV2)
...
type AutomationRuleV2 struct {
	...
	Actions []AutomationRuleV2_AutomationRulesActionV2 `json:"Actions"`
	...
	Criteria *AutomationRuleV2_Criteria `json:"Criteria"`
...
func (r *AutomationRuleV2) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AutomationRuleV2"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AutomationRuleV2) MarshalJSON() ([]byte, error) {
	type Properties AutomationRuleV2
...
func (r *AutomationRuleV2) UnmarshalJSON(b []byte) error {
	type Properties AutomationRuleV2
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AutomationRuleV2(*res.Properties)
	}
