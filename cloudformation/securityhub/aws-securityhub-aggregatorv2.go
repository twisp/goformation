...
// AggregatorV2 AWS CloudFormation Resource (AWS::SecurityHub::AggregatorV2)
...
type AggregatorV2 struct {
	...
	// LinkedRegions AWS CloudFormation Property
	// Required: true
	...
	// RegionLinkingMode AWS CloudFormation Property
	// Required: true
...
func (r *AggregatorV2) AWSCloudFormationType() string {
	return "AWS::SecurityHub::AggregatorV2"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AggregatorV2) MarshalJSON() ([]byte, error) {
	type Properties AggregatorV2
...
func (r *AggregatorV2) UnmarshalJSON(b []byte) error {
	type Properties AggregatorV2
	res := &struct {
		Type                string
		Properties          *Properties
