...
// Dashboard_BodySectionDynamicCategoryDimensionConfiguration AWS CloudFormation Resource (AWS::QuickSight::Dashboard.BodySectionDynamicCategoryDimensionConfiguration)
...
type Dashboard_BodySectionDynamicCategoryDimensionConfiguration struct {
	...
	SortByMetrics []Dashboard_ColumnSort `json:"SortByMetrics,omitempty"`
...
func (r *Dashboard_BodySectionDynamicCategoryDimensionConfiguration) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.BodySectionDynamicCategoryDimensionConfiguration"
}
