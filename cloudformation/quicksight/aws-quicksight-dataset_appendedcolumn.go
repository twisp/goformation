...
// DataSet_AppendedColumn AWS CloudFormation Resource (AWS::QuickSight::DataSet.AppendedColumn)
...
func (r *DataSet_AppendedColumn) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.AppendedColumn"
}
