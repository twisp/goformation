...
// DataSource_StarburstParameters AWS CloudFormation Resource (AWS::QuickSight::DataSource.StarburstParameters)
...
type DataSource_StarburstParameters struct {
	...
	// ProductType AWS CloudFormation Property
	// Required: false
...
func (r *DataSource_StarburstParameters) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSource.StarburstParameters"
}
