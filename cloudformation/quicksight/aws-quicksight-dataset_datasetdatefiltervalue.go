...
// DataSet_DataSetDateFilterValue AWS CloudFormation Resource (AWS::QuickSight::DataSet.DataSetDateFilterValue)
...
func (r *DataSet_DataSetDateFilterValue) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.DataSetDateFilterValue"
}
