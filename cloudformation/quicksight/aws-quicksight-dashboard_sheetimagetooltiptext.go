...
// Dashboard_SheetImageTooltipText AWS CloudFormation Resource (AWS::QuickSight::Dashboard.SheetImageTooltipText)
...
func (r *Dashboard_SheetImageTooltipText) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.SheetImageTooltipText"
}
