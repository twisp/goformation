...
// Dashboard_PluginVisualProperty AWS CloudFormation Resource (AWS::QuickSight::Dashboard.PluginVisualProperty)
...
func (r *Dashboard_PluginVisualProperty) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.PluginVisualProperty"
}
