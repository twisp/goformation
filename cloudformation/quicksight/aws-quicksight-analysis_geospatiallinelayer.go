...
// Analysis_GeospatialLineLayer AWS CloudFormation Resource (AWS::QuickSight::Analysis.GeospatialLineLayer)
...
type Analysis_GeospatialLineLayer struct {
	...
	Style *Analysis_GeospatialLineStyle `json:"Style"`
...
func (r *Analysis_GeospatialLineLayer) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.GeospatialLineLayer"
}
