...
// DataSet_DataSetStringListFilterValue AWS CloudFormation Resource (AWS::QuickSight::DataSet.DataSetStringListFilterValue)
...
func (r *DataSet_DataSetStringListFilterValue) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.DataSetStringListFilterValue"
}
