...
// Template_ImageCustomAction AWS CloudFormation Resource (AWS::QuickSight::Template.ImageCustomAction)
...
type Template_ImageCustomAction struct {
	...
	ActionOperations []Template_ImageCustomActionOperation `json:"ActionOperations"`
...
func (r *Template_ImageCustomAction) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.ImageCustomAction"
}
