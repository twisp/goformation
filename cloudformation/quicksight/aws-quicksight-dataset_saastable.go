...
// DataSet_SaaSTable AWS CloudFormation Resource (AWS::QuickSight::DataSet.SaaSTable)
...
type DataSet_SaaSTable struct {
	...
	// TablePath AWS CloudFormation Property
	// Required: true
	...
	TablePath []DataSet_TablePathElement `json:"TablePath"`
...
func (r *DataSet_SaaSTable) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.SaaSTable"
}
