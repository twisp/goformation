...
// Template_PluginVisual AWS CloudFormation Resource (AWS::QuickSight::Template.PluginVisual)
...
type Template_PluginVisual struct {
	...
	ChartConfiguration *Template_PluginVisualConfiguration `json:"ChartConfiguration,omitempty"`
...
func (r *Template_PluginVisual) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.PluginVisual"
}
