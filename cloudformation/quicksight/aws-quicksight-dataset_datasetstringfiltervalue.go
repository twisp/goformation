...
// DataSet_DataSetStringFilterValue AWS CloudFormation Resource (AWS::QuickSight::DataSet.DataSetStringFilterValue)
...
func (r *DataSet_DataSetStringFilterValue) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.DataSetStringFilterValue"
}
