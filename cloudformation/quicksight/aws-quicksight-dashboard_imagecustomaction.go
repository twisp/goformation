...
// Dashboard_ImageCustomAction AWS CloudFormation Resource (AWS::QuickSight::Dashboard.ImageCustomAction)
...
type Dashboard_ImageCustomAction struct {
	...
	ActionOperations []Dashboard_ImageCustomActionOperation `json:"ActionOperations"`
...
func (r *Dashboard_ImageCustomAction) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.ImageCustomAction"
}
