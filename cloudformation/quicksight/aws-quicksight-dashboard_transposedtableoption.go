...
// Dashboard_TransposedTableOption AWS CloudFormation Resource (AWS::QuickSight::Dashboard.TransposedTableOption)
...
func (r *Dashboard_TransposedTableOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.TransposedTableOption"
}
