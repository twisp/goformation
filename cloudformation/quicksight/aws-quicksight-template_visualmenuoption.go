...
// Template_VisualMenuOption AWS CloudFormation Resource (AWS::QuickSight::Template.VisualMenuOption)
...
func (r *Template_VisualMenuOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.VisualMenuOption"
}
