...
// Dashboard_QuickSuiteActionsOption AWS CloudFormation Resource (AWS::QuickSight::Dashboard.QuickSuiteActionsOption)
...
func (r *Dashboard_QuickSuiteActionsOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.QuickSuiteActionsOption"
}
