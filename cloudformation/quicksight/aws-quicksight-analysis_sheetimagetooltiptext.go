...
// Analysis_SheetImageTooltipText AWS CloudFormation Resource (AWS::QuickSight::Analysis.SheetImageTooltipText)
...
func (r *Analysis_SheetImageTooltipText) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.SheetImageTooltipText"
}
