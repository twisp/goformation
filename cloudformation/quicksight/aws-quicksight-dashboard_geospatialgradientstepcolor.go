...
// Dashboard_GeospatialGradientStepColor AWS CloudFormation Resource (AWS::QuickSight::Dashboard.GeospatialGradientStepColor)
...
func (r *Dashboard_GeospatialGradientStepColor) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.GeospatialGradientStepColor"
}
