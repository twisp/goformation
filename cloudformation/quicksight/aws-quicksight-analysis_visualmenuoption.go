...
// Analysis_VisualMenuOption AWS CloudFormation Resource (AWS::QuickSight::Analysis.VisualMenuOption)
...
func (r *Analysis_VisualMenuOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.VisualMenuOption"
}
