...
// Analysis_GeospatialPolygonLayer AWS CloudFormation Resource (AWS::QuickSight::Analysis.GeospatialPolygonLayer)
...
type Analysis_GeospatialPolygonLayer struct {
	...
	Style *Analysis_GeospatialPolygonStyle `json:"Style"`
...
func (r *Analysis_GeospatialPolygonLayer) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.GeospatialPolygonLayer"
}
