...
// Analysis_GeospatialMapStyle AWS CloudFormation Resource (AWS::QuickSight::Analysis.GeospatialMapStyle)
...
func (r *Analysis_GeospatialMapStyle) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.GeospatialMapStyle"
}
