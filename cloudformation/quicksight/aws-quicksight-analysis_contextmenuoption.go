...
// Analysis_ContextMenuOption AWS CloudFormation Resource (AWS::QuickSight::Analysis.ContextMenuOption)
...
func (r *Analysis_ContextMenuOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.ContextMenuOption"
}
