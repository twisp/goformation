...
// Template_KPISparklineOptions AWS CloudFormation Resource (AWS::QuickSight::Template.KPISparklineOptions)
...
type Template_KPISparklineOptions struct {
	...
	TooltipVisibility interface{} `json:"TooltipVisibility,omitempty"`
...
func (r *Template_KPISparklineOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.KPISparklineOptions"
}
