...
// Analysis_ImageCustomAction AWS CloudFormation Resource (AWS::QuickSight::Analysis.ImageCustomAction)
...
type Analysis_ImageCustomAction struct {
	...
	ActionOperations []Analysis_ImageCustomActionOperation `json:"ActionOperations"`
...
func (r *Analysis_ImageCustomAction) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.ImageCustomAction"
}
