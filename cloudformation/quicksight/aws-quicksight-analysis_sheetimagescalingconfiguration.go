...
// Analysis_SheetImageScalingConfiguration AWS CloudFormation Resource (AWS::QuickSight::Analysis.SheetImageScalingConfiguration)
...
func (r *Analysis_SheetImageScalingConfiguration) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.SheetImageScalingConfiguration"
}
