...
// DataSet_DataSetNumericFilterValue AWS CloudFormation Resource (AWS::QuickSight::DataSet.DataSetNumericFilterValue)
...
func (r *DataSet_DataSetNumericFilterValue) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.DataSetNumericFilterValue"
}
