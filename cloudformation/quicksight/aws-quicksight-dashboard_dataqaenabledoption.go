...
// Dashboard_DataQAEnabledOption AWS CloudFormation Resource (AWS::QuickSight::Dashboard.DataQAEnabledOption)
...
func (r *Dashboard_DataQAEnabledOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.DataQAEnabledOption"
}
