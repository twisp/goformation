...
// Analysis_GeospatialMapState AWS CloudFormation Resource (AWS::QuickSight::Analysis.GeospatialMapState)
...
func (r *Analysis_GeospatialMapState) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.GeospatialMapState"
}
