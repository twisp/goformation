...
// Dashboard_GeospatialLayerJoinDefinition AWS CloudFormation Resource (AWS::QuickSight::Dashboard.GeospatialLayerJoinDefinition)
...
type Dashboard_GeospatialLayerJoinDefinition struct {
	...
	ColorField *Dashboard_GeospatialLayerColorField `json:"ColorField,omitempty"`
	...
	DatasetKeyField *Dashboard_UnaggregatedField `json:"DatasetKeyField,omitempty"`
...
func (r *Dashboard_GeospatialLayerJoinDefinition) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.GeospatialLayerJoinDefinition"
}
