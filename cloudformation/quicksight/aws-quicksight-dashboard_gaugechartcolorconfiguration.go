...
// Dashboard_GaugeChartColorConfiguration AWS CloudFormation Resource (AWS::QuickSight::Dashboard.GaugeChartColorConfiguration)
...
func (r *Dashboard_GaugeChartColorConfiguration) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.GaugeChartColorConfiguration"
}
