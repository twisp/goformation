...
// DataSet_RowLevelPermissionTagRule AWS CloudFormation Resource (AWS::QuickSight::DataSet.RowLevelPermissionTagRule)
...
func (r *DataSet_RowLevelPermissionTagRule) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.RowLevelPermissionTagRule"
}
