...
// DataSet_SourceTable AWS CloudFormation Resource (AWS::QuickSight::DataSet.SourceTable)
...
type DataSet_SourceTable struct {
	...
	// DataSet AWS CloudFormation Property
	// Required: false
...
func (r *DataSet_SourceTable) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.SourceTable"
}
