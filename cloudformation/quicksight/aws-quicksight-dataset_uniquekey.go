...
// DataSet_UniqueKey AWS CloudFormation Resource (AWS::QuickSight::DataSet.UniqueKey)
...
func (r *DataSet_UniqueKey) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.UniqueKey"
}
