...
// Dashboard_GeospatialColor AWS CloudFormation Resource (AWS::QuickSight::Dashboard.GeospatialColor)
...
type Dashboard_GeospatialColor struct {
	...
	Categorical *Dashboard_GeospatialCategoricalColor `json:"Categorical,omitempty"`
	...
	Gradient *Dashboard_GeospatialGradientColor `json:"Gradient,omitempty"`
	...
	Solid *Dashboard_GeospatialSolidColor `json:"Solid,omitempty"`
...
func (r *Dashboard_GeospatialColor) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.GeospatialColor"
}
