...
// Dashboard_GeospatialCircleRadius AWS CloudFormation Resource (AWS::QuickSight::Dashboard.GeospatialCircleRadius)
...
func (r *Dashboard_GeospatialCircleRadius) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.GeospatialCircleRadius"
}
