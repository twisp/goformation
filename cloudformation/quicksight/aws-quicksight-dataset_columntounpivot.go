...
// DataSet_ColumnToUnpivot AWS CloudFormation Resource (AWS::QuickSight::DataSet.ColumnToUnpivot)
...
type DataSet_ColumnToUnpivot struct {
	...
	// NewValue AWS CloudFormation Property
	// Required: false
...
func (r *DataSet_ColumnToUnpivot) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.ColumnToUnpivot"
}
