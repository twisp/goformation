...
// Analysis_ImageCustomActionOperation AWS CloudFormation Resource (AWS::QuickSight::Analysis.ImageCustomActionOperation)
...
func (r *Analysis_ImageCustomActionOperation) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.ImageCustomActionOperation"
}
