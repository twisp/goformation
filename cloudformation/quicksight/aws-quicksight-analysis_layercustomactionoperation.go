...
// Analysis_LayerCustomActionOperation AWS CloudFormation Resource (AWS::QuickSight::Analysis.LayerCustomActionOperation)
...
func (r *Analysis_LayerCustomActionOperation) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.LayerCustomActionOperation"
}
