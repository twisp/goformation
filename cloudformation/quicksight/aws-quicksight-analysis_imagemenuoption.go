...
// Analysis_ImageMenuOption AWS CloudFormation Resource (AWS::QuickSight::Analysis.ImageMenuOption)
...
func (r *Analysis_ImageMenuOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.ImageMenuOption"
}
