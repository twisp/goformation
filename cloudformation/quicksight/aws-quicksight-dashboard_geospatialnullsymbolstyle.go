...
// Dashboard_GeospatialNullSymbolStyle AWS CloudFormation Resource (AWS::QuickSight::Dashboard.GeospatialNullSymbolStyle)
...
func (r *Dashboard_GeospatialNullSymbolStyle) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.GeospatialNullSymbolStyle"
}
