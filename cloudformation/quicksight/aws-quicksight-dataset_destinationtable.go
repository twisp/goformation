...
// DataSet_DestinationTable AWS CloudFormation Resource (AWS::QuickSight::DataSet.DestinationTable)
...
type DataSet_DestinationTable struct {
	...
	Source *DataSet_DestinationTableSource `json:"Source"`
...
func (r *DataSet_DestinationTable) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.DestinationTable"
}
