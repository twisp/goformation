...
// Analysis_StaticFileUrlSourceOptions AWS CloudFormation Resource (AWS::QuickSight::Analysis.StaticFileUrlSourceOptions)
...
func (r *Analysis_StaticFileUrlSourceOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.StaticFileUrlSourceOptions"
}
