...
// Analysis_GeospatialLineWidth AWS CloudFormation Resource (AWS::QuickSight::Analysis.GeospatialLineWidth)
...
func (r *Analysis_GeospatialLineWidth) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.GeospatialLineWidth"
}
