...
// ActionConnector_ResourcePermission AWS CloudFormation Resource (AWS::QuickSight::ActionConnector.ResourcePermission)
...
type ActionConnector_ResourcePermission struct {
...
func (r *ActionConnector_ResourcePermission) AWSCloudFormationType() string {
	return "AWS::QuickSight::ActionConnector.ResourcePermission"
}
