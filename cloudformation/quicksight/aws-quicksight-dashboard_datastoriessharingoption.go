...
// Dashboard_DataStoriesSharingOption AWS CloudFormation Resource (AWS::QuickSight::Dashboard.DataStoriesSharingOption)
...
func (r *Dashboard_DataStoriesSharingOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.DataStoriesSharingOption"
}
