...
// Template_PluginVisualProperty AWS CloudFormation Resource (AWS::QuickSight::Template.PluginVisualProperty)
...
func (r *Template_PluginVisualProperty) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.PluginVisualProperty"
}
