...
// Analysis_PluginVisualConfiguration AWS CloudFormation Resource (AWS::QuickSight::Analysis.PluginVisualConfiguration)
...
func (r *Analysis_PluginVisualConfiguration) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.PluginVisualConfiguration"
}
