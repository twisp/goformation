...
// Template_BodySectionRepeatPageBreakConfiguration AWS CloudFormation Resource (AWS::QuickSight::Template.BodySectionRepeatPageBreakConfiguration)
...
func (r *Template_BodySectionRepeatPageBreakConfiguration) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.BodySectionRepeatPageBreakConfiguration"
}
