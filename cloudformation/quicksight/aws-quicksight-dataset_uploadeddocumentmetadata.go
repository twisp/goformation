...
// DataSet_UploadedDocumentMetadata AWS CloudFormation Resource (AWS::QuickSight::DataSet.UploadedDocumentMetadata)
...
type DataSet_UploadedDocumentMetadata struct {
...
func (r *DataSet_UploadedDocumentMetadata) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.UploadedDocumentMetadata"
}
