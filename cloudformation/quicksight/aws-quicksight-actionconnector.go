...
// ActionConnector AWS CloudFormation Resource (AWS::QuickSight::ActionConnector)
...
type ActionConnector struct {
	...
	// ActionConnectorId AWS CloudFormation Property
	// Required: true
	...
	// AuthenticationConfig AWS CloudFormation Property
	// Required: true
	...
	AuthenticationConfig *ActionConnector_AuthConfig `json:"AuthenticationConfig"`
	...
	Permissions []ActionConnector_ResourcePermission `json:"Permissions,omitempty"`
...
func (r *ActionConnector) AWSCloudFormationType() string {
	return "AWS::QuickSight::ActionConnector"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ActionConnector) MarshalJSON() ([]byte, error) {
	type Properties ActionConnector
...
func (r *ActionConnector) UnmarshalJSON(b []byte) error {
	type Properties ActionConnector
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ActionConnector(*res.Properties)
	}
