...
// DataSet_RefreshFailureEmailAlert AWS CloudFormation Resource (AWS::QuickSight::DataSet.RefreshFailureEmailAlert)
...
type DataSet_RefreshFailureEmailAlert struct {
	...
	// AlertStatus AWS CloudFormation Property
	// Required: false
...
func (r *DataSet_RefreshFailureEmailAlert) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.RefreshFailureEmailAlert"
}
