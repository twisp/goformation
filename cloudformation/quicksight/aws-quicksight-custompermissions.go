...
// CustomPermissions AWS CloudFormation Resource (AWS::QuickSight::CustomPermissions)
...
type CustomPermissions struct {
	...
	// CustomPermissionsName AWS CloudFormation Property
	// Required: true
	...
	CustomPermissionsName string `json:"CustomPermissionsName"`
...
func (r *CustomPermissions) AWSCloudFormationType() string {
	return "AWS::QuickSight::CustomPermissions"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CustomPermissions) MarshalJSON() ([]byte, error) {
	type Properties CustomPermissions
...
func (r *CustomPermissions) UnmarshalJSON(b []byte) error {
	type Properties CustomPermissions
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CustomPermissions(*res.Properties)
	}
