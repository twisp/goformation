...
// DataSet_DataSetColumnIdMapping AWS CloudFormation Resource (AWS::QuickSight::DataSet.DataSetColumnIdMapping)
...
type DataSet_DataSetColumnIdMapping struct {
	...
	// SourceColumnId AWS CloudFormation Property
	// Required: true
	...
	// TargetColumnId AWS CloudFormation Property
	// Required: true
...
func (r *DataSet_DataSetColumnIdMapping) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.DataSetColumnIdMapping"
}
