...
// Template_PivotTableRowsLabelOptions AWS CloudFormation Resource (AWS::QuickSight::Template.PivotTableRowsLabelOptions)
...
func (r *Template_PivotTableRowsLabelOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.PivotTableRowsLabelOptions"
}
