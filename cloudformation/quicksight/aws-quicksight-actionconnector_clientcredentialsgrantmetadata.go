...
// ActionConnector_ClientCredentialsGrantMetadata AWS CloudFormation Resource (AWS::QuickSight::ActionConnector.ClientCredentialsGrantMetadata)
...
type ActionConnector_ClientCredentialsGrantMetadata struct {
	...
	// ClientCredentialsDetails AWS CloudFormation Property
	// Required: false
	...
	ClientCredentialsDetails *ActionConnector_ClientCredentialsDetails `json:"ClientCredentialsDetails,omitempty"`

	// ClientCredentialsSource AWS CloudFormation Property
	// Required: false
...
func (r *ActionConnector_ClientCredentialsGrantMetadata) AWSCloudFormationType() string {
	return "AWS::QuickSight::ActionConnector.ClientCredentialsGrantMetadata"
}
