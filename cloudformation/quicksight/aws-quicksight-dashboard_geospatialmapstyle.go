...
// Dashboard_GeospatialMapStyle AWS CloudFormation Resource (AWS::QuickSight::Dashboard.GeospatialMapStyle)
...
type Dashboard_GeospatialMapStyle struct {
	...
	// BaseMapVisibility AWS CloudFormation Property
	// Required: false
...
func (r *Dashboard_GeospatialMapStyle) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.GeospatialMapStyle"
}
