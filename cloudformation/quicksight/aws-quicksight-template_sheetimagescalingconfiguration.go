...
// Template_SheetImageScalingConfiguration AWS CloudFormation Resource (AWS::QuickSight::Template.SheetImageScalingConfiguration)
...
func (r *Template_SheetImageScalingConfiguration) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.SheetImageScalingConfiguration"
}
