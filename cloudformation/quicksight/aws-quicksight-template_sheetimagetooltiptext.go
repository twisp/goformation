...
// Template_SheetImageTooltipText AWS CloudFormation Resource (AWS::QuickSight::Template.SheetImageTooltipText)
...
func (r *Template_SheetImageTooltipText) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.SheetImageTooltipText"
}
