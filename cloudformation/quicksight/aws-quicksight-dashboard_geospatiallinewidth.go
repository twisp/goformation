...
// Dashboard_GeospatialLineWidth AWS CloudFormation Resource (AWS::QuickSight::Dashboard.GeospatialLineWidth)
...
func (r *Dashboard_GeospatialLineWidth) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.GeospatialLineWidth"
}
