...
// Dashboard_ContextMenuOption AWS CloudFormation Resource (AWS::QuickSight::Dashboard.ContextMenuOption)
...
func (r *Dashboard_ContextMenuOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.ContextMenuOption"
}
