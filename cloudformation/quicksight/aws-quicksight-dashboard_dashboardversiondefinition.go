...
type Dashboard_DashboardVersionDefinition struct {
	...
	Options *Dashboard_AssetOptions `json:"Options,omitempty"`
	...
	// StaticFiles AWS CloudFormation Property
	// Required: false
	...
	StaticFiles []Dashboard_StaticFile `json:"StaticFiles,omitempty"`
