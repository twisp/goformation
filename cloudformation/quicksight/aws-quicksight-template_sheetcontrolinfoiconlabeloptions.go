...
// Template_SheetControlInfoIconLabelOptions AWS CloudFormation Resource (AWS::QuickSight::Template.SheetControlInfoIconLabelOptions)
...
func (r *Template_SheetControlInfoIconLabelOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.SheetControlInfoIconLabelOptions"
}
