...
// Dashboard_StaticFileUrlSourceOptions AWS CloudFormation Resource (AWS::QuickSight::Dashboard.StaticFileUrlSourceOptions)
...
func (r *Dashboard_StaticFileUrlSourceOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.StaticFileUrlSourceOptions"
}
