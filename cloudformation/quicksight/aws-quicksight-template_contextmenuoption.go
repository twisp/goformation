...
// Template_ContextMenuOption AWS CloudFormation Resource (AWS::QuickSight::Template.ContextMenuOption)
...
func (r *Template_ContextMenuOption) AWSCloudFormationType() string {
	return "AWS::QuickSight::Template.ContextMenuOption"
}
