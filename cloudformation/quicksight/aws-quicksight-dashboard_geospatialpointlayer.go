...
// Dashboard_GeospatialPointLayer AWS CloudFormation Resource (AWS::QuickSight::Dashboard.GeospatialPointLayer)
...
type Dashboard_GeospatialPointLayer struct {
	...
	Style *Dashboard_GeospatialPointStyle `json:"Style"`
...
func (r *Dashboard_GeospatialPointLayer) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.GeospatialPointLayer"
}
