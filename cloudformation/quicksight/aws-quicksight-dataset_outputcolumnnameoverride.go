...
// DataSet_OutputColumnNameOverride AWS CloudFormation Resource (AWS::QuickSight::DataSet.OutputColumnNameOverride)
...
type DataSet_OutputColumnNameOverride struct {
	...
	// OutputColumnName AWS CloudFormation Property
	// Required: true
	...
	// SourceColumnName AWS CloudFormation Property
	// Required: false
...
func (r *DataSet_OutputColumnNameOverride) AWSCloudFormationType() string {
	return "AWS::QuickSight::DataSet.OutputColumnNameOverride"
}
