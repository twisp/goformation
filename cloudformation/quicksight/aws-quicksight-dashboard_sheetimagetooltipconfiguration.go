...
// Dashboard_SheetImageTooltipConfiguration AWS CloudFormation Resource (AWS::QuickSight::Dashboard.SheetImageTooltipConfiguration)
...
type Dashboard_SheetImageTooltipConfiguration struct {
	...
	TooltipText *Dashboard_SheetImageTooltipText `json:"TooltipText,omitempty"`
...
func (r *Dashboard_SheetImageTooltipConfiguration) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.SheetImageTooltipConfiguration"
}
