...
// Topic_TopicConfigOptions AWS CloudFormation Resource (AWS::QuickSight::Topic.TopicConfigOptions)
...
type Topic_TopicConfigOptions struct {
	...
	// QBusinessInsightsEnabled AWS CloudFormation Property
	// Required: false
...
func (r *Topic_TopicConfigOptions) AWSCloudFormationType() string {
	return "AWS::QuickSight::Topic.TopicConfigOptions"
}
