...
// Analysis_GeospatialLineSymbolStyle AWS CloudFormation Resource (AWS::QuickSight::Analysis.GeospatialLineSymbolStyle)
...
func (r *Analysis_GeospatialLineSymbolStyle) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.GeospatialLineSymbolStyle"
}
