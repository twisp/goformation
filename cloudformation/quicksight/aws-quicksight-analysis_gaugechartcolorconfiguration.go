...
// Analysis_GaugeChartColorConfiguration AWS CloudFormation Resource (AWS::QuickSight::Analysis.GaugeChartColorConfiguration)
...
func (r *Analysis_GaugeChartColorConfiguration) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.GaugeChartColorConfiguration"
}
