...
// Analysis_PluginVisualProperty AWS CloudFormation Resource (AWS::QuickSight::Analysis.PluginVisualProperty)
...
func (r *Analysis_PluginVisualProperty) AWSCloudFormationType() string {
	return "AWS::QuickSight::Analysis.PluginVisualProperty"
}
