...
// Dashboard_SankeyDiagramVisual AWS CloudFormation Resource (AWS::QuickSight::Dashboard.SankeyDiagramVisual)
...
type Dashboard_SankeyDiagramVisual struct {
	...
	ChartConfiguration *Dashboard_SankeyDiagramChartConfiguration `json:"ChartConfiguration,omitempty"`
...
func (r *Dashboard_SankeyDiagramVisual) AWSCloudFormationType() string {
	return "AWS::QuickSight::Dashboard.SankeyDiagramVisual"
}
