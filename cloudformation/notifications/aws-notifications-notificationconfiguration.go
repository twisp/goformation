...
// NotificationConfiguration AWS CloudFormation Resource (AWS::Notifications::NotificationConfiguration)
...
type NotificationConfiguration struct {
	...
	// AggregationDuration AWS CloudFormation Property
	// Required: false
...
func (r *NotificationConfiguration) AWSCloudFormationType() string {
	return "AWS::Notifications::NotificationConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r NotificationConfiguration) MarshalJSON() ([]byte, error) {
	type Properties NotificationConfiguration
...
func (r *NotificationConfiguration) UnmarshalJSON(b []byte) error {
	type Properties NotificationConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = NotificationConfiguration(*res.Properties)
	}
