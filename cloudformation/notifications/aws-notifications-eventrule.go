...
// EventRule AWS CloudFormation Resource (AWS::Notifications::EventRule)
...
func (r *EventRule) AWSCloudFormationType() string {
	return "AWS::Notifications::EventRule"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EventRule) MarshalJSON() ([]byte, error) {
	type Properties EventRule
...
func (r *EventRule) UnmarshalJSON(b []byte) error {
	type Properties EventRule
	res := &struct {
		Type                string
		Properties          *Properties
