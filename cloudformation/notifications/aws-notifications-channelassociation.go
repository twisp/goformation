...
// ChannelAssociation AWS CloudFormation Resource (AWS::Notifications::ChannelAssociation)
...
func (r *ChannelAssociation) AWSCloudFormationType() string {
	return "AWS::Notifications::ChannelAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ChannelAssociation) MarshalJSON() ([]byte, error) {
	type Properties ChannelAssociation
...
func (r *ChannelAssociation) UnmarshalJSON(b []byte) error {
	type Properties ChannelAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ChannelAssociation(*res.Properties)
	}
