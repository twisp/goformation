...
// OrganizationalUnitAssociation AWS CloudFormation Resource (AWS::Notifications::OrganizationalUnitAssociation)
...
type OrganizationalUnitAssociation struct {
	...
	// NotificationConfigurationArn AWS CloudFormation Property
	// Required: true
	...
	// OrganizationalUnitId AWS CloudFormation Property
	// Required: true
...
func (r *OrganizationalUnitAssociation) AWSCloudFormationType() string {
	return "AWS::Notifications::OrganizationalUnitAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OrganizationalUnitAssociation) MarshalJSON() ([]byte, error) {
	type Properties OrganizationalUnitAssociation
...
func (r *OrganizationalUnitAssociation) UnmarshalJSON(b []byte) error {
	type Properties OrganizationalUnitAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = OrganizationalUnitAssociation(*res.Properties)
	}
