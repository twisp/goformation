...
// ManagedNotificationAccountContactAssociation AWS CloudFormation Resource (AWS::Notifications::ManagedNotificationAccountContactAssociation)
...
type ManagedNotificationAccountContactAssociation struct {
	...
	// ContactIdentifier AWS CloudFormation Property
	// Required: true
	...
	ManagedNotificationConfigurationArn string `json:"ManagedNotificationConfigurationArn"`
...
func (r *ManagedNotificationAccountContactAssociation) AWSCloudFormationType() string {
	return "AWS::Notifications::ManagedNotificationAccountContactAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ManagedNotificationAccountContactAssociation) MarshalJSON() ([]byte, error) {
	type Properties ManagedNotificationAccountContactAssociation
...
func (r *ManagedNotificationAccountContactAssociation) UnmarshalJSON(b []byte) error {
	type Properties ManagedNotificationAccountContactAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ManagedNotificationAccountContactAssociation(*res.Properties)
	}
