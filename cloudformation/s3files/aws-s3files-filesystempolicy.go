...
// FileSystemPolicy AWS CloudFormation Resource (AWS::S3Files::FileSystemPolicy)
...
func (r *FileSystemPolicy) AWSCloudFormationType() string {
	return "AWS::S3Files::FileSystemPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r FileSystemPolicy) MarshalJSON() ([]byte, error) {
	type Properties FileSystemPolicy
...
func (r *FileSystemPolicy) UnmarshalJSON(b []byte) error {
	type Properties FileSystemPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = FileSystemPolicy(*res.Properties)
	}
