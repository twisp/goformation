...
// AccessPoint_RootDirectory AWS CloudFormation Resource (AWS::S3Files::AccessPoint.RootDirectory)
...
type AccessPoint_RootDirectory struct {
	...
	// CreationPermissions AWS CloudFormation Property
	// Required: false
	...
	CreationPermissions *AccessPoint_CreationPermissions `json:"CreationPermissions,omitempty"`
...
func (r *AccessPoint_RootDirectory) AWSCloudFormationType() string {
	return "AWS::S3Files::AccessPoint.RootDirectory"
}
