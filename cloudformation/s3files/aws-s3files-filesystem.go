...
// FileSystem AWS CloudFormation Resource (AWS::S3Files::FileSystem)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-s3files-filesystem.html
type FileSystem struct {

	// AcceptBucketWarning AWS CloudFormation Property
	// Required: false
	...
	// SynchronizationConfiguration AWS CloudFormation Property
	// Required: false
	...
	SynchronizationConfiguration *FileSystem_SynchronizationConfiguration `json:"SynchronizationConfiguration,omitempty"`
