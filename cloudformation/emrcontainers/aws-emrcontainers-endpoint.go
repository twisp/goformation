...
// Endpoint AWS CloudFormation Resource (AWS::EMRContainers::Endpoint)
...
type Endpoint struct {
	...
	ConfigurationOverrides *Endpoint_ConfigurationOverrides `json:"ConfigurationOverrides,omitempty"`
	...
	// VirtualClusterId AWS CloudFormation Property
	// Required: true
...
func (r *Endpoint) AWSCloudFormationType() string {
	return "AWS::EMRContainers::Endpoint"
}
