...
// SecurityConfiguration_LakeFormationConfiguration AWS CloudFormation Resource (AWS::EMRContainers::SecurityConfiguration.LakeFormationConfiguration)
...
type SecurityConfiguration_LakeFormationConfiguration struct {

	// AuthorizedSessionTagValue AWS CloudFormation Property
	// Required: false
	...
	// QueryAccessControlEnabled AWS CloudFormation Property
	// Required: false
	...
	// QueryEngineRoleArn AWS CloudFormation Property
	// Required: false
	...
	// SecureNamespaceInfo AWS CloudFormation Property
	// Required: false
	...
	SecureNamespaceInfo *SecurityConfiguration_SecureNamespaceInfo `json:"SecureNamespaceInfo,omitempty"`
...
func (r *SecurityConfiguration_LakeFormationConfiguration) AWSCloudFormationType() string {
	return "AWS::EMRContainers::SecurityConfiguration.LakeFormationConfiguration"
}
