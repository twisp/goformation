...
// SecurityConfiguration_ContainerInfo AWS CloudFormation Resource (AWS::EMRContainers::SecurityConfiguration.ContainerInfo)
...
type SecurityConfiguration_ContainerInfo struct {
	...
	EksInfo *SecurityConfiguration_EksInfo `json:"EksInfo,omitempty"`
...
func (r *SecurityConfiguration_ContainerInfo) AWSCloudFormationType() string {
	return "AWS::EMRContainers::SecurityConfiguration.ContainerInfo"
}
