...
// SecurityConfiguration_S3EncryptionConfiguration AWS CloudFormation Resource (AWS::EMRContainers::SecurityConfiguration.S3EncryptionConfiguration)
...
type SecurityConfiguration_S3EncryptionConfiguration struct {
...
func (r *SecurityConfiguration_S3EncryptionConfiguration) AWSCloudFormationType() string {
	return "AWS::EMRContainers::SecurityConfiguration.S3EncryptionConfiguration"
}
