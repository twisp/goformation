...
// Dashboard AWS CloudFormation Resource (AWS::BCM::Dashboard)
...
type Dashboard struct {
	...
	// Widgets AWS CloudFormation Property
	// Required: true
	...
	Widgets []Dashboard_Widget `json:"Widgets"`
