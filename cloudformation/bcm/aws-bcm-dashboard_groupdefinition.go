...
// Dashboard_GroupDefinition AWS CloudFormation Resource (AWS::BCM::Dashboard.GroupDefinition)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-bcm-dashboard-groupdefinition.html
type Dashboard_GroupDefinition struct {
...
func (r *Dashboard_GroupDefinition) AWSCloudFormationType() string {
	return "AWS::BCM::Dashboard.GroupDefinition"
}
