...
// Project_ScopeConfiguration AWS CloudFormation Resource (AWS::CodeBuild::Project.ScopeConfiguration)
...
func (r *Project_ScopeConfiguration) AWSCloudFormationType() string {
	return "AWS::CodeBuild::Project.ScopeConfiguration"
}
