...
// CollectionGroup AWS CloudFormation Resource (AWS::OpenSearchServerless::CollectionGroup)
...
type CollectionGroup struct {
	...
	CapacityLimits *CollectionGroup_CapacityLimits `json:"CapacityLimits,omitempty"`
	...
	// Generation AWS CloudFormation Property
	// Required: false
	...
	// StandbyReplicas AWS CloudFormation Property
	// Required: true
...
func (r *CollectionGroup) AWSCloudFormationType() string {
	return "AWS::OpenSearchServerless::CollectionGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CollectionGroup) MarshalJSON() ([]byte, error) {
	type Properties CollectionGroup
...
func (r *CollectionGroup) UnmarshalJSON(b []byte) error {
	type Properties CollectionGroup
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CollectionGroup(*res.Properties)
	}
