...
// CollectionIndex AWS CloudFormation Resource (AWS::OpenSearchServerless::CollectionIndex)
...
type CollectionIndex struct {
	...
	// IndexSchema AWS CloudFormation Property
	// Required: false
...
func (r *CollectionIndex) AWSCloudFormationType() string {
	return "AWS::OpenSearchServerless::CollectionIndex"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CollectionIndex) MarshalJSON() ([]byte, error) {
	type Properties CollectionIndex
...
func (r *CollectionIndex) UnmarshalJSON(b []byte) error {
	type Properties CollectionIndex
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CollectionIndex(*res.Properties)
	}
