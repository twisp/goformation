...
// Dictionary AWS CloudFormation Resource (AWS::ElementalInference::Dictionary)
...
func (r *Dictionary) AWSCloudFormationType() string {
	return "AWS::ElementalInference::Dictionary"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Dictionary) MarshalJSON() ([]byte, error) {
...
func (r *Dictionary) UnmarshalJSON(b []byte) error {
	type Properties Dictionary
	res := &struct {
		Type                string
		Properties          *Properties
