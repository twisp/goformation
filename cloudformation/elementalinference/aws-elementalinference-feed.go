...
// Feed AWS CloudFormation Resource (AWS::ElementalInference::Feed)
...
type Feed struct {
	...
	Outputs []Feed_GetOutput `json:"Outputs"`
...
func (r *Feed) AWSCloudFormationType() string {
	return "AWS::ElementalInference::Feed"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Feed) MarshalJSON() ([]byte, error) {
	type Properties Feed
...
func (r *Feed) UnmarshalJSON(b []byte) error {
	type Properties Feed
	res := &struct {
		Type                string
		Properties          *Properties
