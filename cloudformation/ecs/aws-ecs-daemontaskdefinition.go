...
// DaemonTaskDefinition AWS CloudFormation Resource (AWS::ECS::DaemonTaskDefinition)
...
type DaemonTaskDefinition struct {
	...
	ContainerDefinitions []DaemonTaskDefinition_DaemonContainerDefinition `json:"ContainerDefinitions,omitempty"`
	...
	Volumes []DaemonTaskDefinition_Volume `json:"Volumes,omitempty"`
...
func (r *DaemonTaskDefinition) AWSCloudFormationType() string {
	return "AWS::ECS::DaemonTaskDefinition"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DaemonTaskDefinition) MarshalJSON() ([]byte, error) {
	type Properties DaemonTaskDefinition
...
func (r *DaemonTaskDefinition) UnmarshalJSON(b []byte) error {
	type Properties DaemonTaskDefinition
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DaemonTaskDefinition(*res.Properties)
	}
