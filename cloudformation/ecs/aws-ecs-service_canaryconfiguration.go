...
// Service_CanaryConfiguration AWS CloudFormation Resource (AWS::ECS::Service.CanaryConfiguration)
...
type Service_CanaryConfiguration struct {
	...
	// CanaryBakeTimeInMinutes AWS CloudFormation Property
	// Required: false
	...
	// CanaryPercent AWS CloudFormation Property
	// Required: false
...
func (r *Service_CanaryConfiguration) AWSCloudFormationType() string {
	return "AWS::ECS::Service.CanaryConfiguration"
}
