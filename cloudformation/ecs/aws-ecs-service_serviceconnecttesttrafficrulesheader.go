...
// Service_ServiceConnectTestTrafficRulesHeader AWS CloudFormation Resource (AWS::ECS::Service.ServiceConnectTestTrafficRulesHeader)
...
func (r *Service_ServiceConnectTestTrafficRulesHeader) AWSCloudFormationType() string {
	return "AWS::ECS::Service.ServiceConnectTestTrafficRulesHeader"
}
