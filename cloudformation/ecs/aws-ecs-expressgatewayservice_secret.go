...
// ExpressGatewayService_Secret AWS CloudFormation Resource (AWS::ECS::ExpressGatewayService.Secret)
...
func (r *ExpressGatewayService_Secret) AWSCloudFormationType() string {
	return "AWS::ECS::ExpressGatewayService.Secret"
}
