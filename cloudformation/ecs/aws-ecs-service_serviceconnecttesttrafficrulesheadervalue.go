...
// Service_ServiceConnectTestTrafficRulesHeaderValue AWS CloudFormation Resource (AWS::ECS::Service.ServiceConnectTestTrafficRulesHeaderValue)
...
func (r *Service_ServiceConnectTestTrafficRulesHeaderValue) AWSCloudFormationType() string {
	return "AWS::ECS::Service.ServiceConnectTestTrafficRulesHeaderValue"
}
