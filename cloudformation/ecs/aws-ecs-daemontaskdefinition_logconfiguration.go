...
// DaemonTaskDefinition_LogConfiguration AWS CloudFormation Resource (AWS::ECS::DaemonTaskDefinition.LogConfiguration)
...
type DaemonTaskDefinition_LogConfiguration struct {
	...
	SecretOptions []DaemonTaskDefinition_Secret `json:"SecretOptions,omitempty"`
...
func (r *DaemonTaskDefinition_LogConfiguration) AWSCloudFormationType() string {
	return "AWS::ECS::DaemonTaskDefinition.LogConfiguration"
}
