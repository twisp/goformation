...
type Service struct {
	...
	// AvailabilityZoneRebalancing AWS CloudFormation Property
	// Required: false
	...
	// ForceNewDeployment AWS CloudFormation Property
	// Required: false
	...
	Monitoring *Service_MonitoringConfiguration `json:"Monitoring,omitempty"`
	...
	// VpcLatticeConfigurations AWS CloudFormation Property
	// Required: false
