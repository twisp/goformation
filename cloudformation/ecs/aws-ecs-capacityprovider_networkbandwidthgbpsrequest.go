...
// CapacityProvider_NetworkBandwidthGbpsRequest AWS CloudFormation Resource (AWS::ECS::CapacityProvider.NetworkBandwidthGbpsRequest)
...
func (r *CapacityProvider_NetworkBandwidthGbpsRequest) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.NetworkBandwidthGbpsRequest"
}
