...
// ExpressGatewayService_ExpressGatewayServiceAwsLogsConfiguration AWS CloudFormation Resource (AWS::ECS::ExpressGatewayService.ExpressGatewayServiceAwsLogsConfiguration)
...
type ExpressGatewayService_ExpressGatewayServiceAwsLogsConfiguration struct {
	...
	// LogStreamPrefix AWS CloudFormation Property
	// Required: true
...
func (r *ExpressGatewayService_ExpressGatewayServiceAwsLogsConfiguration) AWSCloudFormationType() string {
	return "AWS::ECS::ExpressGatewayService.ExpressGatewayServiceAwsLogsConfiguration"
}
