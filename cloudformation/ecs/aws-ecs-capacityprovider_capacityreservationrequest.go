...
// CapacityProvider_CapacityReservationRequest AWS CloudFormation Resource (AWS::ECS::CapacityProvider.CapacityReservationRequest)
...
type CapacityProvider_CapacityReservationRequest struct {

	// ReservationGroupArn AWS CloudFormation Property
	// Required: false
	...
	// ReservationPreference AWS CloudFormation Property
	// Required: false
...
func (r *CapacityProvider_CapacityReservationRequest) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.CapacityReservationRequest"
}
