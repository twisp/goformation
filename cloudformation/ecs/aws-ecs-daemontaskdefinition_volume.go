...
// DaemonTaskDefinition_Volume AWS CloudFormation Resource (AWS::ECS::DaemonTaskDefinition.Volume)
...
type DaemonTaskDefinition_Volume struct {
	...
	Host *DaemonTaskDefinition_HostVolumeProperties `json:"Host,omitempty"`
...
func (r *DaemonTaskDefinition_Volume) AWSCloudFormationType() string {
	return "AWS::ECS::DaemonTaskDefinition.Volume"
}
