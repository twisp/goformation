...
// CapacityProvider_BaselineEbsBandwidthMbpsRequest AWS CloudFormation Resource (AWS::ECS::CapacityProvider.BaselineEbsBandwidthMbpsRequest)
...
func (r *CapacityProvider_BaselineEbsBandwidthMbpsRequest) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.BaselineEbsBandwidthMbpsRequest"
}
