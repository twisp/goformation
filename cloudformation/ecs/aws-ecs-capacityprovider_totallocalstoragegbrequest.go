...
// CapacityProvider_TotalLocalStorageGBRequest AWS CloudFormation Resource (AWS::ECS::CapacityProvider.TotalLocalStorageGBRequest)
...
func (r *CapacityProvider_TotalLocalStorageGBRequest) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.TotalLocalStorageGBRequest"
}
