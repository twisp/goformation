...
// Service_LinearConfiguration AWS CloudFormation Resource (AWS::ECS::Service.LinearConfiguration)
...
type Service_LinearConfiguration struct {
	...
	// StepBakeTimeInMinutes AWS CloudFormation Property
	// Required: false
	...
	// StepPercent AWS CloudFormation Property
	// Required: false
...
func (r *Service_LinearConfiguration) AWSCloudFormationType() string {
	return "AWS::ECS::Service.LinearConfiguration"
}
