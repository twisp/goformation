...
// DaemonTaskDefinition_MountPoint AWS CloudFormation Resource (AWS::ECS::DaemonTaskDefinition.MountPoint)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-daemontaskdefinition-mountpoint.html
type DaemonTaskDefinition_MountPoint struct {
...
func (r *DaemonTaskDefinition_MountPoint) AWSCloudFormationType() string {
	return "AWS::ECS::DaemonTaskDefinition.MountPoint"
}
