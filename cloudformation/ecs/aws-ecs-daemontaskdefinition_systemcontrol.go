...
// DaemonTaskDefinition_SystemControl AWS CloudFormation Resource (AWS::ECS::DaemonTaskDefinition.SystemControl)
...
type DaemonTaskDefinition_SystemControl struct {
...
func (r *DaemonTaskDefinition_SystemControl) AWSCloudFormationType() string {
	return "AWS::ECS::DaemonTaskDefinition.SystemControl"
}
