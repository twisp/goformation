...
// CapacityProvider_AutoRepairConfiguration AWS CloudFormation Resource (AWS::ECS::CapacityProvider.AutoRepairConfiguration)
...
type CapacityProvider_AutoRepairConfiguration struct {

	// ActionsStatus AWS CloudFormation Property
	// Required: false
...
func (r *CapacityProvider_AutoRepairConfiguration) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.AutoRepairConfiguration"
}
