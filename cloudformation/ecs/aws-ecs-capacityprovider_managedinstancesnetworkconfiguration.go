...
// CapacityProvider_ManagedInstancesNetworkConfiguration AWS CloudFormation Resource (AWS::ECS::CapacityProvider.ManagedInstancesNetworkConfiguration)
...
func (r *CapacityProvider_ManagedInstancesNetworkConfiguration) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.ManagedInstancesNetworkConfiguration"
}
