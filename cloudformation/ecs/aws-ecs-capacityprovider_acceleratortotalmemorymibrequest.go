...
// CapacityProvider_AcceleratorTotalMemoryMiBRequest AWS CloudFormation Resource (AWS::ECS::CapacityProvider.AcceleratorTotalMemoryMiBRequest)
...
func (r *CapacityProvider_AcceleratorTotalMemoryMiBRequest) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.AcceleratorTotalMemoryMiBRequest"
}
