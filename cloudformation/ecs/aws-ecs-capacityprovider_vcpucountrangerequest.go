...
// CapacityProvider_VCpuCountRangeRequest AWS CloudFormation Resource (AWS::ECS::CapacityProvider.VCpuCountRangeRequest)
...
func (r *CapacityProvider_VCpuCountRangeRequest) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.VCpuCountRangeRequest"
}
