...
// ExpressGatewayService AWS CloudFormation Resource (AWS::ECS::ExpressGatewayService)
...
func (r *ExpressGatewayService) AWSCloudFormationType() string {
	return "AWS::ECS::ExpressGatewayService"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ExpressGatewayService) MarshalJSON() ([]byte, error) {
	type Properties ExpressGatewayService
...
func (r *ExpressGatewayService) UnmarshalJSON(b []byte) error {
	type Properties ExpressGatewayService
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ExpressGatewayService(*res.Properties)
	}
