...
// CapacityProvider_MemoryGiBPerVCpuRequest AWS CloudFormation Resource (AWS::ECS::CapacityProvider.MemoryGiBPerVCpuRequest)
...
func (r *CapacityProvider_MemoryGiBPerVCpuRequest) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.MemoryGiBPerVCpuRequest"
}
