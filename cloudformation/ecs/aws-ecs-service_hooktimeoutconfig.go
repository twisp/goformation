...
// Service_HookTimeoutConfig AWS CloudFormation Resource (AWS::ECS::Service.HookTimeoutConfig)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ecs-service-hooktimeoutconfig.html
type Service_HookTimeoutConfig struct {
...
func (r *Service_HookTimeoutConfig) AWSCloudFormationType() string {
	return "AWS::ECS::Service.HookTimeoutConfig"
}
