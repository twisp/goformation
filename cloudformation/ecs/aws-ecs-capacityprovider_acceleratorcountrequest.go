...
// CapacityProvider_AcceleratorCountRequest AWS CloudFormation Resource (AWS::ECS::CapacityProvider.AcceleratorCountRequest)
...
func (r *CapacityProvider_AcceleratorCountRequest) AWSCloudFormationType() string {
	return "AWS::ECS::CapacityProvider.AcceleratorCountRequest"
}
