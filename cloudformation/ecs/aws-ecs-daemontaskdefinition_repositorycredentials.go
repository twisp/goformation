...
// DaemonTaskDefinition_RepositoryCredentials AWS CloudFormation Resource (AWS::ECS::DaemonTaskDefinition.RepositoryCredentials)
...
type DaemonTaskDefinition_RepositoryCredentials struct {
...
func (r *DaemonTaskDefinition_RepositoryCredentials) AWSCloudFormationType() string {
	return "AWS::ECS::DaemonTaskDefinition.RepositoryCredentials"
}
