...
// Table_StorageClassConfiguration AWS CloudFormation Resource (AWS::S3Tables::Table.StorageClassConfiguration)
...
func (r *Table_StorageClassConfiguration) AWSCloudFormationType() string {
	return "AWS::S3Tables::Table.StorageClassConfiguration"
}
