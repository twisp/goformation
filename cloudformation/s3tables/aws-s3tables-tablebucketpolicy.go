...
// TableBucketPolicy AWS CloudFormation Resource (AWS::S3Tables::TableBucketPolicy)
...
func (r *TableBucketPolicy) AWSCloudFormationType() string {
	return "AWS::S3Tables::TableBucketPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TableBucketPolicy) MarshalJSON() ([]byte, error) {
	type Properties TableBucketPolicy
...
func (r *TableBucketPolicy) UnmarshalJSON(b []byte) error {
	type Properties TableBucketPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TableBucketPolicy(*res.Properties)
	}
