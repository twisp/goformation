...
type Table struct {
	...
	// Compaction AWS CloudFormation Property
	// Required: false
	...
	// IcebergMetadata AWS CloudFormation Property
	// Required: false
	...
	// OpenTableFormat AWS CloudFormation Property
	// Required: true
	...
	OpenTableFormat string `json:"OpenTableFormat"`

	// SnapshotManagement AWS CloudFormation Property
	// Required: false
