...
// TablePolicy AWS CloudFormation Resource (AWS::S3Tables::TablePolicy)
...
func (r *TablePolicy) AWSCloudFormationType() string {
	return "AWS::S3Tables::TablePolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TablePolicy) MarshalJSON() ([]byte, error) {
	type Properties TablePolicy
...
func (r *TablePolicy) UnmarshalJSON(b []byte) error {
	type Properties TablePolicy
	res := &struct {
		Type                string
		Properties          *Properties
