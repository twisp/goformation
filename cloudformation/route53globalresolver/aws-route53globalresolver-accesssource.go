...
// AccessSource AWS CloudFormation Resource (AWS::Route53GlobalResolver::AccessSource)
...
func (r *AccessSource) AWSCloudFormationType() string {
	return "AWS::Route53GlobalResolver::AccessSource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AccessSource) MarshalJSON() ([]byte, error) {
	type Properties AccessSource
...
func (r *AccessSource) UnmarshalJSON(b []byte) error {
	type Properties AccessSource
	res := &struct {
		Type                string
		Properties          *Properties
