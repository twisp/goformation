...
// HostedZoneAssociation AWS CloudFormation Resource (AWS::Route53GlobalResolver::HostedZoneAssociation)
...
func (r *HostedZoneAssociation) AWSCloudFormationType() string {
	return "AWS::Route53GlobalResolver::HostedZoneAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r HostedZoneAssociation) MarshalJSON() ([]byte, error) {
	type Properties HostedZoneAssociation
...
func (r *HostedZoneAssociation) UnmarshalJSON(b []byte) error {
	type Properties HostedZoneAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = HostedZoneAssociation(*res.Properties)
	}
