...
// AccessToken AWS CloudFormation Resource (AWS::Route53GlobalResolver::AccessToken)
...
func (r *AccessToken) AWSCloudFormationType() string {
	return "AWS::Route53GlobalResolver::AccessToken"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AccessToken) MarshalJSON() ([]byte, error) {
	type Properties AccessToken
