...
// DnsView AWS CloudFormation Resource (AWS::Route53GlobalResolver::DnsView)
...
type DnsView struct {
	...
	// DnssecValidation AWS CloudFormation Property
	// Required: false
	...
	// EdnsClientSubnet AWS CloudFormation Property
	// Required: false
	...
	// FirewallRulesFailOpen AWS CloudFormation Property
	// Required: false
	...
	// GlobalResolverId AWS CloudFormation Property
	// Required: true
	...
	GlobalResolverId string `json:"GlobalResolverId"`
...
func (r *DnsView) AWSCloudFormationType() string {
	return "AWS::Route53GlobalResolver::DnsView"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DnsView) MarshalJSON() ([]byte, error) {
	type Properties DnsView
...
func (r *DnsView) UnmarshalJSON(b []byte) error {
	type Properties DnsView
	res := &struct {
		Type                string
		Properties          *Properties
