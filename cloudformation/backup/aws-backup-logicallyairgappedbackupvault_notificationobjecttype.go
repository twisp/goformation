...
// LogicallyAirGappedBackupVault_NotificationObjectType AWS CloudFormation Resource (AWS::Backup::LogicallyAirGappedBackupVault.NotificationObjectType)
...
func (r *LogicallyAirGappedBackupVault_NotificationObjectType) AWSCloudFormationType() string {
	return "AWS::Backup::LogicallyAirGappedBackupVault.NotificationObjectType"
}
