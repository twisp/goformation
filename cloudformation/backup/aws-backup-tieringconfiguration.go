...
// TieringConfiguration AWS CloudFormation Resource (AWS::Backup::TieringConfiguration)
...
type TieringConfiguration struct {
	...
	// ResourceSelection AWS CloudFormation Property
	// Required: true
	...
	ResourceSelection []TieringConfiguration_ResourceSelection `json:"ResourceSelection"`

	// TieringConfigurationName AWS CloudFormation Property
	// Required: true
	...
	// TieringConfigurationTags AWS CloudFormation Property
	// Required: false
...
func (r *TieringConfiguration) AWSCloudFormationType() string {
	return "AWS::Backup::TieringConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TieringConfiguration) MarshalJSON() ([]byte, error) {
	type Properties TieringConfiguration
...
func (r *TieringConfiguration) UnmarshalJSON(b []byte) error {
	type Properties TieringConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TieringConfiguration(*res.Properties)
	}
