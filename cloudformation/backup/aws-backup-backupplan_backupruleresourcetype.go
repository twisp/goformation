...
type BackupPlan_BackupRuleResourceType struct {
	...
	// IndexActions AWS CloudFormation Property
	// Required: false
	...
	// ScanActions AWS CloudFormation Property
	// Required: false
	...
	ScanActions []BackupPlan_ScanActionResourceType `json:"ScanActions,omitempty"`
	...
	// TargetLogicallyAirGappedBackupVaultArn AWS CloudFormation Property
	// Required: false
