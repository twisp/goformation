...
// LogicallyAirGappedBackupVault AWS CloudFormation Resource (AWS::Backup::LogicallyAirGappedBackupVault)
...
func (r *LogicallyAirGappedBackupVault) AWSCloudFormationType() string {
	return "AWS::Backup::LogicallyAirGappedBackupVault"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LogicallyAirGappedBackupVault) MarshalJSON() ([]byte, error) {
	type Properties LogicallyAirGappedBackupVault
...
func (r *LogicallyAirGappedBackupVault) UnmarshalJSON(b []byte) error {
	type Properties LogicallyAirGappedBackupVault
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LogicallyAirGappedBackupVault(*res.Properties)
	}
