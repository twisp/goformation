...
// IngestConfiguration AWS CloudFormation Resource (AWS::IVS::IngestConfiguration)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ivs-ingestconfiguration.html
type IngestConfiguration struct {

	// IngestProtocol AWS CloudFormation Property
	// Required: false
	...
	// StageArn AWS CloudFormation Property
	// Required: false
...
func (r *IngestConfiguration) AWSCloudFormationType() string {
	return "AWS::IVS::IngestConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IngestConfiguration) MarshalJSON() ([]byte, error) {
	type Properties IngestConfiguration
...
func (r *IngestConfiguration) UnmarshalJSON(b []byte) error {
	type Properties IngestConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IngestConfiguration(*res.Properties)
	}
