...
// Stage_AutoParticipantRecordingConfiguration AWS CloudFormation Resource (AWS::IVS::Stage.AutoParticipantRecordingConfiguration)
...
type Stage_AutoParticipantRecordingConfiguration struct {
	...
	// MediaTypes AWS CloudFormation Property
	// Required: false
	...
	// StorageConfigurationArn AWS CloudFormation Property
	// Required: true
	...
	ThumbnailConfiguration *Stage_ThumbnailConfiguration `json:"ThumbnailConfiguration,omitempty"`
...
func (r *Stage_AutoParticipantRecordingConfiguration) AWSCloudFormationType() string {
	return "AWS::IVS::Stage.AutoParticipantRecordingConfiguration"
}
