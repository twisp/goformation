...
// PlaybackRestrictionPolicy AWS CloudFormation Resource (AWS::IVS::PlaybackRestrictionPolicy)
...
func (r *PlaybackRestrictionPolicy) AWSCloudFormationType() string {
	return "AWS::IVS::PlaybackRestrictionPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PlaybackRestrictionPolicy) MarshalJSON() ([]byte, error) {
	type Properties PlaybackRestrictionPolicy
...
func (r *PlaybackRestrictionPolicy) UnmarshalJSON(b []byte) error {
	type Properties PlaybackRestrictionPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PlaybackRestrictionPolicy(*res.Properties)
	}
