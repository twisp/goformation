...
// Stage_ParticipantRecordingHlsConfiguration AWS CloudFormation Resource (AWS::IVS::Stage.ParticipantRecordingHlsConfiguration)
...
type Stage_ParticipantRecordingHlsConfiguration struct {
	...
	// TargetSegmentDurationSeconds AWS CloudFormation Property
	// Required: false
...
func (r *Stage_ParticipantRecordingHlsConfiguration) AWSCloudFormationType() string {
	return "AWS::IVS::Stage.ParticipantRecordingHlsConfiguration"
}
