...
// ServiceLevelObjective_SelectionConfig AWS CloudFormation Resource (AWS::ApplicationSignals::ServiceLevelObjective.SelectionConfig)
...
type ServiceLevelObjective_SelectionConfig struct {
...
func (r *ServiceLevelObjective_SelectionConfig) AWSCloudFormationType() string {
	return "AWS::ApplicationSignals::ServiceLevelObjective.SelectionConfig"
}
