...
// ServicePrincipalName AWS CloudFormation Resource (AWS::PCAConnectorAD::ServicePrincipalName)
...
type ServicePrincipalName struct {
	...
	DirectoryRegistrationArn string `json:"DirectoryRegistrationArn"`
...
func (r *ServicePrincipalName) AWSCloudFormationType() string {
	return "AWS::PCAConnectorAD::ServicePrincipalName"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ServicePrincipalName) MarshalJSON() ([]byte, error) {
	type Properties ServicePrincipalName
...
func (r *ServicePrincipalName) UnmarshalJSON(b []byte) error {
	type Properties ServicePrincipalName
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ServicePrincipalName(*res.Properties)
	}
