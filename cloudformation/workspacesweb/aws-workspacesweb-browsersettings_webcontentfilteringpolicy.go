...
// BrowserSettings_WebContentFilteringPolicy AWS CloudFormation Resource (AWS::WorkSpacesWeb::BrowserSettings.WebContentFilteringPolicy)
...
type BrowserSettings_WebContentFilteringPolicy struct {
	...
	// BlockedCategories AWS CloudFormation Property
	// Required: false
	...
	// BlockedUrls AWS CloudFormation Property
	// Required: false
...
func (r *BrowserSettings_WebContentFilteringPolicy) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::BrowserSettings.WebContentFilteringPolicy"
}
