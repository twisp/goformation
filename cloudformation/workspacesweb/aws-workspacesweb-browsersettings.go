...
// BrowserSettings AWS CloudFormation Resource (AWS::WorkSpacesWeb::BrowserSettings)
...
func (r *BrowserSettings) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::BrowserSettings"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BrowserSettings) MarshalJSON() ([]byte, error) {
	type Properties BrowserSettings
...
func (r *BrowserSettings) UnmarshalJSON(b []byte) error {
	type Properties BrowserSettings
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = BrowserSettings(*res.Properties)
	}
