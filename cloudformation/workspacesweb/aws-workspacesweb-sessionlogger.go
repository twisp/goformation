...
// SessionLogger AWS CloudFormation Resource (AWS::WorkSpacesWeb::SessionLogger)
...
type SessionLogger struct {
	...
	EventFilter *SessionLogger_EventFilter `json:"EventFilter"`
	...
	LogConfiguration *SessionLogger_LogConfiguration `json:"LogConfiguration"`
...
func (r *SessionLogger) AWSCloudFormationType() string {
	return "AWS::WorkSpacesWeb::SessionLogger"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SessionLogger) MarshalJSON() ([]byte, error) {
	type Properties SessionLogger
...
func (r *SessionLogger) UnmarshalJSON(b []byte) error {
	type Properties SessionLogger
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SessionLogger(*res.Properties)
	}
