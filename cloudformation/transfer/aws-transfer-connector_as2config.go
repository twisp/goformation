...
type Connector_As2Config struct {
	...
	// AsyncMdnConfig AWS CloudFormation Property
	// Required: false
	...
	AsyncMdnConfig *Connector_ConnectorAsyncMdnConfig `json:"AsyncMdnConfig,omitempty"`
	...
	// PreserveContentType AWS CloudFormation Property
	// Required: false
