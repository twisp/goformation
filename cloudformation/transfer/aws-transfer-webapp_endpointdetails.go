...
// WebApp_EndpointDetails AWS CloudFormation Resource (AWS::Transfer::WebApp.EndpointDetails)
...
type WebApp_EndpointDetails struct {
	...
	Vpc *WebApp_Vpc `json:"Vpc,omitempty"`
...
func (r *WebApp_EndpointDetails) AWSCloudFormationType() string {
	return "AWS::Transfer::WebApp.EndpointDetails"
}
