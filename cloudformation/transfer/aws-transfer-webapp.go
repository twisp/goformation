...
type WebApp struct {
	...
	IdentityProviderDetails *WebApp_IdentityProviderDetails `json:"IdentityProviderDetails"`
	...
	// WebAppCustomization AWS CloudFormation Property
	// Required: false
...
func (r *WebApp) AWSCloudFormationType() string {
	return "AWS::Transfer::WebApp"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r WebApp) MarshalJSON() ([]byte, error) {
	type Properties WebApp
...
func (r *WebApp) UnmarshalJSON(b []byte) error {
	type Properties WebApp
	res := &struct {
		Type                string
		Properties          *Properties
