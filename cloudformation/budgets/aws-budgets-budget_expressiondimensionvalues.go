...
// Budget_ExpressionDimensionValues AWS CloudFormation Resource (AWS::Budgets::Budget.ExpressionDimensionValues)
...
func (r *Budget_ExpressionDimensionValues) AWSCloudFormationType() string {
	return "AWS::Budgets::Budget.ExpressionDimensionValues"
}
