...
// Transformer_SplitStringEntry AWS CloudFormation Resource (AWS::Logs::Transformer.SplitStringEntry)
...
func (r *Transformer_SplitStringEntry) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.SplitStringEntry"
}
