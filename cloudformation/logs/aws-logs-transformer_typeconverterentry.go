...
// Transformer_TypeConverterEntry AWS CloudFormation Resource (AWS::Logs::Transformer.TypeConverterEntry)
...
func (r *Transformer_TypeConverterEntry) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.TypeConverterEntry"
}
