...
// Delivery AWS CloudFormation Resource (AWS::Logs::Delivery)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-delivery.html
type Delivery struct {

	// DeliveryDestinationArn AWS CloudFormation Property
	// Required: true
	...
	// DeliverySourceName AWS CloudFormation Property
	// Required: true
	...
	// RecordFields AWS CloudFormation Property
	// Required: false
	...
	// S3EnableHiveCompatiblePath AWS CloudFormation Property
	// Required: false
	...
	// S3SuffixPath AWS CloudFormation Property
	// Required: false
...
func (r *Delivery) AWSCloudFormationType() string {
	return "AWS::Logs::Delivery"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Delivery) MarshalJSON() ([]byte, error) {
	type Properties Delivery
...
func (r *Delivery) UnmarshalJSON(b []byte) error {
	type Properties Delivery
	res := &struct {
		Type                string
		Properties          *Properties
