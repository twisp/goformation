...
// Transformer_ParseCloudfront AWS CloudFormation Resource (AWS::Logs::Transformer.ParseCloudfront)
...
func (r *Transformer_ParseCloudfront) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.ParseCloudfront"
}
