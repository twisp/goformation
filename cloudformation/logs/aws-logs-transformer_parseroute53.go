...
// Transformer_ParseRoute53 AWS CloudFormation Resource (AWS::Logs::Transformer.ParseRoute53)
...
func (r *Transformer_ParseRoute53) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.ParseRoute53"
}
