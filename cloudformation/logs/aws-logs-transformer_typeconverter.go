...
// Transformer_TypeConverter AWS CloudFormation Resource (AWS::Logs::Transformer.TypeConverter)
...
type Transformer_TypeConverter struct {
	...
	Entries []Transformer_TypeConverterEntry `json:"Entries"`
...
func (r *Transformer_TypeConverter) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.TypeConverter"
}
