...
// Transformer_DeleteKeys AWS CloudFormation Resource (AWS::Logs::Transformer.DeleteKeys)
...
func (r *Transformer_DeleteKeys) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.DeleteKeys"
}
