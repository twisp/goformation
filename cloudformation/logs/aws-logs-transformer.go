...
// Transformer AWS CloudFormation Resource (AWS::Logs::Transformer)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-transformer.html
type Transformer struct {

	// LogGroupIdentifier AWS CloudFormation Property
	// Required: true
	...
	// TransformerConfig AWS CloudFormation Property
	// Required: true
	...
	TransformerConfig []Transformer_Processor `json:"TransformerConfig"`
...
func (r *Transformer) AWSCloudFormationType() string {
...
func (r *Transformer) UnmarshalJSON(b []byte) error {
	type Properties Transformer
	res := &struct {
		Type                string
		Properties          *Properties
