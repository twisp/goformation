...
// Transformer_RenameKeyEntry AWS CloudFormation Resource (AWS::Logs::Transformer.RenameKeyEntry)
...
type Transformer_RenameKeyEntry struct {
	...
	// RenameTo AWS CloudFormation Property
	// Required: true
...
func (r *Transformer_RenameKeyEntry) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.RenameKeyEntry"
}
