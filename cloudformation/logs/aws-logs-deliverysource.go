...
// DeliverySource AWS CloudFormation Resource (AWS::Logs::DeliverySource)
...
type DeliverySource struct {
	...
	// DeliverySourceConfiguration AWS CloudFormation Property
	// Required: false
...
func (r *DeliverySource) AWSCloudFormationType() string {
	return "AWS::Logs::DeliverySource"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DeliverySource) MarshalJSON() ([]byte, error) {
	type Properties DeliverySource
...
func (r *DeliverySource) UnmarshalJSON(b []byte) error {
	type Properties DeliverySource
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DeliverySource(*res.Properties)
	}
