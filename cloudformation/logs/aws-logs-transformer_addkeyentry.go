...
// Transformer_AddKeyEntry AWS CloudFormation Resource (AWS::Logs::Transformer.AddKeyEntry)
...
func (r *Transformer_AddKeyEntry) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.AddKeyEntry"
}
