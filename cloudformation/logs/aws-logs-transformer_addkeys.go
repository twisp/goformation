...
// Transformer_AddKeys AWS CloudFormation Resource (AWS::Logs::Transformer.AddKeys)
...
type Transformer_AddKeys struct {
	...
	Entries []Transformer_AddKeyEntry `json:"Entries"`
...
func (r *Transformer_AddKeys) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.AddKeys"
}
