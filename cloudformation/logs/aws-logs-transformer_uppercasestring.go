...
// Transformer_UpperCaseString AWS CloudFormation Resource (AWS::Logs::Transformer.UpperCaseString)
...
func (r *Transformer_UpperCaseString) AWSCloudFormationType() string {
	return "AWS::Logs::Transformer.UpperCaseString"
}
