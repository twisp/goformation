...
// DeliveryDestination AWS CloudFormation Resource (AWS::Logs::DeliveryDestination)
...
func (r *DeliveryDestination) AWSCloudFormationType() string {
	return "AWS::Logs::DeliveryDestination"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DeliveryDestination) MarshalJSON() ([]byte, error) {
	type Properties DeliveryDestination
...
func (r *DeliveryDestination) UnmarshalJSON(b []byte) error {
	type Properties DeliveryDestination
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DeliveryDestination(*res.Properties)
	}
