...
// Deployment AWS CloudFormation Resource (AWS::LaunchWizard::Deployment)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-launchwizard-deployment.html
type Deployment struct {

	// DeploymentPatternName AWS CloudFormation Property
	// Required: true
	...
	DeploymentPatternName string `json:"DeploymentPatternName"`
	...
	// WorkloadName AWS CloudFormation Property
	// Required: true
