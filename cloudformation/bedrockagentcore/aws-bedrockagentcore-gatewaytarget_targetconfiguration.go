...
// GatewayTarget_TargetConfiguration AWS CloudFormation Resource (AWS::BedrockAgentCore::GatewayTarget.TargetConfiguration)
...
type GatewayTarget_TargetConfiguration struct {
	...
	Mcp *GatewayTarget_McpTargetConfiguration `json:"Mcp"`
...
func (r *GatewayTarget_TargetConfiguration) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::GatewayTarget.TargetConfiguration"
}
