...
// Memory_MessageBasedTriggerInput AWS CloudFormation Resource (AWS::BedrockAgentCore::Memory.MessageBasedTriggerInput)
...
type Memory_MessageBasedTriggerInput struct {
	...
	// MessageCount AWS CloudFormation Property
	// Required: false
...
func (r *Memory_MessageBasedTriggerInput) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Memory.MessageBasedTriggerInput"
}
