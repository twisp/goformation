...
// Memory_StringValidation AWS CloudFormation Resource (AWS::BedrockAgentCore::Memory.StringValidation)
...
type Memory_StringValidation struct {
...
func (r *Memory_StringValidation) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Memory.StringValidation"
}
