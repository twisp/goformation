...
// Harness_ClaimMatchValueType AWS CloudFormation Resource (AWS::BedrockAgentCore::Harness.ClaimMatchValueType)
...
type Harness_ClaimMatchValueType struct {
...
func (r *Harness_ClaimMatchValueType) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Harness.ClaimMatchValueType"
}
