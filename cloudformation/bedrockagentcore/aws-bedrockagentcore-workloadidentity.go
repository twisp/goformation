...
// WorkloadIdentity AWS CloudFormation Resource (AWS::BedrockAgentCore::WorkloadIdentity)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-workloadidentity.html
type WorkloadIdentity struct {

	// AllowedResourceOauth2ReturnUrls AWS CloudFormation Property
	// Required: false
...
func (r *WorkloadIdentity) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::WorkloadIdentity"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r WorkloadIdentity) MarshalJSON() ([]byte, error) {
	type Properties WorkloadIdentity
...
func (r *WorkloadIdentity) UnmarshalJSON(b []byte) error {
	type Properties WorkloadIdentity
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = WorkloadIdentity(*res.Properties)
	}
