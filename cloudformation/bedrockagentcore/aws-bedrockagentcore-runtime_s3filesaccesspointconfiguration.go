...
// Runtime_S3FilesAccessPointConfiguration AWS CloudFormation Resource (AWS::BedrockAgentCore::Runtime.S3FilesAccessPointConfiguration)
...
type Runtime_S3FilesAccessPointConfiguration struct {
...
func (r *Runtime_S3FilesAccessPointConfiguration) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Runtime.S3FilesAccessPointConfiguration"
}
