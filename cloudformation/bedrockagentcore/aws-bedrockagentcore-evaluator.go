...
// Evaluator AWS CloudFormation Resource (AWS::BedrockAgentCore::Evaluator)
...
type Evaluator struct {
	...
	// EvaluatorConfig AWS CloudFormation Property
	// Required: true
	...
	EvaluatorConfig *Evaluator_EvaluatorConfig `json:"EvaluatorConfig"`

	// EvaluatorName AWS CloudFormation Property
	// Required: true
...
func (r *Evaluator) AWSCloudFormationType() string {
...
func (r *Evaluator) UnmarshalJSON(b []byte) error {
	type Properties Evaluator
	res := &struct {
		Type                string
		Properties          *Properties
