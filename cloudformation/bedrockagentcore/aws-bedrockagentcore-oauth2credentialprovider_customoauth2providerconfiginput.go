...
// OAuth2CredentialProvider_CustomOauth2ProviderConfigInput AWS CloudFormation Resource (AWS::BedrockAgentCore::OAuth2CredentialProvider.CustomOauth2ProviderConfigInput)
...
type OAuth2CredentialProvider_CustomOauth2ProviderConfigInput struct {
	...
	OauthDiscovery *OAuth2CredentialProvider_Oauth2Discovery `json:"OauthDiscovery"`
...
func (r *OAuth2CredentialProvider_CustomOauth2ProviderConfigInput) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::OAuth2CredentialProvider.CustomOauth2ProviderConfigInput"
}
