...
// OnlineEvaluationConfig_Filter AWS CloudFormation Resource (AWS::BedrockAgentCore::OnlineEvaluationConfig.Filter)
...
type OnlineEvaluationConfig_Filter struct {
	...
	Value *OnlineEvaluationConfig_FilterValue `json:"Value"`
...
func (r *OnlineEvaluationConfig_Filter) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::OnlineEvaluationConfig.Filter"
}
