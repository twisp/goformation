...
// OnlineEvaluationConfig_CloudWatchLogsInputConfig AWS CloudFormation Resource (AWS::BedrockAgentCore::OnlineEvaluationConfig.CloudWatchLogsInputConfig)
...
type OnlineEvaluationConfig_CloudWatchLogsInputConfig struct {
	...
	// ServiceNames AWS CloudFormation Property
	// Required: true
...
func (r *OnlineEvaluationConfig_CloudWatchLogsInputConfig) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::OnlineEvaluationConfig.CloudWatchLogsInputConfig"
}
