...
// Memory_SelfManagedConfiguration AWS CloudFormation Resource (AWS::BedrockAgentCore::Memory.SelfManagedConfiguration)
...
type Memory_SelfManagedConfiguration struct {
	...
	// HistoricalContextWindowSize AWS CloudFormation Property
	// Required: false
	...
	// InvocationConfiguration AWS CloudFormation Property
	// Required: false
	...
	// TriggerConditions AWS CloudFormation Property
	// Required: false
...
func (r *Memory_SelfManagedConfiguration) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Memory.SelfManagedConfiguration"
}
