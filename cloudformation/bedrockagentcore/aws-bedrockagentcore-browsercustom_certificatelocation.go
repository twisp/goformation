...
// BrowserCustom_CertificateLocation AWS CloudFormation Resource (AWS::BedrockAgentCore::BrowserCustom.CertificateLocation)
...
type BrowserCustom_CertificateLocation struct {
...
func (r *BrowserCustom_CertificateLocation) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::BrowserCustom.CertificateLocation"
}
