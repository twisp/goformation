...
// Gateway_AuthorizingClaimMatchValueType AWS CloudFormation Resource (AWS::BedrockAgentCore::Gateway.AuthorizingClaimMatchValueType)
...
type Gateway_AuthorizingClaimMatchValueType struct {
	...
	ClaimMatchValue *Gateway_ClaimMatchValueType `json:"ClaimMatchValue"`
...
func (r *Gateway_AuthorizingClaimMatchValueType) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Gateway.AuthorizingClaimMatchValueType"
}
