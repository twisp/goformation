...
// CodeInterpreterCustom_CertificateLocation AWS CloudFormation Resource (AWS::BedrockAgentCore::CodeInterpreterCustom.CertificateLocation)
...
type CodeInterpreterCustom_CertificateLocation struct {
...
func (r *CodeInterpreterCustom_CertificateLocation) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::CodeInterpreterCustom.CertificateLocation"
}
