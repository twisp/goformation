...
// PaymentCredentialProvider AWS CloudFormation Resource (AWS::BedrockAgentCore::PaymentCredentialProvider)
...
type PaymentCredentialProvider struct {
	...
	// ProviderConfigurationInput AWS CloudFormation Property
	// Required: false
	...
	ProviderConfigurationInput *PaymentCredentialProvider_PaymentProviderConfigurationInput `json:"ProviderConfigurationInput,omitempty"`
...
func (r *PaymentCredentialProvider) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::PaymentCredentialProvider"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PaymentCredentialProvider) MarshalJSON() ([]byte, error) {
	type Properties PaymentCredentialProvider
...
func (r *PaymentCredentialProvider) UnmarshalJSON(b []byte) error {
	type Properties PaymentCredentialProvider
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PaymentCredentialProvider(*res.Properties)
	}
