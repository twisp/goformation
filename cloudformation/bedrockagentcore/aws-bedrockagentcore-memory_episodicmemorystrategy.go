...
// Memory_EpisodicMemoryStrategy AWS CloudFormation Resource (AWS::BedrockAgentCore::Memory.EpisodicMemoryStrategy)
...
type Memory_EpisodicMemoryStrategy struct {
	...
	// ReflectionConfiguration AWS CloudFormation Property
	// Required: false
...
func (r *Memory_EpisodicMemoryStrategy) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Memory.EpisodicMemoryStrategy"
}
