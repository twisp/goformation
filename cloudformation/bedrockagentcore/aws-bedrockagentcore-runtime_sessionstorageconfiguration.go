...
// Runtime_SessionStorageConfiguration AWS CloudFormation Resource (AWS::BedrockAgentCore::Runtime.SessionStorageConfiguration)
...
type Runtime_SessionStorageConfiguration struct {
...
func (r *Runtime_SessionStorageConfiguration) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Runtime.SessionStorageConfiguration"
}
