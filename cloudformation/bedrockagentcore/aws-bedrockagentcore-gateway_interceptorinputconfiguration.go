...
// Gateway_InterceptorInputConfiguration AWS CloudFormation Resource (AWS::BedrockAgentCore::Gateway.InterceptorInputConfiguration)
...
type Gateway_InterceptorInputConfiguration struct {
	...
	// PassRequestHeaders AWS CloudFormation Property
	// Required: true
...
func (r *Gateway_InterceptorInputConfiguration) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Gateway.InterceptorInputConfiguration"
}
