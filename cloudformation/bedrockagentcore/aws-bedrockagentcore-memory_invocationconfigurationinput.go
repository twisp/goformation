...
// Memory_InvocationConfigurationInput AWS CloudFormation Resource (AWS::BedrockAgentCore::Memory.InvocationConfigurationInput)
...
type Memory_InvocationConfigurationInput struct {
	...
	// PayloadDeliveryBucketName AWS CloudFormation Property
	// Required: false
...
func (r *Memory_InvocationConfigurationInput) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Memory.InvocationConfigurationInput"
}
