...
// Runtime_AuthorizingClaimMatchValueType AWS CloudFormation Resource (AWS::BedrockAgentCore::Runtime.AuthorizingClaimMatchValueType)
...
type Runtime_AuthorizingClaimMatchValueType struct {
	...
	ClaimMatchValue *Runtime_ClaimMatchValueType `json:"ClaimMatchValue"`
...
func (r *Runtime_AuthorizingClaimMatchValueType) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Runtime.AuthorizingClaimMatchValueType"
}
