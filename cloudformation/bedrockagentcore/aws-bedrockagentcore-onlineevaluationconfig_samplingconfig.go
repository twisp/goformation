...
// OnlineEvaluationConfig_SamplingConfig AWS CloudFormation Resource (AWS::BedrockAgentCore::OnlineEvaluationConfig.SamplingConfig)
...
type OnlineEvaluationConfig_SamplingConfig struct {
...
func (r *OnlineEvaluationConfig_SamplingConfig) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::OnlineEvaluationConfig.SamplingConfig"
}
