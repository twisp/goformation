...
// RuntimeEndpoint AWS CloudFormation Resource (AWS::BedrockAgentCore::RuntimeEndpoint)
...
type RuntimeEndpoint struct {
	...
	// AgentRuntimeVersion AWS CloudFormation Property
	// Required: false
...
func (r *RuntimeEndpoint) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::RuntimeEndpoint"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RuntimeEndpoint) MarshalJSON() ([]byte, error) {
	type Properties RuntimeEndpoint
...
func (r *RuntimeEndpoint) UnmarshalJSON(b []byte) error {
	type Properties RuntimeEndpoint
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = RuntimeEndpoint(*res.Properties)
	}
