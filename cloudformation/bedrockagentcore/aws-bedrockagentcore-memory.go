...
// Memory AWS CloudFormation Resource (AWS::BedrockAgentCore::Memory)
...
type Memory struct {
	...
	// EventExpiryDuration AWS CloudFormation Property
	// Required: true
	...
	// MemoryStrategies AWS CloudFormation Property
	// Required: false
...
func (r *Memory) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Memory"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Memory) MarshalJSON() ([]byte, error) {
...
func (r *Memory) UnmarshalJSON(b []byte) error {
	type Properties Memory
	res := &struct {
		Type                string
		Properties          *Properties
