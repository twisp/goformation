...
// PaymentManager_ClaimMatchValueType AWS CloudFormation Resource (AWS::BedrockAgentCore::PaymentManager.ClaimMatchValueType)
...
type PaymentManager_ClaimMatchValueType struct {
...
func (r *PaymentManager_ClaimMatchValueType) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::PaymentManager.ClaimMatchValueType"
}
