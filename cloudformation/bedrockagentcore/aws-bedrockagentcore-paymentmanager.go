...
// PaymentManager AWS CloudFormation Resource (AWS::BedrockAgentCore::PaymentManager)
...
type PaymentManager struct {
	...
	AuthorizerConfiguration *PaymentManager_AuthorizerConfiguration `json:"AuthorizerConfiguration,omitempty"`
...
func (r *PaymentManager) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::PaymentManager"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PaymentManager) MarshalJSON() ([]byte, error) {
	type Properties PaymentManager
...
func (r *PaymentManager) UnmarshalJSON(b []byte) error {
	type Properties PaymentManager
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PaymentManager(*res.Properties)
	}
