...
// Harness_HarnessAgentCoreBrowserConfig AWS CloudFormation Resource (AWS::BedrockAgentCore::Harness.HarnessAgentCoreBrowserConfig)
...
type Harness_HarnessAgentCoreBrowserConfig struct {

	// BrowserArn AWS CloudFormation Property
	// Required: false
...
func (r *Harness_HarnessAgentCoreBrowserConfig) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Harness.HarnessAgentCoreBrowserConfig"
}
