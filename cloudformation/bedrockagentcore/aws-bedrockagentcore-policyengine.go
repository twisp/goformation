...
// PolicyEngine AWS CloudFormation Resource (AWS::BedrockAgentCore::PolicyEngine)
...
func (r *PolicyEngine) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::PolicyEngine"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PolicyEngine) MarshalJSON() ([]byte, error) {
	type Properties PolicyEngine
...
func (r *PolicyEngine) UnmarshalJSON(b []byte) error {
	type Properties PolicyEngine
	res := &struct {
		Type                string
		Properties          *Properties
