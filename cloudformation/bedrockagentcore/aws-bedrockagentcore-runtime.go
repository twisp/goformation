...
// Runtime AWS CloudFormation Resource (AWS::BedrockAgentCore::Runtime)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-bedrockagentcore-runtime.html
type Runtime struct {

	// AgentRuntimeArtifact AWS CloudFormation Property
	// Required: true
	...
	AgentRuntimeArtifact *Runtime_AgentRuntimeArtifact `json:"AgentRuntimeArtifact"`
...
func (r *Runtime) AWSCloudFormationType() string {
