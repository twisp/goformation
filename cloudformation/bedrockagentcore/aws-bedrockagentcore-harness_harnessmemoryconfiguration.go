...
// Harness_HarnessMemoryConfiguration AWS CloudFormation Resource (AWS::BedrockAgentCore::Harness.HarnessMemoryConfiguration)
...
type Harness_HarnessMemoryConfiguration struct {

	// AgentCoreMemoryConfiguration AWS CloudFormation Property
	// Required: false
...
func (r *Harness_HarnessMemoryConfiguration) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Harness.HarnessMemoryConfiguration"
}
