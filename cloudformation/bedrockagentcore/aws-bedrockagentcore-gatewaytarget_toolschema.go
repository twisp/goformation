...
// GatewayTarget_ToolSchema AWS CloudFormation Resource (AWS::BedrockAgentCore::GatewayTarget.ToolSchema)
...
func (r *GatewayTarget_ToolSchema) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::GatewayTarget.ToolSchema"
}
