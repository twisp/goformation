...
// Harness_HarnessRemoteMcpConfig AWS CloudFormation Resource (AWS::BedrockAgentCore::Harness.HarnessRemoteMcpConfig)
...
type Harness_HarnessRemoteMcpConfig struct {
...
func (r *Harness_HarnessRemoteMcpConfig) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Harness.HarnessRemoteMcpConfig"
}
