...
// PaymentConnector AWS CloudFormation Resource (AWS::BedrockAgentCore::PaymentConnector)
...
type PaymentConnector struct {
	...
	// PaymentManagerId AWS CloudFormation Property
	// Required: true
...
func (r *PaymentConnector) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::PaymentConnector"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PaymentConnector) MarshalJSON() ([]byte, error) {
	type Properties PaymentConnector
...
func (r *PaymentConnector) UnmarshalJSON(b []byte) error {
	type Properties PaymentConnector
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PaymentConnector(*res.Properties)
	}
