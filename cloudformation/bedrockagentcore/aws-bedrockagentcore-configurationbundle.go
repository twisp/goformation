...
// ConfigurationBundle AWS CloudFormation Resource (AWS::BedrockAgentCore::ConfigurationBundle)
...
type ConfigurationBundle struct {
	...
	// BundleName AWS CloudFormation Property
	// Required: true
	...
	Components map[string]ConfigurationBundle_ComponentConfiguration `json:"Components"`
...
func (r *ConfigurationBundle) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::ConfigurationBundle"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ConfigurationBundle) MarshalJSON() ([]byte, error) {
	type Properties ConfigurationBundle
...
func (r *ConfigurationBundle) UnmarshalJSON(b []byte) error {
	type Properties ConfigurationBundle
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ConfigurationBundle(*res.Properties)
	}
