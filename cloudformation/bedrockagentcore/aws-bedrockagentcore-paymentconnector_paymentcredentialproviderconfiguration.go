...
// PaymentConnector_PaymentCredentialProviderConfiguration AWS CloudFormation Resource (AWS::BedrockAgentCore::PaymentConnector.PaymentCredentialProviderConfiguration)
...
type PaymentConnector_PaymentCredentialProviderConfiguration struct {

	// CredentialProviderArn AWS CloudFormation Property
	// Required: true
...
func (r *PaymentConnector_PaymentCredentialProviderConfiguration) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::PaymentConnector.PaymentCredentialProviderConfiguration"
}
