...
// PaymentManager_WorkloadIdentityDetails AWS CloudFormation Resource (AWS::BedrockAgentCore::PaymentManager.WorkloadIdentityDetails)
...
func (r *PaymentManager_WorkloadIdentityDetails) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::PaymentManager.WorkloadIdentityDetails"
}
