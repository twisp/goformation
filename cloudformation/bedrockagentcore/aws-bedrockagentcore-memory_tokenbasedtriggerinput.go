...
// Memory_TokenBasedTriggerInput AWS CloudFormation Resource (AWS::BedrockAgentCore::Memory.TokenBasedTriggerInput)
...
type Memory_TokenBasedTriggerInput struct {
	...
	// TokenCount AWS CloudFormation Property
	// Required: false
...
func (r *Memory_TokenBasedTriggerInput) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Memory.TokenBasedTriggerInput"
}
