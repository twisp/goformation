...
// Dataset AWS CloudFormation Resource (AWS::BedrockAgentCore::Dataset)
...
type Dataset struct {
	...
	// SchemaType AWS CloudFormation Property
	// Required: true
	...
	Source *Dataset_DataSourceType `json:"Source,omitempty"`
