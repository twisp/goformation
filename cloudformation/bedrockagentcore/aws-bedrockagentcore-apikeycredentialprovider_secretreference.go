...
// ApiKeyCredentialProvider_SecretReference AWS CloudFormation Resource (AWS::BedrockAgentCore::ApiKeyCredentialProvider.SecretReference)
...
type ApiKeyCredentialProvider_SecretReference struct {
...
func (r *ApiKeyCredentialProvider_SecretReference) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::ApiKeyCredentialProvider.SecretReference"
}
