...
// BrowserProfile AWS CloudFormation Resource (AWS::BedrockAgentCore::BrowserProfile)
...
func (r *BrowserProfile) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::BrowserProfile"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r BrowserProfile) MarshalJSON() ([]byte, error) {
	type Properties BrowserProfile
...
func (r *BrowserProfile) UnmarshalJSON(b []byte) error {
	type Properties BrowserProfile
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = BrowserProfile(*res.Properties)
	}
