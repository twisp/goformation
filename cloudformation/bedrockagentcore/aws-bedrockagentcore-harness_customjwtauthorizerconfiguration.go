...
// Harness_CustomJWTAuthorizerConfiguration AWS CloudFormation Resource (AWS::BedrockAgentCore::Harness.CustomJWTAuthorizerConfiguration)
...
type Harness_CustomJWTAuthorizerConfiguration struct {
	...
	CustomClaims []Harness_CustomClaimValidationType `json:"CustomClaims,omitempty"`
	...
	PrivateEndpoint *Harness_PrivateEndpoint `json:"PrivateEndpoint,omitempty"`
	...
	PrivateEndpointOverrides []Harness_PrivateEndpointOverride `json:"PrivateEndpointOverrides,omitempty"`
...
func (r *Harness_CustomJWTAuthorizerConfiguration) AWSCloudFormationType() string {
	return "AWS::BedrockAgentCore::Harness.CustomJWTAuthorizerConfiguration"
}
