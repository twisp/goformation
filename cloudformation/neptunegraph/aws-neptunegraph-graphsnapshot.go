...
// GraphSnapshot AWS CloudFormation Resource (AWS::NeptuneGraph::GraphSnapshot)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-neptunegraph-graphsnapshot.html
type GraphSnapshot struct {

	// GraphIdentifier AWS CloudFormation Property
	// Required: true
...
func (r *GraphSnapshot) AWSCloudFormationType() string {
	return "AWS::NeptuneGraph::GraphSnapshot"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r GraphSnapshot) MarshalJSON() ([]byte, error) {
	type Properties GraphSnapshot
...
func (r *GraphSnapshot) UnmarshalJSON(b []byte) error {
	type Properties GraphSnapshot
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = GraphSnapshot(*res.Properties)
	}
