...
// RouterInput_FlowTransitEncryption AWS CloudFormation Resource (AWS::MediaConnect::RouterInput.FlowTransitEncryption)
...
type RouterInput_FlowTransitEncryption struct {
	...
	EncryptionKeyConfiguration *RouterInput_FlowTransitEncryptionKeyConfiguration `json:"EncryptionKeyConfiguration"`
...
func (r *RouterInput_FlowTransitEncryption) AWSCloudFormationType() string {
	return "AWS::MediaConnect::RouterInput.FlowTransitEncryption"
}
