...
// RouterOutput_FlowTransitEncryption AWS CloudFormation Resource (AWS::MediaConnect::RouterOutput.FlowTransitEncryption)
...
type RouterOutput_FlowTransitEncryption struct {
	...
	EncryptionKeyConfiguration *RouterOutput_FlowTransitEncryptionKeyConfiguration `json:"EncryptionKeyConfiguration"`
...
func (r *RouterOutput_FlowTransitEncryption) AWSCloudFormationType() string {
	return "AWS::MediaConnect::RouterOutput.FlowTransitEncryption"
}
