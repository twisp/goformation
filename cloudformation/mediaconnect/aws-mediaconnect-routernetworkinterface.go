...
// RouterNetworkInterface AWS CloudFormation Resource (AWS::MediaConnect::RouterNetworkInterface)
...
type RouterNetworkInterface struct {
	...
	Configuration *RouterNetworkInterface_RouterNetworkInterfaceConfiguration `json:"Configuration"`
...
func (r *RouterNetworkInterface) AWSCloudFormationType() string {
	return "AWS::MediaConnect::RouterNetworkInterface"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RouterNetworkInterface) MarshalJSON() ([]byte, error) {
	type Properties RouterNetworkInterface
...
func (r *RouterNetworkInterface) UnmarshalJSON(b []byte) error {
	type Properties RouterNetworkInterface
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = RouterNetworkInterface(*res.Properties)
	}
