...
// RouterInput_RouterInputConfiguration AWS CloudFormation Resource (AWS::MediaConnect::RouterInput.RouterInputConfiguration)
...
func (r *RouterInput_RouterInputConfiguration) AWSCloudFormationType() string {
	return "AWS::MediaConnect::RouterInput.RouterInputConfiguration"
}
