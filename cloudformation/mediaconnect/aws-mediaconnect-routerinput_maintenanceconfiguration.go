...
// RouterInput_MaintenanceConfiguration AWS CloudFormation Resource (AWS::MediaConnect::RouterInput.MaintenanceConfiguration)
...
func (r *RouterInput_MaintenanceConfiguration) AWSCloudFormationType() string {
	return "AWS::MediaConnect::RouterInput.MaintenanceConfiguration"
}
