...
// RouterOutput_MediaLiveTransitEncryption AWS CloudFormation Resource (AWS::MediaConnect::RouterOutput.MediaLiveTransitEncryption)
...
type RouterOutput_MediaLiveTransitEncryption struct {
	...
	EncryptionKeyConfiguration *RouterOutput_MediaLiveTransitEncryptionKeyConfiguration `json:"EncryptionKeyConfiguration"`
...
func (r *RouterOutput_MediaLiveTransitEncryption) AWSCloudFormationType() string {
	return "AWS::MediaConnect::RouterOutput.MediaLiveTransitEncryption"
}
