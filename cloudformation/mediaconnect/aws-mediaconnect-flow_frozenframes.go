...
// Flow_FrozenFrames AWS CloudFormation Resource (AWS::MediaConnect::Flow.FrozenFrames)
...
func (r *Flow_FrozenFrames) AWSCloudFormationType() string {
	return "AWS::MediaConnect::Flow.FrozenFrames"
}
