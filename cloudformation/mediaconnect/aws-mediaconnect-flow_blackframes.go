...
// Flow_BlackFrames AWS CloudFormation Resource (AWS::MediaConnect::Flow.BlackFrames)
...
func (r *Flow_BlackFrames) AWSCloudFormationType() string {
	return "AWS::MediaConnect::Flow.BlackFrames"
}
