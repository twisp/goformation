...
type Flow_Source struct {
	...
	GatewayBridgeSource *Flow_GatewayBridgeSource `json:"GatewayBridgeSource,omitempty"`
	...
	// MaxSyncBuffer AWS CloudFormation Property
	// Required: false
	...
	// MediaStreamSourceConfigurations AWS CloudFormation Property
	// Required: false
