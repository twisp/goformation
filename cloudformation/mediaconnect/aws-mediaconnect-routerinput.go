...
// RouterInput AWS CloudFormation Resource (AWS::MediaConnect::RouterInput)
...
func (r *RouterInput) AWSCloudFormationType() string {
	return "AWS::MediaConnect::RouterInput"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RouterInput) MarshalJSON() ([]byte, error) {
	type Properties RouterInput
...
func (r *RouterInput) UnmarshalJSON(b []byte) error {
	type Properties RouterInput
	res := &struct {
		Type                string
		Properties          *Properties
