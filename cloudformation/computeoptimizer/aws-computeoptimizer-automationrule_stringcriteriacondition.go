...
// AutomationRule_StringCriteriaCondition AWS CloudFormation Resource (AWS::ComputeOptimizer::AutomationRule.StringCriteriaCondition)
...
type AutomationRule_StringCriteriaCondition struct {
...
func (r *AutomationRule_StringCriteriaCondition) AWSCloudFormationType() string {
	return "AWS::ComputeOptimizer::AutomationRule.StringCriteriaCondition"
}
