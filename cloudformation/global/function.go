...
type Function struct {
	...
	EphemeralStorage *serverless.Function_EphemeralStorage `json:"EphemeralStorage,omitempty"`
	...
	FunctionUrlConfig *serverless.Function_FunctionUrlConfig `json:"FunctionUrlConfig,omitempty"`
