...
// InvestigationGroup_EncryptionConfigMap AWS CloudFormation Resource (AWS::AIOps::InvestigationGroup.EncryptionConfigMap)
...
type InvestigationGroup_EncryptionConfigMap struct {
	...
	// EncryptionConfigurationType AWS CloudFormation Property
	// Required: false
...
func (r *InvestigationGroup_EncryptionConfigMap) AWSCloudFormationType() string {
	return "AWS::AIOps::InvestigationGroup.EncryptionConfigMap"
}
