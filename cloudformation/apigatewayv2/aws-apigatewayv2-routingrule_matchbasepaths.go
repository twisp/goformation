...
// RoutingRule_MatchBasePaths AWS CloudFormation Resource (AWS::ApiGatewayV2::RoutingRule.MatchBasePaths)
...
func (r *RoutingRule_MatchBasePaths) AWSCloudFormationType() string {
	return "AWS::ApiGatewayV2::RoutingRule.MatchBasePaths"
}
