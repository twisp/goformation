...
// RoutingRule AWS CloudFormation Resource (AWS::ApiGatewayV2::RoutingRule)
...
type RoutingRule struct {
	...
	Actions []RoutingRule_Action `json:"Actions"`
	...
	Conditions []RoutingRule_Condition `json:"Conditions"`
...
func (r *RoutingRule) AWSCloudFormationType() string {
...
func (r *RoutingRule) UnmarshalJSON(b []byte) error {
	type Properties RoutingRule
	res := &struct {
		Type                string
		Properties          *Properties
