...
// EventTrigger_EventTriggerCondition AWS CloudFormation Resource (AWS::CustomerProfiles::EventTrigger.EventTriggerCondition)
...
type EventTrigger_EventTriggerCondition struct {
	...
	// EventTriggerDimensions AWS CloudFormation Property
	// Required: true
	...
	EventTriggerDimensions []EventTrigger_EventTriggerDimension `json:"EventTriggerDimensions"`
...
func (r *EventTrigger_EventTriggerCondition) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::EventTrigger.EventTriggerCondition"
}
