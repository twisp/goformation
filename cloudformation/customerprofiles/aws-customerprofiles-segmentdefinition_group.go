...
// SegmentDefinition_Group AWS CloudFormation Resource (AWS::CustomerProfiles::SegmentDefinition.Group)
...
func (r *SegmentDefinition_Group) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::SegmentDefinition.Group"
}
