...
// SegmentDefinition_SegmentGroup AWS CloudFormation Resource (AWS::CustomerProfiles::SegmentDefinition.SegmentGroup)
...
func (r *SegmentDefinition_SegmentGroup) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::SegmentDefinition.SegmentGroup"
}
