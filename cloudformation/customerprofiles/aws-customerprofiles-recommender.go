...
// Recommender AWS CloudFormation Resource (AWS::CustomerProfiles::Recommender)
...
type Recommender struct {
	...
	// RecommenderName AWS CloudFormation Property
	// Required: true
	...
	// RecommenderRecipeName AWS CloudFormation Property
	// Required: true
	...
	RecommenderRecipeName string `json:"RecommenderRecipeName"`
...
func (r *Recommender) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::Recommender"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Recommender) MarshalJSON() ([]byte, error) {
	type Properties Recommender
...
func (r *Recommender) UnmarshalJSON(b []byte) error {
	type Properties Recommender
	res := &struct {
		Type                string
		Properties          *Properties
