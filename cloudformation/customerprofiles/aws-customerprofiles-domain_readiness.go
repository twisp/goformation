...
// Domain_Readiness AWS CloudFormation Resource (AWS::CustomerProfiles::Domain.Readiness)
...
func (r *Domain_Readiness) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::Domain.Readiness"
}
