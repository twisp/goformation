...
// SegmentDefinition_ProfileTypeDimension AWS CloudFormation Resource (AWS::CustomerProfiles::SegmentDefinition.ProfileTypeDimension)
...
func (r *SegmentDefinition_ProfileTypeDimension) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::SegmentDefinition.ProfileTypeDimension"
}
