...
// CalculatedAttributeDefinition AWS CloudFormation Resource (AWS::CustomerProfiles::CalculatedAttributeDefinition)
...
type CalculatedAttributeDefinition struct {
	...
	// AttributeDetails AWS CloudFormation Property
	// Required: true
	...
	AttributeDetails *CalculatedAttributeDefinition_AttributeDetails `json:"AttributeDetails"`

	// CalculatedAttributeName AWS CloudFormation Property
	// Required: true
	...
	CalculatedAttributeName string `json:"CalculatedAttributeName"`
	...
	// UseHistoricalData AWS CloudFormation Property
	// Required: false
...
func (r *CalculatedAttributeDefinition) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::CalculatedAttributeDefinition"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CalculatedAttributeDefinition) MarshalJSON() ([]byte, error) {
	type Properties CalculatedAttributeDefinition
...
func (r *CalculatedAttributeDefinition) UnmarshalJSON(b []byte) error {
	type Properties CalculatedAttributeDefinition
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CalculatedAttributeDefinition(*res.Properties)
	}
