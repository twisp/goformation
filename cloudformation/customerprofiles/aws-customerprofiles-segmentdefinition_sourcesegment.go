...
// SegmentDefinition_SourceSegment AWS CloudFormation Resource (AWS::CustomerProfiles::SegmentDefinition.SourceSegment)
...
func (r *SegmentDefinition_SourceSegment) AWSCloudFormationType() string {
	return "AWS::CustomerProfiles::SegmentDefinition.SourceSegment"
}
