...
// ChannelNamespace_AuthMode AWS CloudFormation Resource (AWS::AppSync::ChannelNamespace.AuthMode)
...
func (r *ChannelNamespace_AuthMode) AWSCloudFormationType() string {
	return "AWS::AppSync::ChannelNamespace.AuthMode"
}
