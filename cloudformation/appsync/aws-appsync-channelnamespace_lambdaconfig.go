...
// ChannelNamespace_LambdaConfig AWS CloudFormation Resource (AWS::AppSync::ChannelNamespace.LambdaConfig)
...
type ChannelNamespace_LambdaConfig struct {
	...
	// InvokeType AWS CloudFormation Property
	// Required: true
...
func (r *ChannelNamespace_LambdaConfig) AWSCloudFormationType() string {
	return "AWS::AppSync::ChannelNamespace.LambdaConfig"
}
