...
// LocationHDFS_CustomSecretConfig AWS CloudFormation Resource (AWS::DataSync::LocationHDFS.CustomSecretConfig)
...
type LocationHDFS_CustomSecretConfig struct {
...
func (r *LocationHDFS_CustomSecretConfig) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationHDFS.CustomSecretConfig"
}
