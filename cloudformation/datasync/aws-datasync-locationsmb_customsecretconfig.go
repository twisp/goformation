...
// LocationSMB_CustomSecretConfig AWS CloudFormation Resource (AWS::DataSync::LocationSMB.CustomSecretConfig)
...
func (r *LocationSMB_CustomSecretConfig) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationSMB.CustomSecretConfig"
}
