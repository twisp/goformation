...
// LocationObjectStorage_CmkSecretConfig AWS CloudFormation Resource (AWS::DataSync::LocationObjectStorage.CmkSecretConfig)
...
func (r *LocationObjectStorage_CmkSecretConfig) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationObjectStorage.CmkSecretConfig"
}
