...
// LocationFSxONTAP_ManagedSecretConfig AWS CloudFormation Resource (AWS::DataSync::LocationFSxONTAP.ManagedSecretConfig)
...
type LocationFSxONTAP_ManagedSecretConfig struct {
...
func (r *LocationFSxONTAP_ManagedSecretConfig) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationFSxONTAP.ManagedSecretConfig"
}
