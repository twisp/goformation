...
// LocationFSxONTAP_CmkSecretConfig AWS CloudFormation Resource (AWS::DataSync::LocationFSxONTAP.CmkSecretConfig)
...
type LocationFSxONTAP_CmkSecretConfig struct {
...
func (r *LocationFSxONTAP_CmkSecretConfig) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationFSxONTAP.CmkSecretConfig"
}
