...
// LocationObjectStorage_ManagedSecretConfig AWS CloudFormation Resource (AWS::DataSync::LocationObjectStorage.ManagedSecretConfig)
...
func (r *LocationObjectStorage_ManagedSecretConfig) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationObjectStorage.ManagedSecretConfig"
}
