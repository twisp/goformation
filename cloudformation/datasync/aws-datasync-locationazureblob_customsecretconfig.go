...
// LocationAzureBlob_CustomSecretConfig AWS CloudFormation Resource (AWS::DataSync::LocationAzureBlob.CustomSecretConfig)
...
func (r *LocationAzureBlob_CustomSecretConfig) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationAzureBlob.CustomSecretConfig"
}
