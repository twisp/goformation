...
// LocationSMB_CmkSecretConfig AWS CloudFormation Resource (AWS::DataSync::LocationSMB.CmkSecretConfig)
...
func (r *LocationSMB_CmkSecretConfig) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationSMB.CmkSecretConfig"
}
