...
// LocationAzureBlob AWS CloudFormation Resource (AWS::DataSync::LocationAzureBlob)
...
func (r *LocationAzureBlob) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationAzureBlob"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocationAzureBlob) MarshalJSON() ([]byte, error) {
	type Properties LocationAzureBlob
...
func (r *LocationAzureBlob) UnmarshalJSON(b []byte) error {
	type Properties LocationAzureBlob
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LocationAzureBlob(*res.Properties)
	}
