...
// LocationFSxWindows_CmkSecretConfig AWS CloudFormation Resource (AWS::DataSync::LocationFSxWindows.CmkSecretConfig)
...
func (r *LocationFSxWindows_CmkSecretConfig) AWSCloudFormationType() string {
	return "AWS::DataSync::LocationFSxWindows.CmkSecretConfig"
}
