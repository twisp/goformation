...
// TagSyncTask AWS CloudFormation Resource (AWS::ResourceGroups::TagSyncTask)
...
func (r *TagSyncTask) AWSCloudFormationType() string {
	return "AWS::ResourceGroups::TagSyncTask"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TagSyncTask) MarshalJSON() ([]byte, error) {
	type Properties TagSyncTask
...
func (r *TagSyncTask) UnmarshalJSON(b []byte) error {
	type Properties TagSyncTask
	res := &struct {
		Type                string
		Properties          *Properties
