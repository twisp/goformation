...
// WebACL_MonetizeAction AWS CloudFormation Resource (AWS::WAFv2::WebACL.MonetizeAction)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-webacl-monetizeaction.html
type WebACL_MonetizeAction struct {
...
func (r *WebACL_MonetizeAction) AWSCloudFormationType() string {
	return "AWS::WAFv2::WebACL.MonetizeAction"
}
