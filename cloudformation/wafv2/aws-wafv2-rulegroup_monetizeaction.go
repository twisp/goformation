...
// RuleGroup_MonetizeAction AWS CloudFormation Resource (AWS::WAFv2::RuleGroup.MonetizeAction)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-wafv2-rulegroup-monetizeaction.html
type RuleGroup_MonetizeAction struct {

	// PriceMultiplier AWS CloudFormation Property
	// Required: false
...
func (r *RuleGroup_MonetizeAction) AWSCloudFormationType() string {
	return "AWS::WAFv2::RuleGroup.MonetizeAction"
}
