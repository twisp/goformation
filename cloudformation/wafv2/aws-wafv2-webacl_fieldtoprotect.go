...
// WebACL_FieldToProtect AWS CloudFormation Resource (AWS::WAFv2::WebACL.FieldToProtect)
...
type WebACL_FieldToProtect struct {
	...
	// FieldKeys AWS CloudFormation Property
	// Required: false
...
func (r *WebACL_FieldToProtect) AWSCloudFormationType() string {
	return "AWS::WAFv2::WebACL.FieldToProtect"
}
