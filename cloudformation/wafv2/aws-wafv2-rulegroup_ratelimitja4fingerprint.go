...
// RuleGroup_RateLimitJA4Fingerprint AWS CloudFormation Resource (AWS::WAFv2::RuleGroup.RateLimitJA4Fingerprint)
...
func (r *RuleGroup_RateLimitJA4Fingerprint) AWSCloudFormationType() string {
	return "AWS::WAFv2::RuleGroup.RateLimitJA4Fingerprint"
}
