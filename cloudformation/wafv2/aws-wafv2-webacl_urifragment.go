...
// WebACL_UriFragment AWS CloudFormation Resource (AWS::WAFv2::WebACL.UriFragment)
...
func (r *WebACL_UriFragment) AWSCloudFormationType() string {
	return "AWS::WAFv2::WebACL.UriFragment"
}
