...
// WebACL_OnSourceDDoSProtectionConfig AWS CloudFormation Resource (AWS::WAFv2::WebACL.OnSourceDDoSProtectionConfig)
...
type WebACL_OnSourceDDoSProtectionConfig struct {
	...
	// ALBLowReputationMode AWS CloudFormation Property
	// Required: true
	...
	ALBLowReputationMode string `json:"ALBLowReputationMode"`
...
func (r *WebACL_OnSourceDDoSProtectionConfig) AWSCloudFormationType() string {
	return "AWS::WAFv2::WebACL.OnSourceDDoSProtectionConfig"
}
