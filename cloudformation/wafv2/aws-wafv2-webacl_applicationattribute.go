...
// WebACL_ApplicationAttribute AWS CloudFormation Resource (AWS::WAFv2::WebACL.ApplicationAttribute)
...
func (r *WebACL_ApplicationAttribute) AWSCloudFormationType() string {
	return "AWS::WAFv2::WebACL.ApplicationAttribute"
}
