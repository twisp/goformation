...
// WebACL_ApplicationConfig AWS CloudFormation Resource (AWS::WAFv2::WebACL.ApplicationConfig)
...
type WebACL_ApplicationConfig struct {
	...
	Attributes []WebACL_ApplicationAttribute `json:"Attributes"`
...
func (r *WebACL_ApplicationConfig) AWSCloudFormationType() string {
	return "AWS::WAFv2::WebACL.ApplicationConfig"
}
