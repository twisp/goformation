...
// Link AWS CloudFormation Resource (AWS::RTBFabric::Link)
...
type Link struct {
	...
	// HttpResponderAllowed AWS CloudFormation Property
	// Required: false
	...
	LinkLogSettings *Link_LinkLogSettings `json:"LinkLogSettings"`

	// ModuleConfigurationList AWS CloudFormation Property
	// Required: false
	...
	// PeerGatewayId AWS CloudFormation Property
	// Required: true
	...
	PeerGatewayId string `json:"PeerGatewayId"`
