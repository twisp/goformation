...
// LinkRoutingRule AWS CloudFormation Resource (AWS::RTBFabric::LinkRoutingRule)
...
type LinkRoutingRule struct {
	...
	Conditions *LinkRoutingRule_RuleCondition `json:"Conditions"`
...
func (r *LinkRoutingRule) AWSCloudFormationType() string {
	return "AWS::RTBFabric::LinkRoutingRule"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LinkRoutingRule) MarshalJSON() ([]byte, error) {
	type Properties LinkRoutingRule
...
func (r *LinkRoutingRule) UnmarshalJSON(b []byte) error {
	type Properties LinkRoutingRule
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LinkRoutingRule(*res.Properties)
	}
