...
// OutboundExternalLink AWS CloudFormation Resource (AWS::RTBFabric::OutboundExternalLink)
...
type OutboundExternalLink struct {
	...
	// LinkAttributes AWS CloudFormation Property
	// Required: false
	...
	// LinkLogSettings AWS CloudFormation Property
	// Required: true
	...
	LinkLogSettings *OutboundExternalLink_LinkLogSettings `json:"LinkLogSettings"`
...
func (r *OutboundExternalLink) AWSCloudFormationType() string {
	return "AWS::RTBFabric::OutboundExternalLink"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OutboundExternalLink) MarshalJSON() ([]byte, error) {
	type Properties OutboundExternalLink
...
func (r *OutboundExternalLink) UnmarshalJSON(b []byte) error {
	type Properties OutboundExternalLink
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = OutboundExternalLink(*res.Properties)
	}
