...
// Link_ModuleParameters AWS CloudFormation Resource (AWS::RTBFabric::Link.ModuleParameters)
...
type Link_ModuleParameters struct {
	...
	// OpenRtbAttribute AWS CloudFormation Property
	// Required: false
...
func (r *Link_ModuleParameters) AWSCloudFormationType() string {
	return "AWS::RTBFabric::Link.ModuleParameters"
}
