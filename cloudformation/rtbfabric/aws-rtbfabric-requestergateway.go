...
// RequesterGateway AWS CloudFormation Resource (AWS::RTBFabric::RequesterGateway)
...
func (r *RequesterGateway) AWSCloudFormationType() string {
	return "AWS::RTBFabric::RequesterGateway"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RequesterGateway) MarshalJSON() ([]byte, error) {
	type Properties RequesterGateway
...
func (r *RequesterGateway) UnmarshalJSON(b []byte) error {
	type Properties RequesterGateway
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = RequesterGateway(*res.Properties)
	}
