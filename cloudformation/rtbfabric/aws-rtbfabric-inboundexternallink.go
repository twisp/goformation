...
// InboundExternalLink AWS CloudFormation Resource (AWS::RTBFabric::InboundExternalLink)
...
type InboundExternalLink struct {
	...
	LinkLogSettings *InboundExternalLink_LinkLogSettings `json:"LinkLogSettings"`
...
func (r *InboundExternalLink) AWSCloudFormationType() string {
	return "AWS::RTBFabric::InboundExternalLink"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r InboundExternalLink) MarshalJSON() ([]byte, error) {
	type Properties InboundExternalLink
...
func (r *InboundExternalLink) UnmarshalJSON(b []byte) error {
	type Properties InboundExternalLink
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = InboundExternalLink(*res.Properties)
	}
