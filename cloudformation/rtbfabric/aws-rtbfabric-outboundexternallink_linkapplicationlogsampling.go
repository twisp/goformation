...
// OutboundExternalLink_LinkApplicationLogSampling AWS CloudFormation Resource (AWS::RTBFabric::OutboundExternalLink.LinkApplicationLogSampling)
...
func (r *OutboundExternalLink_LinkApplicationLogSampling) AWSCloudFormationType() string {
	return "AWS::RTBFabric::OutboundExternalLink.LinkApplicationLogSampling"
}
