...
// ApplicationInferenceProfile AWS CloudFormation Resource (AWS::Bedrock::ApplicationInferenceProfile)
...
type ApplicationInferenceProfile struct {
	...
	// InferenceProfileName AWS CloudFormation Property
	// Required: true
	...
	// ModelSource AWS CloudFormation Property
	// Required: false
...
func (r *ApplicationInferenceProfile) AWSCloudFormationType() string {
	return "AWS::Bedrock::ApplicationInferenceProfile"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ApplicationInferenceProfile) MarshalJSON() ([]byte, error) {
	type Properties ApplicationInferenceProfile
...
func (r *ApplicationInferenceProfile) UnmarshalJSON(b []byte) error {
	type Properties ApplicationInferenceProfile
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ApplicationInferenceProfile(*res.Properties)
	}
