...
// PromptVersion_CachePointBlock AWS CloudFormation Resource (AWS::Bedrock::PromptVersion.CachePointBlock)
...
func (r *PromptVersion_CachePointBlock) AWSCloudFormationType() string {
	return "AWS::Bedrock::PromptVersion.CachePointBlock"
}
