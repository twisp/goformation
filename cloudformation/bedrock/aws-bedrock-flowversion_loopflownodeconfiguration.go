...
// FlowVersion_LoopFlowNodeConfiguration AWS CloudFormation Resource (AWS::Bedrock::FlowVersion.LoopFlowNodeConfiguration)
...
type FlowVersion_LoopFlowNodeConfiguration struct {
	...
	Definition *FlowVersion_FlowDefinition `json:"Definition"`
...
func (r *FlowVersion_LoopFlowNodeConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowVersion.LoopFlowNodeConfiguration"
}
