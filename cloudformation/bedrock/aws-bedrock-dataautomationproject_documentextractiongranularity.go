...
// DataAutomationProject_DocumentExtractionGranularity AWS CloudFormation Resource (AWS::Bedrock::DataAutomationProject.DocumentExtractionGranularity)
...
func (r *DataAutomationProject_DocumentExtractionGranularity) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataAutomationProject.DocumentExtractionGranularity"
}
