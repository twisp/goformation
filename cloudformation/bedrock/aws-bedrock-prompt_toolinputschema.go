...
// Prompt_ToolInputSchema AWS CloudFormation Resource (AWS::Bedrock::Prompt.ToolInputSchema)
...
func (r *Prompt_ToolInputSchema) AWSCloudFormationType() string {
	return "AWS::Bedrock::Prompt.ToolInputSchema"
}
