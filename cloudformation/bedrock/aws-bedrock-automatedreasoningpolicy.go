...
// AutomatedReasoningPolicy AWS CloudFormation Resource (AWS::Bedrock::AutomatedReasoningPolicy)
...
type AutomatedReasoningPolicy struct {
	...
	// PolicyDefinition AWS CloudFormation Property
	// Required: false
...
func (r *AutomatedReasoningPolicy) AWSCloudFormationType() string {
	return "AWS::Bedrock::AutomatedReasoningPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AutomatedReasoningPolicy) MarshalJSON() ([]byte, error) {
	type Properties AutomatedReasoningPolicy
...
func (r *AutomatedReasoningPolicy) UnmarshalJSON(b []byte) error {
	type Properties AutomatedReasoningPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AutomatedReasoningPolicy(*res.Properties)
	}
