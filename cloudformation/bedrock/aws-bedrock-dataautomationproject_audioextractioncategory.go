...
// DataAutomationProject_AudioExtractionCategory AWS CloudFormation Resource (AWS::Bedrock::DataAutomationProject.AudioExtractionCategory)
...
type DataAutomationProject_AudioExtractionCategory struct {
	...
	// TypeConfiguration AWS CloudFormation Property
	// Required: false
...
func (r *DataAutomationProject_AudioExtractionCategory) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataAutomationProject.AudioExtractionCategory"
}
