...
// PromptVersion_ToolInputSchema AWS CloudFormation Resource (AWS::Bedrock::PromptVersion.ToolInputSchema)
...
func (r *PromptVersion_ToolInputSchema) AWSCloudFormationType() string {
	return "AWS::Bedrock::PromptVersion.ToolInputSchema"
}
