...
// DataAutomationLibrary AWS CloudFormation Resource (AWS::Bedrock::DataAutomationLibrary)
...
type DataAutomationLibrary struct {
	...
	EncryptionConfiguration *DataAutomationLibrary_EncryptionConfiguration `json:"EncryptionConfiguration,omitempty"`

	// LibraryDescription AWS CloudFormation Property
	// Required: false
	...
	// LibraryName AWS CloudFormation Property
	// Required: true
...
func (r *DataAutomationLibrary) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataAutomationLibrary"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DataAutomationLibrary) MarshalJSON() ([]byte, error) {
	type Properties DataAutomationLibrary
...
func (r *DataAutomationLibrary) UnmarshalJSON(b []byte) error {
	type Properties DataAutomationLibrary
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DataAutomationLibrary(*res.Properties)
	}
