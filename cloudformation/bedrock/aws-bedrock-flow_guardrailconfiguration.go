...
// Flow_GuardrailConfiguration AWS CloudFormation Resource (AWS::Bedrock::Flow.GuardrailConfiguration)
...
func (r *Flow_GuardrailConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::Flow.GuardrailConfiguration"
}
