...
// DataAutomationLibrary_EntityTypeInfo AWS CloudFormation Resource (AWS::Bedrock::DataAutomationLibrary.EntityTypeInfo)
...
type DataAutomationLibrary_EntityTypeInfo struct {

	// EntityMetadata AWS CloudFormation Property
	// Required: false
...
func (r *DataAutomationLibrary_EntityTypeInfo) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataAutomationLibrary.EntityTypeInfo"
}
