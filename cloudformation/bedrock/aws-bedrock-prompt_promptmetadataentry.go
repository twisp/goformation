...
// Prompt_PromptMetadataEntry AWS CloudFormation Resource (AWS::Bedrock::Prompt.PromptMetadataEntry)
...
func (r *Prompt_PromptMetadataEntry) AWSCloudFormationType() string {
	return "AWS::Bedrock::Prompt.PromptMetadataEntry"
}
