...
// KnowledgeBase_KendraKnowledgeBaseConfiguration AWS CloudFormation Resource (AWS::Bedrock::KnowledgeBase.KendraKnowledgeBaseConfiguration)
...
type KnowledgeBase_KendraKnowledgeBaseConfiguration struct {
	...
	// KendraIndexArn AWS CloudFormation Property
	// Required: true
...
func (r *KnowledgeBase_KendraKnowledgeBaseConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::KnowledgeBase.KendraKnowledgeBaseConfiguration"
}
