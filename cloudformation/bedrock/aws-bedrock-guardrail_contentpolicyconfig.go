...
// Guardrail_ContentPolicyConfig AWS CloudFormation Resource (AWS::Bedrock::Guardrail.ContentPolicyConfig)
...
type Guardrail_ContentPolicyConfig struct {
	...
	// ContentFiltersTierConfig AWS CloudFormation Property
	// Required: false
	...
	FiltersConfig []Guardrail_ContentFilterConfig `json:"FiltersConfig"`
...
func (r *Guardrail_ContentPolicyConfig) AWSCloudFormationType() string {
	return "AWS::Bedrock::Guardrail.ContentPolicyConfig"
}
