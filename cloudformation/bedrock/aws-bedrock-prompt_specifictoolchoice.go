...
// Prompt_SpecificToolChoice AWS CloudFormation Resource (AWS::Bedrock::Prompt.SpecificToolChoice)
...
func (r *Prompt_SpecificToolChoice) AWSCloudFormationType() string {
	return "AWS::Bedrock::Prompt.SpecificToolChoice"
}
