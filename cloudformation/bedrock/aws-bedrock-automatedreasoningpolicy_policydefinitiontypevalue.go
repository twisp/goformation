...
// AutomatedReasoningPolicy_PolicyDefinitionTypeValue AWS CloudFormation Resource (AWS::Bedrock::AutomatedReasoningPolicy.PolicyDefinitionTypeValue)
...
func (r *AutomatedReasoningPolicy_PolicyDefinitionTypeValue) AWSCloudFormationType() string {
	return "AWS::Bedrock::AutomatedReasoningPolicy.PolicyDefinitionTypeValue"
}
