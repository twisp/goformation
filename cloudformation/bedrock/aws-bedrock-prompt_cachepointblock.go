...
// Prompt_CachePointBlock AWS CloudFormation Resource (AWS::Bedrock::Prompt.CachePointBlock)
...
func (r *Prompt_CachePointBlock) AWSCloudFormationType() string {
	return "AWS::Bedrock::Prompt.CachePointBlock"
}
