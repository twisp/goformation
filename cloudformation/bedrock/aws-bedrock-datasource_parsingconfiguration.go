...
// DataSource_ParsingConfiguration AWS CloudFormation Resource (AWS::Bedrock::DataSource.ParsingConfiguration)
...
type DataSource_ParsingConfiguration struct {
	...
	// BedrockDataAutomationConfiguration AWS CloudFormation Property
	// Required: false
...
func (r *DataSource_ParsingConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataSource.ParsingConfiguration"
}
