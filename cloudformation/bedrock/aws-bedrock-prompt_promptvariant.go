...
type Prompt_PromptVariant struct {
	...
	// GenAiResource AWS CloudFormation Property
	// Required: false
	...
	GenAiResource *Prompt_PromptGenAiResource `json:"GenAiResource,omitempty"`
	...
	Metadata []Prompt_PromptMetadataEntry `json:"Metadata,omitempty"`
	...
	TemplateConfiguration *Prompt_PromptTemplateConfiguration `json:"TemplateConfiguration"`
