...
// PromptVersion_PromptModelInferenceConfiguration AWS CloudFormation Resource (AWS::Bedrock::PromptVersion.PromptModelInferenceConfiguration)
...
func (r *PromptVersion_PromptModelInferenceConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::PromptVersion.PromptModelInferenceConfiguration"
}
