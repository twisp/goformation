...
// AutomatedReasoningPolicy_PolicyDefinitionType AWS CloudFormation Resource (AWS::Bedrock::AutomatedReasoningPolicy.PolicyDefinitionType)
...
type AutomatedReasoningPolicy_PolicyDefinitionType struct {
	...
	Values []AutomatedReasoningPolicy_PolicyDefinitionTypeValue `json:"Values"`
...
func (r *AutomatedReasoningPolicy_PolicyDefinitionType) AWSCloudFormationType() string {
	return "AWS::Bedrock::AutomatedReasoningPolicy.PolicyDefinitionType"
}
