...
// DataAutomationProject_PIIEntitiesConfiguration AWS CloudFormation Resource (AWS::Bedrock::DataAutomationProject.PIIEntitiesConfiguration)
...
type DataAutomationProject_PIIEntitiesConfiguration struct {
	...
	// PiiEntityTypes AWS CloudFormation Property
	// Required: false
	...
	// RedactionMaskMode AWS CloudFormation Property
	// Required: false
...
func (r *DataAutomationProject_PIIEntitiesConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataAutomationProject.PIIEntitiesConfiguration"
}
