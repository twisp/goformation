...
// PromptVersion_SpecificToolChoice AWS CloudFormation Resource (AWS::Bedrock::PromptVersion.SpecificToolChoice)
...
func (r *PromptVersion_SpecificToolChoice) AWSCloudFormationType() string {
	return "AWS::Bedrock::PromptVersion.SpecificToolChoice"
}
