...
// EnforcedGuardrailConfiguration AWS CloudFormation Resource (AWS::Bedrock::EnforcedGuardrailConfiguration)
...
type EnforcedGuardrailConfiguration struct {
	...
	// ModelEnforcement AWS CloudFormation Property
	// Required: false
	...
	ModelEnforcement *EnforcedGuardrailConfiguration_ModelEnforcement `json:"ModelEnforcement,omitempty"`

	// SelectiveContentGuarding AWS CloudFormation Property
	// Required: false
	...
	SelectiveContentGuarding *EnforcedGuardrailConfiguration_SelectiveContentGuarding `json:"SelectiveContentGuarding,omitempty"`
...
func (r *EnforcedGuardrailConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::EnforcedGuardrailConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EnforcedGuardrailConfiguration) MarshalJSON() ([]byte, error) {
	type Properties EnforcedGuardrailConfiguration
...
func (r *EnforcedGuardrailConfiguration) UnmarshalJSON(b []byte) error {
	type Properties EnforcedGuardrailConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = EnforcedGuardrailConfiguration(*res.Properties)
	}
