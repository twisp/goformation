...
// Agent_AgentDescriptor AWS CloudFormation Resource (AWS::Bedrock::Agent.AgentDescriptor)
...
type Agent_AgentDescriptor struct {
	...
	// AliasArn AWS CloudFormation Property
	// Required: false
...
func (r *Agent_AgentDescriptor) AWSCloudFormationType() string {
	return "AWS::Bedrock::Agent.AgentDescriptor"
}
