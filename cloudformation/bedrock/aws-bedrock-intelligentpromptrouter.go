...
// IntelligentPromptRouter AWS CloudFormation Resource (AWS::Bedrock::IntelligentPromptRouter)
...
type IntelligentPromptRouter struct {
	...
	// FallbackModel AWS CloudFormation Property
	// Required: true
	...
	FallbackModel *IntelligentPromptRouter_PromptRouterTargetModel `json:"FallbackModel"`
	...
	Models []IntelligentPromptRouter_PromptRouterTargetModel `json:"Models"`

	// PromptRouterName AWS CloudFormation Property
	// Required: true
	...
	// RoutingCriteria AWS CloudFormation Property
	// Required: true
	...
	RoutingCriteria *IntelligentPromptRouter_RoutingCriteria `json:"RoutingCriteria"`
...
func (r *IntelligentPromptRouter) AWSCloudFormationType() string {
	return "AWS::Bedrock::IntelligentPromptRouter"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IntelligentPromptRouter) MarshalJSON() ([]byte, error) {
	type Properties IntelligentPromptRouter
...
func (r *IntelligentPromptRouter) UnmarshalJSON(b []byte) error {
	type Properties IntelligentPromptRouter
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IntelligentPromptRouter(*res.Properties)
	}
