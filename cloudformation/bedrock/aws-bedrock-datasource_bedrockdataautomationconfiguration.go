...
// DataSource_BedrockDataAutomationConfiguration AWS CloudFormation Resource (AWS::Bedrock::DataSource.BedrockDataAutomationConfiguration)
...
type DataSource_BedrockDataAutomationConfiguration struct {
	...
	// ParsingModality AWS CloudFormation Property
	// Required: false
...
func (r *DataSource_BedrockDataAutomationConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataSource.BedrockDataAutomationConfiguration"
}
