...
// Prompt_PromptTemplateConfiguration AWS CloudFormation Resource (AWS::Bedrock::Prompt.PromptTemplateConfiguration)
...
type Prompt_PromptTemplateConfiguration struct {
	...
	Chat *Prompt_ChatPromptTemplateConfiguration `json:"Chat,omitempty"`
	...
	Text *Prompt_TextPromptTemplateConfiguration `json:"Text,omitempty"`
...
func (r *Prompt_PromptTemplateConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::Prompt.PromptTemplateConfiguration"
}
