...
// KnowledgeBase_QueryGenerationContext AWS CloudFormation Resource (AWS::Bedrock::KnowledgeBase.QueryGenerationContext)
...
type KnowledgeBase_QueryGenerationContext struct {
	...
	// CuratedQueries AWS CloudFormation Property
	// Required: false
...
func (r *KnowledgeBase_QueryGenerationContext) AWSCloudFormationType() string {
	return "AWS::Bedrock::KnowledgeBase.QueryGenerationContext"
}
