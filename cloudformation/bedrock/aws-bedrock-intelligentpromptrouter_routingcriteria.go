...
// IntelligentPromptRouter_RoutingCriteria AWS CloudFormation Resource (AWS::Bedrock::IntelligentPromptRouter.RoutingCriteria)
...
type IntelligentPromptRouter_RoutingCriteria struct {
	...
	// ResponseQualityDifference AWS CloudFormation Property
	// Required: true
...
func (r *IntelligentPromptRouter_RoutingCriteria) AWSCloudFormationType() string {
	return "AWS::Bedrock::IntelligentPromptRouter.RoutingCriteria"
}
