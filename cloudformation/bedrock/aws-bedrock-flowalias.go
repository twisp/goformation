...
type FlowAlias struct {
	...
	RoutingConfiguration []FlowAlias_FlowAliasRoutingConfigurationListItem `json:"RoutingConfiguration"`
...
func (r *FlowAlias) AWSCloudFormationType() string {
	return "AWS::Bedrock::FlowAlias"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r FlowAlias) MarshalJSON() ([]byte, error) {
	type Properties FlowAlias
...
func (r *FlowAlias) UnmarshalJSON(b []byte) error {
	type Properties FlowAlias
	res := &struct {
		Type                string
		Properties          *Properties
