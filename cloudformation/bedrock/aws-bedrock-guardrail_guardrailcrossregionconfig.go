...
// Guardrail_GuardrailCrossRegionConfig AWS CloudFormation Resource (AWS::Bedrock::Guardrail.GuardrailCrossRegionConfig)
...
type Guardrail_GuardrailCrossRegionConfig struct {
	...
	// GuardrailProfileArn AWS CloudFormation Property
	// Required: true
...
func (r *Guardrail_GuardrailCrossRegionConfig) AWSCloudFormationType() string {
	return "AWS::Bedrock::Guardrail.GuardrailCrossRegionConfig"
}
