...
// DataAutomationProject_VideoBoundingBox AWS CloudFormation Resource (AWS::Bedrock::DataAutomationProject.VideoBoundingBox)
...
func (r *DataAutomationProject_VideoBoundingBox) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataAutomationProject.VideoBoundingBox"
}
