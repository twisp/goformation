...
// DataAutomationProject_OverrideConfiguration AWS CloudFormation Resource (AWS::Bedrock::DataAutomationProject.OverrideConfiguration)
...
type DataAutomationProject_OverrideConfiguration struct {
	...
	// ModalityRouting AWS CloudFormation Property
	// Required: false
...
func (r *DataAutomationProject_OverrideConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::DataAutomationProject.OverrideConfiguration"
}
