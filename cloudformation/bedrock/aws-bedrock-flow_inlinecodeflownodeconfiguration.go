...
// Flow_InlineCodeFlowNodeConfiguration AWS CloudFormation Resource (AWS::Bedrock::Flow.InlineCodeFlowNodeConfiguration)
...
func (r *Flow_InlineCodeFlowNodeConfiguration) AWSCloudFormationType() string {
	return "AWS::Bedrock::Flow.InlineCodeFlowNodeConfiguration"
}
