...
// JobDefinition_EksPersistentVolumeClaim AWS CloudFormation Resource (AWS::Batch::JobDefinition.EksPersistentVolumeClaim)
...
type JobDefinition_EksPersistentVolumeClaim struct {
	...
	// ClaimName AWS CloudFormation Property
	// Required: true
...
func (r *JobDefinition_EksPersistentVolumeClaim) AWSCloudFormationType() string {
	return "AWS::Batch::JobDefinition.EksPersistentVolumeClaim"
}
