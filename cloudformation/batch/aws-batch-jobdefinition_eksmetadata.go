...
// JobDefinition_EksMetadata AWS CloudFormation Resource (AWS::Batch::JobDefinition.EksMetadata)
...
func (r *JobDefinition_EksMetadata) AWSCloudFormationType() string {
	return "AWS::Batch::JobDefinition.EksMetadata"
}
