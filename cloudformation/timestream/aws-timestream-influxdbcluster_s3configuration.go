...
// InfluxDBCluster_S3Configuration AWS CloudFormation Resource (AWS::Timestream::InfluxDBCluster.S3Configuration)
...
type InfluxDBCluster_S3Configuration struct {
...
func (r *InfluxDBCluster_S3Configuration) AWSCloudFormationType() string {
	return "AWS::Timestream::InfluxDBCluster.S3Configuration"
}
