...
// InfluxDBInstance_MaintenanceSchedule AWS CloudFormation Resource (AWS::Timestream::InfluxDBInstance.MaintenanceSchedule)
...
func (r *InfluxDBInstance_MaintenanceSchedule) AWSCloudFormationType() string {
	return "AWS::Timestream::InfluxDBInstance.MaintenanceSchedule"
}
