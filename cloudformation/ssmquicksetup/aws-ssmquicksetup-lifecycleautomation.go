...
// LifecycleAutomation AWS CloudFormation Resource (AWS::SSMQuickSetup::LifecycleAutomation)
...
type LifecycleAutomation struct {
	...
	// AutomationDocument AWS CloudFormation Property
	// Required: true
	...
	AutomationDocument string `json:"AutomationDocument"`

	// AutomationParameters AWS CloudFormation Property
	// Required: true
	...
	AutomationParameters interface{} `json:"AutomationParameters"`

	// ResourceKey AWS CloudFormation Property
	// Required: true
...
func (r *LifecycleAutomation) AWSCloudFormationType() string {
	return "AWS::SSMQuickSetup::LifecycleAutomation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LifecycleAutomation) MarshalJSON() ([]byte, error) {
	type Properties LifecycleAutomation
...
func (r *LifecycleAutomation) UnmarshalJSON(b []byte) error {
	type Properties LifecycleAutomation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LifecycleAutomation(*res.Properties)
	}
