...
// Preferences_ConnectionRecordingPreferences AWS CloudFormation Resource (AWS::SSMGuiConnect::Preferences.ConnectionRecordingPreferences)
...
type Preferences_ConnectionRecordingPreferences struct {
	...
	// RecordingDestinations AWS CloudFormation Property
	// Required: true
	...
	RecordingDestinations *Preferences_RecordingDestinations `json:"RecordingDestinations"`
...
func (r *Preferences_ConnectionRecordingPreferences) AWSCloudFormationType() string {
	return "AWS::SSMGuiConnect::Preferences.ConnectionRecordingPreferences"
}
