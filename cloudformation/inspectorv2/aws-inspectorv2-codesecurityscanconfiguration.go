...
// CodeSecurityScanConfiguration AWS CloudFormation Resource (AWS::InspectorV2::CodeSecurityScanConfiguration)
...
type CodeSecurityScanConfiguration struct {
	...
	// ScopeSettings AWS CloudFormation Property
	// Required: false
...
func (r *CodeSecurityScanConfiguration) AWSCloudFormationType() string {
	return "AWS::InspectorV2::CodeSecurityScanConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CodeSecurityScanConfiguration) MarshalJSON() ([]byte, error) {
	type Properties CodeSecurityScanConfiguration
...
func (r *CodeSecurityScanConfiguration) UnmarshalJSON(b []byte) error {
	type Properties CodeSecurityScanConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CodeSecurityScanConfiguration(*res.Properties)
	}
