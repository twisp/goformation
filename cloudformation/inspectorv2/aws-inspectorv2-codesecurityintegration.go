...
// CodeSecurityIntegration AWS CloudFormation Resource (AWS::InspectorV2::CodeSecurityIntegration)
...
type CodeSecurityIntegration struct {
	...
	// CreateIntegrationDetails AWS CloudFormation Property
	// Required: false
	...
	// UpdateIntegrationDetails AWS CloudFormation Property
	// Required: false
...
func (r *CodeSecurityIntegration) AWSCloudFormationType() string {
	return "AWS::InspectorV2::CodeSecurityIntegration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CodeSecurityIntegration) MarshalJSON() ([]byte, error) {
	type Properties CodeSecurityIntegration
...
func (r *CodeSecurityIntegration) UnmarshalJSON(b []byte) error {
	type Properties CodeSecurityIntegration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CodeSecurityIntegration(*res.Properties)
	}
