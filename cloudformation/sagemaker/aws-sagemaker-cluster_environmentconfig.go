...
// Cluster_EnvironmentConfig AWS CloudFormation Resource (AWS::SageMaker::Cluster.EnvironmentConfig)
...
func (r *Cluster_EnvironmentConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.EnvironmentConfig"
}
