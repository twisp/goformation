...
// InferenceComponent_InferenceComponentCapacitySize AWS CloudFormation Resource (AWS::SageMaker::InferenceComponent.InferenceComponentCapacitySize)
...
func (r *InferenceComponent_InferenceComponentCapacitySize) AWSCloudFormationType() string {
	return "AWS::SageMaker::InferenceComponent.InferenceComponentCapacitySize"
}
