...
// Cluster_RollingUpdatePolicy AWS CloudFormation Resource (AWS::SageMaker::Cluster.RollingUpdatePolicy)
...
type Cluster_RollingUpdatePolicy struct {
	...
	MaximumBatchSize *Cluster_CapacitySizeConfig `json:"MaximumBatchSize"`
...
func (r *Cluster_RollingUpdatePolicy) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.RollingUpdatePolicy"
}
