...
// ProcessingJob_ClusterConfig AWS CloudFormation Resource (AWS::SageMaker::ProcessingJob.ClusterConfig)
...
func (r *ProcessingJob_ClusterConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::ProcessingJob.ClusterConfig"
}
