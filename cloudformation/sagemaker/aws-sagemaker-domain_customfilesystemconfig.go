...
// Domain_CustomFileSystemConfig AWS CloudFormation Resource (AWS::SageMaker::Domain.CustomFileSystemConfig)
...
type Domain_CustomFileSystemConfig struct {
	...
	// S3FileSystemConfig AWS CloudFormation Property
	// Required: false
...
func (r *Domain_CustomFileSystemConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::Domain.CustomFileSystemConfig"
}
