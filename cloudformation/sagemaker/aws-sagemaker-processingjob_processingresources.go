...
// ProcessingJob_ProcessingResources AWS CloudFormation Resource (AWS::SageMaker::ProcessingJob.ProcessingResources)
...
type ProcessingJob_ProcessingResources struct {
	...
	ClusterConfig *ProcessingJob_ClusterConfig `json:"ClusterConfig"`
...
func (r *ProcessingJob_ProcessingResources) AWSCloudFormationType() string {
	return "AWS::SageMaker::ProcessingJob.ProcessingResources"
}
