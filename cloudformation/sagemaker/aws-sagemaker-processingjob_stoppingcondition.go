...
// ProcessingJob_StoppingCondition AWS CloudFormation Resource (AWS::SageMaker::ProcessingJob.StoppingCondition)
...
func (r *ProcessingJob_StoppingCondition) AWSCloudFormationType() string {
	return "AWS::SageMaker::ProcessingJob.StoppingCondition"
}
