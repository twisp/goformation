...
// Cluster_ClusterAutoScalingConfig AWS CloudFormation Resource (AWS::SageMaker::Cluster.ClusterAutoScalingConfig)
...
type Cluster_ClusterAutoScalingConfig struct {
	...
	// AutoScalerType AWS CloudFormation Property
	// Required: false
...
func (r *Cluster_ClusterAutoScalingConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.ClusterAutoScalingConfig"
}
