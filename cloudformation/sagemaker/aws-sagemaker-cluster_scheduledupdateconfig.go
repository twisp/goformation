...
// Cluster_ScheduledUpdateConfig AWS CloudFormation Resource (AWS::SageMaker::Cluster.ScheduledUpdateConfig)
...
func (r *Cluster_ScheduledUpdateConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.ScheduledUpdateConfig"
}
