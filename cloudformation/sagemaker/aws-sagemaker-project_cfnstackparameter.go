...
// Project_CfnStackParameter AWS CloudFormation Resource (AWS::SageMaker::Project.CfnStackParameter)
...
func (r *Project_CfnStackParameter) AWSCloudFormationType() string {
	return "AWS::SageMaker::Project.CfnStackParameter"
}
