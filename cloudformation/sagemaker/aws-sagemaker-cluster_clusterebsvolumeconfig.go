...
// Cluster_ClusterEbsVolumeConfig AWS CloudFormation Resource (AWS::SageMaker::Cluster.ClusterEbsVolumeConfig)
...
type Cluster_ClusterEbsVolumeConfig struct {
	...
	// RootVolume AWS CloudFormation Property
	// Required: false
...
func (r *Cluster_ClusterEbsVolumeConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.ClusterEbsVolumeConfig"
}
