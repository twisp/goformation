...
// Cluster_ClusterNetworkInterface AWS CloudFormation Resource (AWS::SageMaker::Cluster.ClusterNetworkInterface)
...
type Cluster_ClusterNetworkInterface struct {
...
func (r *Cluster_ClusterNetworkInterface) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.ClusterNetworkInterface"
}
