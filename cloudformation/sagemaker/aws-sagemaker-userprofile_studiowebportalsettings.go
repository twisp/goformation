...
// UserProfile_StudioWebPortalSettings AWS CloudFormation Resource (AWS::SageMaker::UserProfile.StudioWebPortalSettings)
...
func (r *UserProfile_StudioWebPortalSettings) AWSCloudFormationType() string {
	return "AWS::SageMaker::UserProfile.StudioWebPortalSettings"
}
