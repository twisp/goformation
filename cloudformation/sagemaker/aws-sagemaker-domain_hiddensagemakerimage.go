...
// Domain_HiddenSageMakerImage AWS CloudFormation Resource (AWS::SageMaker::Domain.HiddenSageMakerImage)
...
func (r *Domain_HiddenSageMakerImage) AWSCloudFormationType() string {
	return "AWS::SageMaker::Domain.HiddenSageMakerImage"
}
