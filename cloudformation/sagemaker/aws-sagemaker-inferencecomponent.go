...
// InferenceComponent AWS CloudFormation Resource (AWS::SageMaker::InferenceComponent)
...
type InferenceComponent struct {
	...
	// EndpointArn AWS CloudFormation Property
	// Required: false
	...
	// InferenceComponentName AWS CloudFormation Property
	// Required: false
...
func (r *InferenceComponent) AWSCloudFormationType() string {
	return "AWS::SageMaker::InferenceComponent"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r InferenceComponent) MarshalJSON() ([]byte, error) {
	type Properties InferenceComponent
...
func (r *InferenceComponent) UnmarshalJSON(b []byte) error {
	type Properties InferenceComponent
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = InferenceComponent(*res.Properties)
	}
