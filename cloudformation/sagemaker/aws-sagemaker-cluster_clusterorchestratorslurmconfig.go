...
// Cluster_ClusterOrchestratorSlurmConfig AWS CloudFormation Resource (AWS::SageMaker::Cluster.ClusterOrchestratorSlurmConfig)
...
func (r *Cluster_ClusterOrchestratorSlurmConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.ClusterOrchestratorSlurmConfig"
}
