...
// Cluster_ClusterInstanceStorageConfig AWS CloudFormation Resource (AWS::SageMaker::Cluster.ClusterInstanceStorageConfig)
...
type Cluster_ClusterInstanceStorageConfig struct {
	...
	// EbsVolumeConfig AWS CloudFormation Property
	// Required: false
...
func (r *Cluster_ClusterInstanceStorageConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.ClusterInstanceStorageConfig"
}
