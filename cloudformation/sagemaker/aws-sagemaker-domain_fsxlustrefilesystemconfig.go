...
// Domain_FSxLustreFileSystemConfig AWS CloudFormation Resource (AWS::SageMaker::Domain.FSxLustreFileSystemConfig)
...
func (r *Domain_FSxLustreFileSystemConfig) AWSCloudFormationType() string {
	return "AWS::SageMaker::Domain.FSxLustreFileSystemConfig"
}
