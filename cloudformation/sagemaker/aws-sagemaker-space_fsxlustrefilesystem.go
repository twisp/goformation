...
// Space_FSxLustreFileSystem AWS CloudFormation Resource (AWS::SageMaker::Space.FSxLustreFileSystem)
...
func (r *Space_FSxLustreFileSystem) AWSCloudFormationType() string {
	return "AWS::SageMaker::Space.FSxLustreFileSystem"
}
