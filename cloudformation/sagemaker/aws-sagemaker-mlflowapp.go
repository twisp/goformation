...
// MlflowApp AWS CloudFormation Resource (AWS::SageMaker::MlflowApp)
...
type MlflowApp struct {
	...
	// ArtifactStoreUri AWS CloudFormation Property
	// Required: true
	...
	// ModelRegistrationMode AWS CloudFormation Property
	// Required: false
...
func (r *MlflowApp) AWSCloudFormationType() string {
	return "AWS::SageMaker::MlflowApp"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r MlflowApp) MarshalJSON() ([]byte, error) {
	type Properties MlflowApp
...
func (r *MlflowApp) UnmarshalJSON(b []byte) error {
	type Properties MlflowApp
	res := &struct {
		Type                string
		Properties          *Properties
