...
// Cluster_InstanceRequirements AWS CloudFormation Resource (AWS::SageMaker::Cluster.InstanceRequirements)
...
type Cluster_InstanceRequirements struct {
...
func (r *Cluster_InstanceRequirements) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.InstanceRequirements"
}
