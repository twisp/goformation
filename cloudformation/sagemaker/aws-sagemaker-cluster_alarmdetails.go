...
// Cluster_AlarmDetails AWS CloudFormation Resource (AWS::SageMaker::Cluster.AlarmDetails)
...
func (r *Cluster_AlarmDetails) AWSCloudFormationType() string {
	return "AWS::SageMaker::Cluster.AlarmDetails"
}
