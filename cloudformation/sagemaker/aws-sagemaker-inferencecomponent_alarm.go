...
// InferenceComponent_Alarm AWS CloudFormation Resource (AWS::SageMaker::InferenceComponent.Alarm)
...
func (r *InferenceComponent_Alarm) AWSCloudFormationType() string {
	return "AWS::SageMaker::InferenceComponent.Alarm"
}
