...
// EmailAddress AWS CloudFormation Resource (AWS::Connect::EmailAddress)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-emailaddress.html
type EmailAddress struct {

	// AliasConfigurations AWS CloudFormation Property
	// Required: false
...
func (r *EmailAddress) AWSCloudFormationType() string {
...
func (r *EmailAddress) UnmarshalJSON(b []byte) error {
	type Properties EmailAddress
	res := &struct {
		Type                string
		Properties          *Properties
