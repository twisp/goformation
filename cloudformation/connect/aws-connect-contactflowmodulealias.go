...
// ContactFlowModuleAlias AWS CloudFormation Resource (AWS::Connect::ContactFlowModuleAlias)
...
type ContactFlowModuleAlias struct {
	...
	// ContactFlowModuleId AWS CloudFormation Property
	// Required: true
	...
	// ContactFlowModuleVersion AWS CloudFormation Property
	// Required: true
	...
	ContactFlowModuleVersion int `json:"ContactFlowModuleVersion"`
...
func (r *ContactFlowModuleAlias) AWSCloudFormationType() string {
	return "AWS::Connect::ContactFlowModuleAlias"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ContactFlowModuleAlias) MarshalJSON() ([]byte, error) {
	type Properties ContactFlowModuleAlias
...
func (r *ContactFlowModuleAlias) UnmarshalJSON(b []byte) error {
	type Properties ContactFlowModuleAlias
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ContactFlowModuleAlias(*res.Properties)
	}
