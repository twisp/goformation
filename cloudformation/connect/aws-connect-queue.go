...
// Queue AWS CloudFormation Resource (AWS::Connect::Queue)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-connect-queue.html
type Queue struct {

	// AdditionalEmailAddresses AWS CloudFormation Property
	// Required: false
	...
	AdditionalEmailAddresses []Queue_EmailAddress `json:"AdditionalEmailAddresses,omitempty"`
	...
	// HoursOfOperationArn AWS CloudFormation Property
	// Required: true
	...
	HoursOfOperationArn string `json:"HoursOfOperationArn"`
	...
	// MaxContacts AWS CloudFormation Property
	// Required: false
	...
	// OutboundCallerConfig AWS CloudFormation Property
	// Required: false
