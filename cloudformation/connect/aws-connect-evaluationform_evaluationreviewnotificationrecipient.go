...
// EvaluationForm_EvaluationReviewNotificationRecipient AWS CloudFormation Resource (AWS::Connect::EvaluationForm.EvaluationReviewNotificationRecipient)
...
type EvaluationForm_EvaluationReviewNotificationRecipient struct {
	...
	Value *EvaluationForm_EvaluationReviewNotificationRecipientValue `json:"Value"`
...
func (r *EvaluationForm_EvaluationReviewNotificationRecipient) AWSCloudFormationType() string {
	return "AWS::Connect::EvaluationForm.EvaluationReviewNotificationRecipient"
}
