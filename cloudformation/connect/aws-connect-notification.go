...
// Notification AWS CloudFormation Resource (AWS::Connect::Notification)
...
type Notification struct {
	...
	Content *Notification_NotificationContent `json:"Content"`
...
func (r *Notification) AWSCloudFormationType() string {
	return "AWS::Connect::Notification"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Notification) MarshalJSON() ([]byte, error) {
	type Properties Notification
...
func (r *Notification) UnmarshalJSON(b []byte) error {
	type Properties Notification
	res := &struct {
		Type                string
		Properties          *Properties
