...
// DataTableRecord_DataTableRecord AWS CloudFormation Resource (AWS::Connect::DataTableRecord.DataTableRecord)
...
type DataTableRecord_DataTableRecord struct {
	...
	// PrimaryValues AWS CloudFormation Property
	// Required: false
	...
	Values []DataTableRecord_Value `json:"Values"`
...
func (r *DataTableRecord_DataTableRecord) AWSCloudFormationType() string {
	return "AWS::Connect::DataTableRecord.DataTableRecord"
}
