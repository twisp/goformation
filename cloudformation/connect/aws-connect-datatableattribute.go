...
// DataTableAttribute AWS CloudFormation Resource (AWS::Connect::DataTableAttribute)
...
func (r *DataTableAttribute) AWSCloudFormationType() string {
	return "AWS::Connect::DataTableAttribute"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DataTableAttribute) MarshalJSON() ([]byte, error) {
	type Properties DataTableAttribute
...
func (r *DataTableAttribute) UnmarshalJSON(b []byte) error {
	type Properties DataTableAttribute
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DataTableAttribute(*res.Properties)
	}
