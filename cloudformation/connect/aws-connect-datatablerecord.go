...
// DataTableRecord AWS CloudFormation Resource (AWS::Connect::DataTableRecord)
...
func (r *DataTableRecord) AWSCloudFormationType() string {
	return "AWS::Connect::DataTableRecord"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DataTableRecord) MarshalJSON() ([]byte, error) {
	type Properties DataTableRecord
...
func (r *DataTableRecord) UnmarshalJSON(b []byte) error {
	type Properties DataTableRecord
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DataTableRecord(*res.Properties)
	}
