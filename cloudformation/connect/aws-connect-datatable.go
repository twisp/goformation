...
// DataTable AWS CloudFormation Resource (AWS::Connect::DataTable)
...
func (r *DataTable) AWSCloudFormationType() string {
	return "AWS::Connect::DataTable"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DataTable) MarshalJSON() ([]byte, error) {
...
func (r *DataTable) UnmarshalJSON(b []byte) error {
	type Properties DataTable
	res := &struct {
		Type                string
		Properties          *Properties
