...
// EvaluationForm_AutoEvaluationConfiguration AWS CloudFormation Resource (AWS::Connect::EvaluationForm.AutoEvaluationConfiguration)
...
func (r *EvaluationForm_AutoEvaluationConfiguration) AWSCloudFormationType() string {
	return "AWS::Connect::EvaluationForm.AutoEvaluationConfiguration"
}
