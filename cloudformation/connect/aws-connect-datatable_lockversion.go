...
// DataTable_LockVersion AWS CloudFormation Resource (AWS::Connect::DataTable.LockVersion)
...
func (r *DataTable_LockVersion) AWSCloudFormationType() string {
	return "AWS::Connect::DataTable.LockVersion"
}
