...
// HoursOfOperation_OverrideTimeSlice AWS CloudFormation Resource (AWS::Connect::HoursOfOperation.OverrideTimeSlice)
...
func (r *HoursOfOperation_OverrideTimeSlice) AWSCloudFormationType() string {
	return "AWS::Connect::HoursOfOperation.OverrideTimeSlice"
}
