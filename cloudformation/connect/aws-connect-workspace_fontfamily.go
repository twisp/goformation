...
// Workspace_FontFamily AWS CloudFormation Resource (AWS::Connect::Workspace.FontFamily)
...
func (r *Workspace_FontFamily) AWSCloudFormationType() string {
	return "AWS::Connect::Workspace.FontFamily"
}
