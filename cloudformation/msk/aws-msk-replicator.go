...
// Replicator AWS CloudFormation Resource (AWS::MSK::Replicator)
...
type Replicator struct {
	...
	// KafkaClusters AWS CloudFormation Property
	// Required: true
	...
	ReplicationInfoList []Replicator_ReplicationInfo `json:"ReplicationInfoList"`

	// ReplicatorName AWS CloudFormation Property
	// Required: true
...
func (r *Replicator) AWSCloudFormationType() string {
	return "AWS::MSK::Replicator"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Replicator) MarshalJSON() ([]byte, error) {
	type Properties Replicator
...
func (r *Replicator) UnmarshalJSON(b []byte) error {
	type Properties Replicator
	res := &struct {
		Type                string
		Properties          *Properties
