...
// Cluster_ZookeeperAccess AWS CloudFormation Resource (AWS::MSK::Cluster.ZookeeperAccess)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-msk-cluster-zookeeperaccess.html
type Cluster_ZookeeperAccess struct {
...
func (r *Cluster_ZookeeperAccess) AWSCloudFormationType() string {
	return "AWS::MSK::Cluster.ZookeeperAccess"
}
