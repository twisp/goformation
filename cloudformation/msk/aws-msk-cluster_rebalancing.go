...
// Cluster_Rebalancing AWS CloudFormation Resource (AWS::MSK::Cluster.Rebalancing)
...
func (r *Cluster_Rebalancing) AWSCloudFormationType() string {
	return "AWS::MSK::Cluster.Rebalancing"
}
