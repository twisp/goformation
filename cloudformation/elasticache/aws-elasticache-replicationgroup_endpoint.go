...
// ReplicationGroup_Endpoint AWS CloudFormation Resource (AWS::ElastiCache::ReplicationGroup.Endpoint)
...
type ReplicationGroup_Endpoint struct {
...
func (r *ReplicationGroup_Endpoint) AWSCloudFormationType() string {
	return "AWS::ElastiCache::ReplicationGroup.Endpoint"
}
