...
// CacheCluster_Endpoint AWS CloudFormation Resource (AWS::ElastiCache::CacheCluster.Endpoint)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-elasticache-cachecluster-endpoint.html
type CacheCluster_Endpoint struct {
...
func (r *CacheCluster_Endpoint) AWSCloudFormationType() string {
	return "AWS::ElastiCache::CacheCluster.Endpoint"
}
