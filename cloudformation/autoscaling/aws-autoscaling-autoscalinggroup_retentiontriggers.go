...
// AutoScalingGroup_RetentionTriggers AWS CloudFormation Resource (AWS::AutoScaling::AutoScalingGroup.RetentionTriggers)
...
type AutoScalingGroup_RetentionTriggers struct {
	...
	// TerminateHookAbandon AWS CloudFormation Property
	// Required: false
...
func (r *AutoScalingGroup_RetentionTriggers) AWSCloudFormationType() string {
	return "AWS::AutoScaling::AutoScalingGroup.RetentionTriggers"
}
