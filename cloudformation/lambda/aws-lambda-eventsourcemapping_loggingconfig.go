...
// EventSourceMapping_LoggingConfig AWS CloudFormation Resource (AWS::Lambda::EventSourceMapping.LoggingConfig)
...
func (r *EventSourceMapping_LoggingConfig) AWSCloudFormationType() string {
	return "AWS::Lambda::EventSourceMapping.LoggingConfig"
}
