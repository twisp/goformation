...
// Function_TenancyConfig AWS CloudFormation Resource (AWS::Lambda::Function.TenancyConfig)
...
type Function_TenancyConfig struct {
	...
	// TenantIsolationMode AWS CloudFormation Property
	// Required: true
...
func (r *Function_TenancyConfig) AWSCloudFormationType() string {
	return "AWS::Lambda::Function.TenancyConfig"
}
