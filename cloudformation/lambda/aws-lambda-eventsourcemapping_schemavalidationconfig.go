...
// EventSourceMapping_SchemaValidationConfig AWS CloudFormation Resource (AWS::Lambda::EventSourceMapping.SchemaValidationConfig)
...
func (r *EventSourceMapping_SchemaValidationConfig) AWSCloudFormationType() string {
	return "AWS::Lambda::EventSourceMapping.SchemaValidationConfig"
}
