...
// EventSourceMapping_SchemaRegistryAccessConfig AWS CloudFormation Resource (AWS::Lambda::EventSourceMapping.SchemaRegistryAccessConfig)
...
func (r *EventSourceMapping_SchemaRegistryAccessConfig) AWSCloudFormationType() string {
	return "AWS::Lambda::EventSourceMapping.SchemaRegistryAccessConfig"
}
