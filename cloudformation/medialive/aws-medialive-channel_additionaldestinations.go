...
// Channel_AdditionalDestinations AWS CloudFormation Resource (AWS::MediaLive::Channel.AdditionalDestinations)
...
func (r *Channel_AdditionalDestinations) AWSCloudFormationType() string {
	return "AWS::MediaLive::Channel.AdditionalDestinations"
}
