...
// Channel_OutputLockingSettings AWS CloudFormation Resource (AWS::MediaLive::Channel.OutputLockingSettings)
...
type Channel_OutputLockingSettings struct {
	...
	// DisabledLockingSettings AWS CloudFormation Property
	// Required: false
	...
	DisabledLockingSettings *Channel_DisabledLockingSettings `json:"DisabledLockingSettings,omitempty"`

	// EpochLockingSettings AWS CloudFormation Property
	// Required: false
...
func (r *Channel_OutputLockingSettings) AWSCloudFormationType() string {
	return "AWS::MediaLive::Channel.OutputLockingSettings"
}
