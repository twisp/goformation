...
// Input_MulticastSourceCreateRequest AWS CloudFormation Resource (AWS::MediaLive::Input.MulticastSourceCreateRequest)
...
func (r *Input_MulticastSourceCreateRequest) AWSCloudFormationType() string {
	return "AWS::MediaLive::Input.MulticastSourceCreateRequest"
}
