...
// Channel_MulticastInputSettings AWS CloudFormation Resource (AWS::MediaLive::Channel.MulticastInputSettings)
...
type Channel_MulticastInputSettings struct {
	...
	// SourceIpAddress AWS CloudFormation Property
	// Required: false
...
func (r *Channel_MulticastInputSettings) AWSCloudFormationType() string {
	return "AWS::MediaLive::Channel.MulticastInputSettings"
}
