...
// Input_SrtSettingsRequest AWS CloudFormation Resource (AWS::MediaLive::Input.SrtSettingsRequest)
...
type Input_SrtSettingsRequest struct {
	...
	// SrtCallerSources AWS CloudFormation Property
	// Required: false
...
func (r *Input_SrtSettingsRequest) AWSCloudFormationType() string {
	return "AWS::MediaLive::Input.SrtSettingsRequest"
}
