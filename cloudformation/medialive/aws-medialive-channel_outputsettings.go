...
type Channel_OutputSettings struct {
	...
	// MediaConnectRouterOutputSettings AWS CloudFormation Property
	// Required: false
	...
	MediaConnectRouterOutputSettings *Channel_MediaConnectRouterOutputSettings `json:"MediaConnectRouterOutputSettings,omitempty"`
