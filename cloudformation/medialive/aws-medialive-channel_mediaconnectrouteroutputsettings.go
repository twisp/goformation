...
// Channel_MediaConnectRouterOutputSettings AWS CloudFormation Resource (AWS::MediaLive::Channel.MediaConnectRouterOutputSettings)
...
type Channel_MediaConnectRouterOutputSettings struct {

	// ConnectedRouterInputs AWS CloudFormation Property
	// Required: false
	...
	ConnectedRouterInputs *Channel_MediaConnectRouterOutputConnectionMap `json:"ConnectedRouterInputs,omitempty"`
	...
	ContainerSettings *Channel_MediaConnectRouterContainerSettings `json:"ContainerSettings,omitempty"`
...
func (r *Channel_MediaConnectRouterOutputSettings) AWSCloudFormationType() string {
	return "AWS::MediaLive::Channel.MediaConnectRouterOutputSettings"
}
