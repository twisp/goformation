...
// Channel_ChannelEngineVersionRequest AWS CloudFormation Resource (AWS::MediaLive::Channel.ChannelEngineVersionRequest)
...
func (r *Channel_ChannelEngineVersionRequest) AWSCloudFormationType() string {
	return "AWS::MediaLive::Channel.ChannelEngineVersionRequest"
}
