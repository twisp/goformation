...
// Channel_PipelineLockingSettings AWS CloudFormation Resource (AWS::MediaLive::Channel.PipelineLockingSettings)
...
func (r *Channel_PipelineLockingSettings) AWSCloudFormationType() string {
	return "AWS::MediaLive::Channel.PipelineLockingSettings"
}
