...
// Channel_PrimaryChannelSettings AWS CloudFormation Resource (AWS::MediaLive::Channel.PrimaryChannelSettings)
...
type Channel_PrimaryChannelSettings struct {
...
func (r *Channel_PrimaryChannelSettings) AWSCloudFormationType() string {
	return "AWS::MediaLive::Channel.PrimaryChannelSettings"
}
