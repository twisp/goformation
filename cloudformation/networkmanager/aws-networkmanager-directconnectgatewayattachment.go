...
// DirectConnectGatewayAttachment AWS CloudFormation Resource (AWS::NetworkManager::DirectConnectGatewayAttachment)
...
type DirectConnectGatewayAttachment struct {
	...
	// DirectConnectGatewayArn AWS CloudFormation Property
	// Required: true
...
func (r *DirectConnectGatewayAttachment) AWSCloudFormationType() string {
	return "AWS::NetworkManager::DirectConnectGatewayAttachment"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DirectConnectGatewayAttachment) MarshalJSON() ([]byte, error) {
	type Properties DirectConnectGatewayAttachment
...
func (r *DirectConnectGatewayAttachment) UnmarshalJSON(b []byte) error {
	type Properties DirectConnectGatewayAttachment
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DirectConnectGatewayAttachment(*res.Properties)
	}
