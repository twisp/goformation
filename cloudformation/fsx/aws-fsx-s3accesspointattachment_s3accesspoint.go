...
// S3AccessPointAttachment_S3AccessPoint AWS CloudFormation Resource (AWS::FSx::S3AccessPointAttachment.S3AccessPoint)
...
func (r *S3AccessPointAttachment_S3AccessPoint) AWSCloudFormationType() string {
	return "AWS::FSx::S3AccessPointAttachment.S3AccessPoint"
}
