...
// S3AccessPointAttachment_OpenZFSFileSystemIdentity AWS CloudFormation Resource (AWS::FSx::S3AccessPointAttachment.OpenZFSFileSystemIdentity)
...
type S3AccessPointAttachment_OpenZFSFileSystemIdentity struct {
	...
	PosixUser *S3AccessPointAttachment_OpenZFSPosixFileSystemUser `json:"PosixUser"`
...
func (r *S3AccessPointAttachment_OpenZFSFileSystemIdentity) AWSCloudFormationType() string {
	return "AWS::FSx::S3AccessPointAttachment.OpenZFSFileSystemIdentity"
}
