...
// CustomAction AWS CloudFormation Resource (AWS::Chatbot::CustomAction)
...
type CustomAction struct {
	...
	Definition *CustomAction_CustomActionDefinition `json:"Definition"`
...
func (r *CustomAction) AWSCloudFormationType() string {
	return "AWS::Chatbot::CustomAction"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CustomAction) MarshalJSON() ([]byte, error) {
	type Properties CustomAction
...
func (r *CustomAction) UnmarshalJSON(b []byte) error {
	type Properties CustomAction
	res := &struct {
		Type                string
		Properties          *Properties
