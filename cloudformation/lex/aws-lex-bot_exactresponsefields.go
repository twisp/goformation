...
// Bot_ExactResponseFields AWS CloudFormation Resource (AWS::Lex::Bot.ExactResponseFields)
...
type Bot_ExactResponseFields struct {
	...
	// AnswerField AWS CloudFormation Property
	// Required: false
	...
	// QuestionField AWS CloudFormation Property
	// Required: false
...
func (r *Bot_ExactResponseFields) AWSCloudFormationType() string {
	return "AWS::Lex::Bot.ExactResponseFields"
}
