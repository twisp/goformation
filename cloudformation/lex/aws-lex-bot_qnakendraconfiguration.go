...
// Bot_QnAKendraConfiguration AWS CloudFormation Resource (AWS::Lex::Bot.QnAKendraConfiguration)
...
func (r *Bot_QnAKendraConfiguration) AWSCloudFormationType() string {
	return "AWS::Lex::Bot.QnAKendraConfiguration"
}
