...
// Bot_ErrorLogSettings AWS CloudFormation Resource (AWS::Lex::Bot.ErrorLogSettings)
...
func (r *Bot_ErrorLogSettings) AWSCloudFormationType() string {
	return "AWS::Lex::Bot.ErrorLogSettings"
}
