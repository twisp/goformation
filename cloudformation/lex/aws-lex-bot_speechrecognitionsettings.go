...
// Bot_SpeechRecognitionSettings AWS CloudFormation Resource (AWS::Lex::Bot.SpeechRecognitionSettings)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-lex-bot-speechrecognitionsettings.html
type Bot_SpeechRecognitionSettings struct {

	// SpeechModelConfig AWS CloudFormation Property
	// Required: false
	...
	SpeechModelConfig *Bot_SpeechModelConfig `json:"SpeechModelConfig,omitempty"`

	// SpeechModelPreference AWS CloudFormation Property
	// Required: false
...
func (r *Bot_SpeechRecognitionSettings) AWSCloudFormationType() string {
	return "AWS::Lex::Bot.SpeechRecognitionSettings"
}
