...
// Bot_NluImprovementSpecification AWS CloudFormation Resource (AWS::Lex::Bot.NluImprovementSpecification)
...
type Bot_NluImprovementSpecification struct {
	...
	// AssistedNluMode AWS CloudFormation Property
	// Required: false
	...
	// IntentDisambiguationSettings AWS CloudFormation Property
	// Required: false
...
func (r *Bot_NluImprovementSpecification) AWSCloudFormationType() string {
	return "AWS::Lex::Bot.NluImprovementSpecification"
}
