...
// Bot_QnAIntentConfiguration AWS CloudFormation Resource (AWS::Lex::Bot.QnAIntentConfiguration)
...
type Bot_QnAIntentConfiguration struct {
	...
	DataSourceConfiguration *Bot_DataSourceConfiguration `json:"DataSourceConfiguration"`
...
func (r *Bot_QnAIntentConfiguration) AWSCloudFormationType() string {
	return "AWS::Lex::Bot.QnAIntentConfiguration"
}
