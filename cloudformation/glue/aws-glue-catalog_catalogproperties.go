...
// Catalog_CatalogProperties AWS CloudFormation Resource (AWS::Glue::Catalog.CatalogProperties)
...
type Catalog_CatalogProperties struct {
	...
	// DataLakeAccessProperties AWS CloudFormation Property
	// Required: false
	...
	DataLakeAccessProperties *Catalog_DataLakeAccessProperties `json:"DataLakeAccessProperties,omitempty"`
...
func (r *Catalog_CatalogProperties) AWSCloudFormationType() string {
	return "AWS::Glue::Catalog.CatalogProperties"
}
