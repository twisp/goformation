...
// Table_IcebergStructField AWS CloudFormation Resource (AWS::Glue::Table.IcebergStructField)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-table-icebergstructfield.html
type Table_IcebergStructField struct {
...
func (r *Table_IcebergStructField) AWSCloudFormationType() string {
	return "AWS::Glue::Table.IcebergStructField"
}
