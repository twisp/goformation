...
// Connection_BasicAuthenticationCredentials AWS CloudFormation Resource (AWS::Glue::Connection.BasicAuthenticationCredentials)
...
func (r *Connection_BasicAuthenticationCredentials) AWSCloudFormationType() string {
	return "AWS::Glue::Connection.BasicAuthenticationCredentials"
}
