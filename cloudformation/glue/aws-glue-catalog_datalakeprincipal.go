...
// Catalog_DataLakePrincipal AWS CloudFormation Resource (AWS::Glue::Catalog.DataLakePrincipal)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-glue-catalog-datalakeprincipal.html
type Catalog_DataLakePrincipal struct {
...
func (r *Catalog_DataLakePrincipal) AWSCloudFormationType() string {
	return "AWS::Glue::Catalog.DataLakePrincipal"
}
