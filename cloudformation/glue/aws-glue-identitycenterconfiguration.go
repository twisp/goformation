...
// IdentityCenterConfiguration AWS CloudFormation Resource (AWS::Glue::IdentityCenterConfiguration)
...
type IdentityCenterConfiguration struct {
	...
	// UserBackgroundSessionsEnabled AWS CloudFormation Property
	// Required: false
...
func (r *IdentityCenterConfiguration) AWSCloudFormationType() string {
	return "AWS::Glue::IdentityCenterConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IdentityCenterConfiguration) MarshalJSON() ([]byte, error) {
	type Properties IdentityCenterConfiguration
...
func (r *IdentityCenterConfiguration) UnmarshalJSON(b []byte) error {
	type Properties IdentityCenterConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IdentityCenterConfiguration(*res.Properties)
	}
