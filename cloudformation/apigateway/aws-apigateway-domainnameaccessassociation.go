...
// DomainNameAccessAssociation AWS CloudFormation Resource (AWS::ApiGateway::DomainNameAccessAssociation)
...
type DomainNameAccessAssociation struct {
	...
	// AccessAssociationSource AWS CloudFormation Property
	// Required: true
	...
	// AccessAssociationSourceType AWS CloudFormation Property
	// Required: true
...
func (r *DomainNameAccessAssociation) AWSCloudFormationType() string {
	return "AWS::ApiGateway::DomainNameAccessAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DomainNameAccessAssociation) MarshalJSON() ([]byte, error) {
	type Properties DomainNameAccessAssociation
...
func (r *DomainNameAccessAssociation) UnmarshalJSON(b []byte) error {
	type Properties DomainNameAccessAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DomainNameAccessAssociation(*res.Properties)
	}
