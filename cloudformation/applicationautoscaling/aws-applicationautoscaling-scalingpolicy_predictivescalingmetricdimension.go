...
// ScalingPolicy_PredictiveScalingMetricDimension AWS CloudFormation Resource (AWS::ApplicationAutoScaling::ScalingPolicy.PredictiveScalingMetricDimension)
...
func (r *ScalingPolicy_PredictiveScalingMetricDimension) AWSCloudFormationType() string {
	return "AWS::ApplicationAutoScaling::ScalingPolicy.PredictiveScalingMetricDimension"
}
