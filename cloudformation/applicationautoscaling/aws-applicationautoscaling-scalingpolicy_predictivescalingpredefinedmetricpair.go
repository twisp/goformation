...
// ScalingPolicy_PredictiveScalingPredefinedMetricPair AWS CloudFormation Resource (AWS::ApplicationAutoScaling::ScalingPolicy.PredictiveScalingPredefinedMetricPair)
...
func (r *ScalingPolicy_PredictiveScalingPredefinedMetricPair) AWSCloudFormationType() string {
	return "AWS::ApplicationAutoScaling::ScalingPolicy.PredictiveScalingPredefinedMetricPair"
}
