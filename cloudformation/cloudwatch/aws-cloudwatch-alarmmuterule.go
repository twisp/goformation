...
// AlarmMuteRule AWS CloudFormation Resource (AWS::CloudWatch::AlarmMuteRule)
...
type AlarmMuteRule struct {
	...
	// ExpireDate AWS CloudFormation Property
	// Required: false
	...
	// MuteTargets AWS CloudFormation Property
	// Required: false
	...
	MuteTargets *AlarmMuteRule_MuteTargets `json:"MuteTargets,omitempty"`
	...
	Rule *AlarmMuteRule_Rule `json:"Rule"`
...
func (r *AlarmMuteRule) AWSCloudFormationType() string {
	return "AWS::CloudWatch::AlarmMuteRule"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AlarmMuteRule) MarshalJSON() ([]byte, error) {
	type Properties AlarmMuteRule
...
func (r *AlarmMuteRule) UnmarshalJSON(b []byte) error {
	type Properties AlarmMuteRule
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AlarmMuteRule(*res.Properties)
	}
