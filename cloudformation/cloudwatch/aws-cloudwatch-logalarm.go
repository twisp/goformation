...
// LogAlarm AWS CloudFormation Resource (AWS::CloudWatch::LogAlarm)
...
type LogAlarm struct {
	...
	// ActionLogLineCount AWS CloudFormation Property
	// Required: false
	...
	// ActionLogLineRoleArn AWS CloudFormation Property
	// Required: false
	...
	// QueryResultsToAlarm AWS CloudFormation Property
	// Required: true
	...
	QueryResultsToAlarm int `json:"QueryResultsToAlarm"`

	// QueryResultsToEvaluate AWS CloudFormation Property
	// Required: true
	...
	QueryResultsToEvaluate int `json:"QueryResultsToEvaluate"`

	// ScheduledQueryConfiguration AWS CloudFormation Property
	// Required: true
	...
	ScheduledQueryConfiguration *LogAlarm_ScheduledQueryConfiguration `json:"ScheduledQueryConfiguration"`
...
func (r *LogAlarm) AWSCloudFormationType() string {
	return "AWS::CloudWatch::LogAlarm"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LogAlarm) MarshalJSON() ([]byte, error) {
	type Properties LogAlarm
...
func (r *LogAlarm) UnmarshalJSON(b []byte) error {
	type Properties LogAlarm
	res := &struct {
		Type                string
		Properties          *Properties
