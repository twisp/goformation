...
// CostCategory_ResourceTag AWS CloudFormation Resource (AWS::CE::CostCategory.ResourceTag)
...
func (r *CostCategory_ResourceTag) AWSCloudFormationType() string {
	return "AWS::CE::CostCategory.ResourceTag"
}
