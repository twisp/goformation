...
// ResourceGateway AWS CloudFormation Resource (AWS::VpcLattice::ResourceGateway)
...
type ResourceGateway struct {
	...
	// ResourceConfigDnsResolution AWS CloudFormation Property
	// Required: false
...
func (r *ResourceGateway) AWSCloudFormationType() string {
	return "AWS::VpcLattice::ResourceGateway"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ResourceGateway) MarshalJSON() ([]byte, error) {
	type Properties ResourceGateway
...
func (r *ResourceGateway) UnmarshalJSON(b []byte) error {
	type Properties ResourceGateway
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ResourceGateway(*res.Properties)
	}
