...
// DomainVerification AWS CloudFormation Resource (AWS::VpcLattice::DomainVerification)
...
func (r *DomainVerification) AWSCloudFormationType() string {
	return "AWS::VpcLattice::DomainVerification"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DomainVerification) MarshalJSON() ([]byte, error) {
	type Properties DomainVerification
...
func (r *DomainVerification) UnmarshalJSON(b []byte) error {
	type Properties DomainVerification
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DomainVerification(*res.Properties)
	}
