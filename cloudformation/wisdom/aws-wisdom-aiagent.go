...
// AIAgent AWS CloudFormation Resource (AWS::Wisdom::AIAgent)
...
type AIAgent struct {
	...
	Configuration *AIAgent_AIAgentConfiguration `json:"Configuration"`
...
func (r *AIAgent) AWSCloudFormationType() string {
	return "AWS::Wisdom::AIAgent"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AIAgent) MarshalJSON() ([]byte, error) {
	type Properties AIAgent
...
func (r *AIAgent) UnmarshalJSON(b []byte) error {
	type Properties AIAgent
	res := &struct {
		Type                string
		Properties          *Properties
