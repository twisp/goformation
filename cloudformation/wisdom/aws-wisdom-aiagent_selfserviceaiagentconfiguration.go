...
// AIAgent_SelfServiceAIAgentConfiguration AWS CloudFormation Resource (AWS::Wisdom::AIAgent.SelfServiceAIAgentConfiguration)
...
type AIAgent_SelfServiceAIAgentConfiguration struct {
	...
	// SelfServiceAIGuardrailId AWS CloudFormation Property
	// Required: false
	...
	SelfServiceAIGuardrailId *string `json:"SelfServiceAIGuardrailId,omitempty"`

	// SelfServiceAnswerGenerationAIPromptId AWS CloudFormation Property
	// Required: false
	...
	SelfServiceAnswerGenerationAIPromptId *string `json:"SelfServiceAnswerGenerationAIPromptId,omitempty"`

	// SelfServicePreProcessingAIPromptId AWS CloudFormation Property
	// Required: false
	...
	SelfServicePreProcessingAIPromptId *string `json:"SelfServicePreProcessingAIPromptId,omitempty"`
...
func (r *AIAgent_SelfServiceAIAgentConfiguration) AWSCloudFormationType() string {
	return "AWS::Wisdom::AIAgent.SelfServiceAIAgentConfiguration"
}
