...
// KnowledgeBase_VectorIngestionConfiguration AWS CloudFormation Resource (AWS::Wisdom::KnowledgeBase.VectorIngestionConfiguration)
...
type KnowledgeBase_VectorIngestionConfiguration struct {
	...
	// ParsingConfiguration AWS CloudFormation Property
	// Required: false
...
func (r *KnowledgeBase_VectorIngestionConfiguration) AWSCloudFormationType() string {
	return "AWS::Wisdom::KnowledgeBase.VectorIngestionConfiguration"
}
