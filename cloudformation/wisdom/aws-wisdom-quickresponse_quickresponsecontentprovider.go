...
// QuickResponse_QuickResponseContentProvider AWS CloudFormation Resource (AWS::Wisdom::QuickResponse.QuickResponseContentProvider)
...
func (r *QuickResponse_QuickResponseContentProvider) AWSCloudFormationType() string {
	return "AWS::Wisdom::QuickResponse.QuickResponseContentProvider"
}
