...
// AIGuardrail_GuardrailPiiEntityConfig AWS CloudFormation Resource (AWS::Wisdom::AIGuardrail.GuardrailPiiEntityConfig)
...
func (r *AIGuardrail_GuardrailPiiEntityConfig) AWSCloudFormationType() string {
	return "AWS::Wisdom::AIGuardrail.GuardrailPiiEntityConfig"
}
