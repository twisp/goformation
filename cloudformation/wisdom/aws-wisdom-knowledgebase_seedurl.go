...
// KnowledgeBase_SeedUrl AWS CloudFormation Resource (AWS::Wisdom::KnowledgeBase.SeedUrl)
...
func (r *KnowledgeBase_SeedUrl) AWSCloudFormationType() string {
	return "AWS::Wisdom::KnowledgeBase.SeedUrl"
}
