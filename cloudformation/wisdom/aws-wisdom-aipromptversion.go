...
// AIPromptVersion AWS CloudFormation Resource (AWS::Wisdom::AIPromptVersion)
...
type AIPromptVersion struct {
	...
	// AIPromptId AWS CloudFormation Property
	// Required: true
	...
	AIPromptId string `json:"AIPromptId"`
...
func (r *AIPromptVersion) AWSCloudFormationType() string {
	return "AWS::Wisdom::AIPromptVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AIPromptVersion) MarshalJSON() ([]byte, error) {
	type Properties AIPromptVersion
...
func (r *AIPromptVersion) UnmarshalJSON(b []byte) error {
	type Properties AIPromptVersion
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AIPromptVersion(*res.Properties)
	}
