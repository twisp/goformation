...
// KnowledgeBase_HierarchicalChunkingConfiguration AWS CloudFormation Resource (AWS::Wisdom::KnowledgeBase.HierarchicalChunkingConfiguration)
...
type KnowledgeBase_HierarchicalChunkingConfiguration struct {
	...
	LevelConfigurations []KnowledgeBase_HierarchicalChunkingLevelConfiguration `json:"LevelConfigurations"`
	...
	OverlapTokens float64 `json:"OverlapTokens"`
...
func (r *KnowledgeBase_HierarchicalChunkingConfiguration) AWSCloudFormationType() string {
	return "AWS::Wisdom::KnowledgeBase.HierarchicalChunkingConfiguration"
}
