...
// AIPrompt AWS CloudFormation Resource (AWS::Wisdom::AIPrompt)
...
type AIPrompt struct {
	...
	TemplateConfiguration *AIPrompt_AIPromptTemplateConfiguration `json:"TemplateConfiguration"`
...
func (r *AIPrompt) AWSCloudFormationType() string {
	return "AWS::Wisdom::AIPrompt"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AIPrompt) MarshalJSON() ([]byte, error) {
	type Properties AIPrompt
...
func (r *AIPrompt) UnmarshalJSON(b []byte) error {
	type Properties AIPrompt
	res := &struct {
		Type                string
		Properties          *Properties
