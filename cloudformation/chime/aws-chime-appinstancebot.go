...
// AppInstanceBot AWS CloudFormation Resource (AWS::Chime::AppInstanceBot)
...
type AppInstanceBot struct {
	...
	// AppInstanceArn AWS CloudFormation Property
	// Required: true
	...
	Configuration *AppInstanceBot_Configuration `json:"Configuration"`
...
func (r *AppInstanceBot) AWSCloudFormationType() string {
	return "AWS::Chime::AppInstanceBot"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AppInstanceBot) MarshalJSON() ([]byte, error) {
	type Properties AppInstanceBot
...
func (r *AppInstanceBot) UnmarshalJSON(b []byte) error {
	type Properties AppInstanceBot
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AppInstanceBot(*res.Properties)
	}
