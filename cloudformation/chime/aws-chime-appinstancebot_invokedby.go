...
// AppInstanceBot_InvokedBy AWS CloudFormation Resource (AWS::Chime::AppInstanceBot.InvokedBy)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-chime-appinstancebot-invokedby.html
type AppInstanceBot_InvokedBy struct {

	// StandardMessages AWS CloudFormation Property
	// Required: true
	...
	StandardMessages string `json:"StandardMessages"`

	// TargetedMessages AWS CloudFormation Property
	// Required: true
	...
	TargetedMessages string `json:"TargetedMessages"`
...
func (r *AppInstanceBot_InvokedBy) AWSCloudFormationType() string {
	return "AWS::Chime::AppInstanceBot.InvokedBy"
}
