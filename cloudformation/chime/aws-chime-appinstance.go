...
// AppInstance AWS CloudFormation Resource (AWS::Chime::AppInstance)
...
func (r *AppInstance) AWSCloudFormationType() string {
	return "AWS::Chime::AppInstance"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AppInstance) MarshalJSON() ([]byte, error) {
	type Properties AppInstance
...
func (r *AppInstance) UnmarshalJSON(b []byte) error {
	type Properties AppInstance
	res := &struct {
		Type                string
		Properties          *Properties
