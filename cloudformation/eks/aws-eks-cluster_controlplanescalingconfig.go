...
// Cluster_ControlPlaneScalingConfig AWS CloudFormation Resource (AWS::EKS::Cluster.ControlPlaneScalingConfig)
...
func (r *Cluster_ControlPlaneScalingConfig) AWSCloudFormationType() string {
	return "AWS::EKS::Cluster.ControlPlaneScalingConfig"
}
