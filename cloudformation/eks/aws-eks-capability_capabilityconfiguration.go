...
// Capability_CapabilityConfiguration AWS CloudFormation Resource (AWS::EKS::Capability.CapabilityConfiguration)
...
func (r *Capability_CapabilityConfiguration) AWSCloudFormationType() string {
	return "AWS::EKS::Capability.CapabilityConfiguration"
}
