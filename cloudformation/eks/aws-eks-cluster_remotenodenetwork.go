...
// Cluster_RemoteNodeNetwork AWS CloudFormation Resource (AWS::EKS::Cluster.RemoteNodeNetwork)
...
func (r *Cluster_RemoteNodeNetwork) AWSCloudFormationType() string {
	return "AWS::EKS::Cluster.RemoteNodeNetwork"
}
