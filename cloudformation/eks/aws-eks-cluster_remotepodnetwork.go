...
// Cluster_RemotePodNetwork AWS CloudFormation Resource (AWS::EKS::Cluster.RemotePodNetwork)
...
func (r *Cluster_RemotePodNetwork) AWSCloudFormationType() string {
	return "AWS::EKS::Cluster.RemotePodNetwork"
}
