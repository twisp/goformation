...
// Stream_WarmThroughputObject AWS CloudFormation Resource (AWS::Kinesis::Stream.WarmThroughputObject)
...
type Stream_WarmThroughputObject struct {
	...
	// CurrentMiBps AWS CloudFormation Property
	// Required: false
	...
	// TargetMiBps AWS CloudFormation Property
	// Required: false
...
func (r *Stream_WarmThroughputObject) AWSCloudFormationType() string {
	return "AWS::Kinesis::Stream.WarmThroughputObject"
}
