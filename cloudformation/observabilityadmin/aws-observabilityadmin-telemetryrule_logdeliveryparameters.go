...
// TelemetryRule_LogDeliveryParameters AWS CloudFormation Resource (AWS::ObservabilityAdmin::TelemetryRule.LogDeliveryParameters)
...
func (r *TelemetryRule_LogDeliveryParameters) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::TelemetryRule.LogDeliveryParameters"
}
