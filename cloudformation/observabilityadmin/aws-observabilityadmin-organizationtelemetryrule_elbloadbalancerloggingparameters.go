...
// OrganizationTelemetryRule_ELBLoadBalancerLoggingParameters AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationTelemetryRule.ELBLoadBalancerLoggingParameters)
...
func (r *OrganizationTelemetryRule_ELBLoadBalancerLoggingParameters) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationTelemetryRule.ELBLoadBalancerLoggingParameters"
}
