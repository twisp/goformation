...
// OrganizationTelemetryRule_RegionStatus AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationTelemetryRule.RegionStatus)
...
type OrganizationTelemetryRule_RegionStatus struct {
...
func (r *OrganizationTelemetryRule_RegionStatus) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationTelemetryRule.RegionStatus"
}
