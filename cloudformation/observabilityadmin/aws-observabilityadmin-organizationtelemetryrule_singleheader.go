...
// OrganizationTelemetryRule_SingleHeader AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationTelemetryRule.SingleHeader)
...
func (r *OrganizationTelemetryRule_SingleHeader) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationTelemetryRule.SingleHeader"
}
