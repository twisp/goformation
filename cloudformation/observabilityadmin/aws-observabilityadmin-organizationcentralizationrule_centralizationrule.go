...
// OrganizationCentralizationRule_CentralizationRule AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationCentralizationRule.CentralizationRule)
...
type OrganizationCentralizationRule_CentralizationRule struct {
	...
	Destination *OrganizationCentralizationRule_CentralizationRuleDestination `json:"Destination"`
	...
	Source *OrganizationCentralizationRule_CentralizationRuleSource `json:"Source"`
...
func (r *OrganizationCentralizationRule_CentralizationRule) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationCentralizationRule.CentralizationRule"
}
