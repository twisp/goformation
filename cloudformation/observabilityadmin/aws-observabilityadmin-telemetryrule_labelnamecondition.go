...
// TelemetryRule_LabelNameCondition AWS CloudFormation Resource (AWS::ObservabilityAdmin::TelemetryRule.LabelNameCondition)
...
func (r *TelemetryRule_LabelNameCondition) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::TelemetryRule.LabelNameCondition"
}
