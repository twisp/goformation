...
// S3TableIntegration AWS CloudFormation Resource (AWS::ObservabilityAdmin::S3TableIntegration)
...
type S3TableIntegration struct {
	...
	Encryption *S3TableIntegration_EncryptionConfig `json:"Encryption"`

	// LogSources AWS CloudFormation Property
	// Required: false
...
func (r *S3TableIntegration) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::S3TableIntegration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r S3TableIntegration) MarshalJSON() ([]byte, error) {
	type Properties S3TableIntegration
...
func (r *S3TableIntegration) UnmarshalJSON(b []byte) error {
	type Properties S3TableIntegration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = S3TableIntegration(*res.Properties)
	}
