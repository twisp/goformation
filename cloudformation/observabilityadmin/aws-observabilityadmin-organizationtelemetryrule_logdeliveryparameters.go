...
// OrganizationTelemetryRule_LogDeliveryParameters AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationTelemetryRule.LogDeliveryParameters)
...
type OrganizationTelemetryRule_LogDeliveryParameters struct {
...
func (r *OrganizationTelemetryRule_LogDeliveryParameters) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationTelemetryRule.LogDeliveryParameters"
}
