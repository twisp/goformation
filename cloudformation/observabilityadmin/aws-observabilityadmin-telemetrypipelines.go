...
// TelemetryPipelines AWS CloudFormation Resource (AWS::ObservabilityAdmin::TelemetryPipelines)
...
type TelemetryPipelines struct {
	...
	Configuration *TelemetryPipelines_TelemetryPipelineConfiguration `json:"Configuration"`
...
func (r *TelemetryPipelines) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::TelemetryPipelines"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TelemetryPipelines) MarshalJSON() ([]byte, error) {
	type Properties TelemetryPipelines
...
func (r *TelemetryPipelines) UnmarshalJSON(b []byte) error {
	type Properties TelemetryPipelines
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TelemetryPipelines(*res.Properties)
	}
