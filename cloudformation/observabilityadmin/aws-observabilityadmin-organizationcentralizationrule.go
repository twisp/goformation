...
// OrganizationCentralizationRule AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationCentralizationRule)
...
type OrganizationCentralizationRule struct {
	...
	Rule *OrganizationCentralizationRule_CentralizationRule `json:"Rule"`
...
func (r *OrganizationCentralizationRule) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationCentralizationRule"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OrganizationCentralizationRule) MarshalJSON() ([]byte, error) {
	type Properties OrganizationCentralizationRule
...
func (r *OrganizationCentralizationRule) UnmarshalJSON(b []byte) error {
	type Properties OrganizationCentralizationRule
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = OrganizationCentralizationRule(*res.Properties)
	}
