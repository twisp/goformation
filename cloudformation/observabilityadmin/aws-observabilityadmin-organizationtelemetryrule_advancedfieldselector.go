...
// OrganizationTelemetryRule_AdvancedFieldSelector AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationTelemetryRule.AdvancedFieldSelector)
...
func (r *OrganizationTelemetryRule_AdvancedFieldSelector) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationTelemetryRule.AdvancedFieldSelector"
}
