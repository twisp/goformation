...
// TelemetryRule_RegionStatus AWS CloudFormation Resource (AWS::ObservabilityAdmin::TelemetryRule.RegionStatus)
...
type TelemetryRule_RegionStatus struct {
...
func (r *TelemetryRule_RegionStatus) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::TelemetryRule.RegionStatus"
}
