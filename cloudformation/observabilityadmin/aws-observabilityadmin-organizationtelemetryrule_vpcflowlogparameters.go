...
// OrganizationTelemetryRule_VPCFlowLogParameters AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationTelemetryRule.VPCFlowLogParameters)
...
func (r *OrganizationTelemetryRule_VPCFlowLogParameters) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationTelemetryRule.VPCFlowLogParameters"
}
