...
// OrganizationCentralizationRule_LogGroupNameConfiguration AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationCentralizationRule.LogGroupNameConfiguration)
...
type OrganizationCentralizationRule_LogGroupNameConfiguration struct {

	// LogGroupNamePattern AWS CloudFormation Property
	// Required: true
...
func (r *OrganizationCentralizationRule_LogGroupNameConfiguration) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationCentralizationRule.LogGroupNameConfiguration"
}
