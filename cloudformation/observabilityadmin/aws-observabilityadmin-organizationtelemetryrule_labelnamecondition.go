...
// OrganizationTelemetryRule_LabelNameCondition AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationTelemetryRule.LabelNameCondition)
...
func (r *OrganizationTelemetryRule_LabelNameCondition) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationTelemetryRule.LabelNameCondition"
}
