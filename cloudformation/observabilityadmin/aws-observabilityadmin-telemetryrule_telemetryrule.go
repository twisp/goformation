...
// TelemetryRule_TelemetryRule AWS CloudFormation Resource (AWS::ObservabilityAdmin::TelemetryRule.TelemetryRule)
...
func (r *TelemetryRule_TelemetryRule) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::TelemetryRule.TelemetryRule"
}
