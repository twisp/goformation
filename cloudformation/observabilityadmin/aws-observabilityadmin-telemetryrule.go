...
// TelemetryRule AWS CloudFormation Resource (AWS::ObservabilityAdmin::TelemetryRule)
...
type TelemetryRule struct {
	...
	Rule *TelemetryRule_TelemetryRule `json:"Rule"`
...
func (r *TelemetryRule) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::TelemetryRule"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TelemetryRule) MarshalJSON() ([]byte, error) {
	type Properties TelemetryRule
...
func (r *TelemetryRule) UnmarshalJSON(b []byte) error {
	type Properties TelemetryRule
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TelemetryRule(*res.Properties)
	}
