...
// OrganizationTelemetryRule AWS CloudFormation Resource (AWS::ObservabilityAdmin::OrganizationTelemetryRule)
...
type OrganizationTelemetryRule struct {
	...
	Rule *OrganizationTelemetryRule_TelemetryRule `json:"Rule"`
...
func (r *OrganizationTelemetryRule) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::OrganizationTelemetryRule"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r OrganizationTelemetryRule) MarshalJSON() ([]byte, error) {
	type Properties OrganizationTelemetryRule
...
func (r *OrganizationTelemetryRule) UnmarshalJSON(b []byte) error {
	type Properties OrganizationTelemetryRule
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = OrganizationTelemetryRule(*res.Properties)
	}
