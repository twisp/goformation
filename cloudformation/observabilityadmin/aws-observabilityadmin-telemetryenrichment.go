...
// TelemetryEnrichment AWS CloudFormation Resource (AWS::ObservabilityAdmin::TelemetryEnrichment)
...
func (r *TelemetryEnrichment) AWSCloudFormationType() string {
	return "AWS::ObservabilityAdmin::TelemetryEnrichment"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TelemetryEnrichment) MarshalJSON() ([]byte, error) {
	type Properties TelemetryEnrichment
...
func (r *TelemetryEnrichment) UnmarshalJSON(b []byte) error {
	type Properties TelemetryEnrichment
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TelemetryEnrichment(*res.Properties)
	}
