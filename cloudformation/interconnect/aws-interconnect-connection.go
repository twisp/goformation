...
// Connection AWS CloudFormation Resource (AWS::Interconnect::Connection)
...
type Connection struct {
	...
	// AttachPoint AWS CloudFormation Property
	// Required: true
	...
	AttachPoint *Connection_AttachPoint `json:"AttachPoint"`
	...
	// RemoteAccount AWS CloudFormation Property
	// Required: false
	...
	RemoteAccount *Connection_RemoteAccount `json:"RemoteAccount,omitempty"`
...
func (r *Connection) AWSCloudFormationType() string {
	return "AWS::Interconnect::Connection"
}
