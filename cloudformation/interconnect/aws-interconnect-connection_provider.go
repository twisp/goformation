...
// Connection_Provider AWS CloudFormation Resource (AWS::Interconnect::Connection.Provider)
...
type Connection_Provider struct {
	...
	// CloudServiceProvider AWS CloudFormation Property
	// Required: false
	...
	// LastMileProvider AWS CloudFormation Property
	// Required: false
...
func (r *Connection_Provider) AWSCloudFormationType() string {
	return "AWS::Interconnect::Connection.Provider"
}
