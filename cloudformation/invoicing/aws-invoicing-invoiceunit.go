...
// InvoiceUnit AWS CloudFormation Resource (AWS::Invoicing::InvoiceUnit)
...
type InvoiceUnit struct {
	...
	// InvoiceReceiver AWS CloudFormation Property
	// Required: true
	...
	InvoiceReceiver string `json:"InvoiceReceiver"`
	...
	Rule *InvoiceUnit_Rule `json:"Rule"`

	// TaxInheritanceDisabled AWS CloudFormation Property
	// Required: false
...
func (r *InvoiceUnit) AWSCloudFormationType() string {
	return "AWS::Invoicing::InvoiceUnit"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r InvoiceUnit) MarshalJSON() ([]byte, error) {
	type Properties InvoiceUnit
...
func (r *InvoiceUnit) UnmarshalJSON(b []byte) error {
	type Properties InvoiceUnit
	res := &struct {
		Type                string
		Properties          *Properties
