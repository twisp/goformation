...
// Layout_FieldItem AWS CloudFormation Resource (AWS::Cases::Layout.FieldItem)
...
func (r *Layout_FieldItem) AWSCloudFormationType() string {
	return "AWS::Cases::Layout.FieldItem"
}
