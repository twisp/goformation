...
// Template_RequiredField AWS CloudFormation Resource (AWS::Cases::Template.RequiredField)
...
func (r *Template_RequiredField) AWSCloudFormationType() string {
	return "AWS::Cases::Template.RequiredField"
}
