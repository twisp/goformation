...
// Field AWS CloudFormation Resource (AWS::Cases::Field)
...
type Field struct {
	...
	Attributes *Field_FieldAttributes `json:"Attributes,omitempty"`
...
func (r *Field) AWSCloudFormationType() string {
...
func (r *Field) UnmarshalJSON(b []byte) error {
	type Properties Field
	res := &struct {
		Type                string
		Properties          *Properties
