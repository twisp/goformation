...
// CaseRule AWS CloudFormation Resource (AWS::Cases::CaseRule)
...
type CaseRule struct {
	...
	Rule *CaseRule_CaseRuleDetails `json:"Rule"`
...
func (r *CaseRule) AWSCloudFormationType() string {
	return "AWS::Cases::CaseRule"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CaseRule) MarshalJSON() ([]byte, error) {
	type Properties CaseRule
...
func (r *CaseRule) UnmarshalJSON(b []byte) error {
	type Properties CaseRule
	res := &struct {
		Type                string
		Properties          *Properties
