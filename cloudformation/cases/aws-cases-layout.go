...
// Layout AWS CloudFormation Resource (AWS::Cases::Layout)
...
type Layout struct {
	...
	Content *Layout_LayoutContent `json:"Content"`
...
func (r *Layout) AWSCloudFormationType() string {
	return "AWS::Cases::Layout"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Layout) MarshalJSON() ([]byte, error) {
...
func (r *Layout) UnmarshalJSON(b []byte) error {
	type Properties Layout
	res := &struct {
		Type                string
		Properties          *Properties
