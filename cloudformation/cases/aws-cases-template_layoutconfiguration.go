...
// Template_LayoutConfiguration AWS CloudFormation Resource (AWS::Cases::Template.LayoutConfiguration)
...
type Template_LayoutConfiguration struct {
	...
	// DefaultLayout AWS CloudFormation Property
	// Required: false
...
func (r *Template_LayoutConfiguration) AWSCloudFormationType() string {
	return "AWS::Cases::Template.LayoutConfiguration"
}
