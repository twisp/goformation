...
// CapacityReservation_CommitmentInfo AWS CloudFormation Resource (AWS::EC2::CapacityReservation.CommitmentInfo)
...
type CapacityReservation_CommitmentInfo struct {
	...
	// CommitmentEndDate AWS CloudFormation Property
	// Required: false
	...
	// CommittedInstanceCount AWS CloudFormation Property
	// Required: false
...
func (r *CapacityReservation_CommitmentInfo) AWSCloudFormationType() string {
	return "AWS::EC2::CapacityReservation.CommitmentInfo"
}
