...
// RouteServerEndpoint AWS CloudFormation Resource (AWS::EC2::RouteServerEndpoint)
...
func (r *RouteServerEndpoint) AWSCloudFormationType() string {
	return "AWS::EC2::RouteServerEndpoint"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RouteServerEndpoint) MarshalJSON() ([]byte, error) {
	type Properties RouteServerEndpoint
...
func (r *RouteServerEndpoint) UnmarshalJSON(b []byte) error {
	type Properties RouteServerEndpoint
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = RouteServerEndpoint(*res.Properties)
	}
