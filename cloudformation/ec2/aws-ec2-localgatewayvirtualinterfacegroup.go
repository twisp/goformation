...
// LocalGatewayVirtualInterfaceGroup AWS CloudFormation Resource (AWS::EC2::LocalGatewayVirtualInterfaceGroup)
...
type LocalGatewayVirtualInterfaceGroup struct {
	...
	// LocalBgpAsn AWS CloudFormation Property
	// Required: false
...
func (r *LocalGatewayVirtualInterfaceGroup) AWSCloudFormationType() string {
	return "AWS::EC2::LocalGatewayVirtualInterfaceGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocalGatewayVirtualInterfaceGroup) MarshalJSON() ([]byte, error) {
	type Properties LocalGatewayVirtualInterfaceGroup
...
func (r *LocalGatewayVirtualInterfaceGroup) UnmarshalJSON(b []byte) error {
	type Properties LocalGatewayVirtualInterfaceGroup
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LocalGatewayVirtualInterfaceGroup(*res.Properties)
	}
