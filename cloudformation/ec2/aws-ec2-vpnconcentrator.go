...
// VPNConcentrator AWS CloudFormation Resource (AWS::EC2::VPNConcentrator)
...
func (r *VPNConcentrator) AWSCloudFormationType() string {
	return "AWS::EC2::VPNConcentrator"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r VPNConcentrator) MarshalJSON() ([]byte, error) {
	type Properties VPNConcentrator
...
func (r *VPNConcentrator) UnmarshalJSON(b []byte) error {
	type Properties VPNConcentrator
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = VPNConcentrator(*res.Properties)
	}
