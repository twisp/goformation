...
// LaunchTemplate_Reference AWS CloudFormation Resource (AWS::EC2::LaunchTemplate.Reference)
...
func (r *LaunchTemplate_Reference) AWSCloudFormationType() string {
	return "AWS::EC2::LaunchTemplate.Reference"
}
