...
// RouteServer AWS CloudFormation Resource (AWS::EC2::RouteServer)
...
func (r *RouteServer) AWSCloudFormationType() string {
	return "AWS::EC2::RouteServer"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RouteServer) MarshalJSON() ([]byte, error) {
	type Properties RouteServer
...
func (r *RouteServer) UnmarshalJSON(b []byte) error {
	type Properties RouteServer
	res := &struct {
		Type                string
		Properties          *Properties
