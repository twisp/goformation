...
// Instance_EnaSrdSpecification AWS CloudFormation Resource (AWS::EC2::Instance.EnaSrdSpecification)
...
func (r *Instance_EnaSrdSpecification) AWSCloudFormationType() string {
	return "AWS::EC2::Instance.EnaSrdSpecification"
}
