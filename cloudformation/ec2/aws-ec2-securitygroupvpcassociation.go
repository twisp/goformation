...
// SecurityGroupVpcAssociation AWS CloudFormation Resource (AWS::EC2::SecurityGroupVpcAssociation)
...
func (r *SecurityGroupVpcAssociation) AWSCloudFormationType() string {
	return "AWS::EC2::SecurityGroupVpcAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SecurityGroupVpcAssociation) MarshalJSON() ([]byte, error) {
	type Properties SecurityGroupVpcAssociation
...
func (r *SecurityGroupVpcAssociation) UnmarshalJSON(b []byte) error {
	type Properties SecurityGroupVpcAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SecurityGroupVpcAssociation(*res.Properties)
	}
