...
// EC2Fleet_ReservedCapacityOptionsRequest AWS CloudFormation Resource (AWS::EC2::EC2Fleet.ReservedCapacityOptionsRequest)
...
func (r *EC2Fleet_ReservedCapacityOptionsRequest) AWSCloudFormationType() string {
	return "AWS::EC2::EC2Fleet.ReservedCapacityOptionsRequest"
}
