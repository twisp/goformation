...
// IPAMPrefixListResolverTarget AWS CloudFormation Resource (AWS::EC2::IPAMPrefixListResolverTarget)
...
type IPAMPrefixListResolverTarget struct {
	...
	// DesiredVersion AWS CloudFormation Property
	// Required: false
	...
	// IpamPrefixListResolverId AWS CloudFormation Property
	// Required: true
	...
	// PrefixListRegion AWS CloudFormation Property
	// Required: true
	...
	// TrackLatestVersion AWS CloudFormation Property
	// Required: true
	...
	TrackLatestVersion bool `json:"TrackLatestVersion"`
...
func (r *IPAMPrefixListResolverTarget) AWSCloudFormationType() string {
	return "AWS::EC2::IPAMPrefixListResolverTarget"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IPAMPrefixListResolverTarget) MarshalJSON() ([]byte, error) {
	type Properties IPAMPrefixListResolverTarget
...
func (r *IPAMPrefixListResolverTarget) UnmarshalJSON(b []byte) error {
	type Properties IPAMPrefixListResolverTarget
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IPAMPrefixListResolverTarget(*res.Properties)
	}
