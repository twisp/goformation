...
// Instance_EnaSrdUdpSpecification AWS CloudFormation Resource (AWS::EC2::Instance.EnaSrdUdpSpecification)
...
func (r *Instance_EnaSrdUdpSpecification) AWSCloudFormationType() string {
	return "AWS::EC2::Instance.EnaSrdUdpSpecification"
}
