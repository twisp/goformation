...
// TransitGatewayConnectPeer AWS CloudFormation Resource (AWS::EC2::TransitGatewayConnectPeer)
...
type TransitGatewayConnectPeer struct {
	...
	// ConnectPeerConfiguration AWS CloudFormation Property
	// Required: true
	...
	ConnectPeerConfiguration *TransitGatewayConnectPeer_TransitGatewayConnectPeerConfiguration `json:"ConnectPeerConfiguration"`
...
func (r *TransitGatewayConnectPeer) AWSCloudFormationType() string {
	return "AWS::EC2::TransitGatewayConnectPeer"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TransitGatewayConnectPeer) MarshalJSON() ([]byte, error) {
	type Properties TransitGatewayConnectPeer
...
func (r *TransitGatewayConnectPeer) UnmarshalJSON(b []byte) error {
	type Properties TransitGatewayConnectPeer
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TransitGatewayConnectPeer(*res.Properties)
	}
