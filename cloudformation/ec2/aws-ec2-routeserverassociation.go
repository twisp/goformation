...
// RouteServerAssociation AWS CloudFormation Resource (AWS::EC2::RouteServerAssociation)
...
func (r *RouteServerAssociation) AWSCloudFormationType() string {
	return "AWS::EC2::RouteServerAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RouteServerAssociation) MarshalJSON() ([]byte, error) {
	type Properties RouteServerAssociation
...
func (r *RouteServerAssociation) UnmarshalJSON(b []byte) error {
	type Properties RouteServerAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = RouteServerAssociation(*res.Properties)
	}
