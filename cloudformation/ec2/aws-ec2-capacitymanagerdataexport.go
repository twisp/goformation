...
// CapacityManagerDataExport AWS CloudFormation Resource (AWS::EC2::CapacityManagerDataExport)
...
func (r *CapacityManagerDataExport) AWSCloudFormationType() string {
	return "AWS::EC2::CapacityManagerDataExport"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r CapacityManagerDataExport) MarshalJSON() ([]byte, error) {
	type Properties CapacityManagerDataExport
...
func (r *CapacityManagerDataExport) UnmarshalJSON(b []byte) error {
	type Properties CapacityManagerDataExport
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = CapacityManagerDataExport(*res.Properties)
	}
