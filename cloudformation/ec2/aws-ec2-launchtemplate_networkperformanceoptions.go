...
// LaunchTemplate_NetworkPerformanceOptions AWS CloudFormation Resource (AWS::EC2::LaunchTemplate.NetworkPerformanceOptions)
...
func (r *LaunchTemplate_NetworkPerformanceOptions) AWSCloudFormationType() string {
	return "AWS::EC2::LaunchTemplate.NetworkPerformanceOptions"
}
