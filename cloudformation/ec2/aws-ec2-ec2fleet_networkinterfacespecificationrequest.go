...
// EC2Fleet_NetworkInterfaceSpecificationRequest AWS CloudFormation Resource (AWS::EC2::EC2Fleet.NetworkInterfaceSpecificationRequest)
...
type EC2Fleet_NetworkInterfaceSpecificationRequest struct {
	...
	Ipv6Addresses []EC2Fleet_Ipv6AddressRequest `json:"Ipv6Addresses,omitempty"`
	...
	PrivateIpAddresses []EC2Fleet_PrivateIpAddressSpecificationRequest `json:"PrivateIpAddresses,omitempty"`
...
func (r *EC2Fleet_NetworkInterfaceSpecificationRequest) AWSCloudFormationType() string {
	return "AWS::EC2::EC2Fleet.NetworkInterfaceSpecificationRequest"
}
