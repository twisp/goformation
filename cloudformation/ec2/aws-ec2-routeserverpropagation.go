...
// RouteServerPropagation AWS CloudFormation Resource (AWS::EC2::RouteServerPropagation)
...
type RouteServerPropagation struct {
	...
	// RouteServerId AWS CloudFormation Property
	// Required: true
...
func (r *RouteServerPropagation) AWSCloudFormationType() string {
	return "AWS::EC2::RouteServerPropagation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RouteServerPropagation) MarshalJSON() ([]byte, error) {
	type Properties RouteServerPropagation
...
func (r *RouteServerPropagation) UnmarshalJSON(b []byte) error {
	type Properties RouteServerPropagation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = RouteServerPropagation(*res.Properties)
	}
