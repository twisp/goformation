...
// IPAMPrefixListResolver AWS CloudFormation Resource (AWS::EC2::IPAMPrefixListResolver)
...
type IPAMPrefixListResolver struct {
	...
	Rules []IPAMPrefixListResolver_IpamPrefixListResolverRule `json:"Rules,omitempty"`
...
func (r *IPAMPrefixListResolver) AWSCloudFormationType() string {
	return "AWS::EC2::IPAMPrefixListResolver"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IPAMPrefixListResolver) MarshalJSON() ([]byte, error) {
	type Properties IPAMPrefixListResolver
...
func (r *IPAMPrefixListResolver) UnmarshalJSON(b []byte) error {
	type Properties IPAMPrefixListResolver
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IPAMPrefixListResolver(*res.Properties)
	}
