...
// EC2Fleet_EbsBlockDevice AWS CloudFormation Resource (AWS::EC2::EC2Fleet.EbsBlockDevice)
...
func (r *EC2Fleet_EbsBlockDevice) AWSCloudFormationType() string {
	return "AWS::EC2::EC2Fleet.EbsBlockDevice"
}
