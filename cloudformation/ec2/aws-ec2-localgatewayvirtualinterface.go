...
// LocalGatewayVirtualInterface AWS CloudFormation Resource (AWS::EC2::LocalGatewayVirtualInterface)
...
type LocalGatewayVirtualInterface struct {
	...
	// LocalAddress AWS CloudFormation Property
	// Required: true
	...
	// OutpostLagId AWS CloudFormation Property
	// Required: true
	...
	OutpostLagId string `json:"OutpostLagId"`
	...
	// PeerBgpAsn AWS CloudFormation Property
	// Required: false
...
func (r *LocalGatewayVirtualInterface) AWSCloudFormationType() string {
	return "AWS::EC2::LocalGatewayVirtualInterface"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r LocalGatewayVirtualInterface) MarshalJSON() ([]byte, error) {
	type Properties LocalGatewayVirtualInterface
...
func (r *LocalGatewayVirtualInterface) UnmarshalJSON(b []byte) error {
	type Properties LocalGatewayVirtualInterface
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = LocalGatewayVirtualInterface(*res.Properties)
	}
