...
// SqlHaStandbyDetectedInstance AWS CloudFormation Resource (AWS::EC2::SqlHaStandbyDetectedInstance)
...
type SqlHaStandbyDetectedInstance struct {
	...
	// SqlServerCredentials AWS CloudFormation Property
	// Required: false
...
func (r *SqlHaStandbyDetectedInstance) AWSCloudFormationType() string {
	return "AWS::EC2::SqlHaStandbyDetectedInstance"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SqlHaStandbyDetectedInstance) MarshalJSON() ([]byte, error) {
	type Properties SqlHaStandbyDetectedInstance
...
func (r *SqlHaStandbyDetectedInstance) UnmarshalJSON(b []byte) error {
	type Properties SqlHaStandbyDetectedInstance
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SqlHaStandbyDetectedInstance(*res.Properties)
	}
