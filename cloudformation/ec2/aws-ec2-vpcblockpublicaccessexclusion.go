...
// VPCBlockPublicAccessExclusion AWS CloudFormation Resource (AWS::EC2::VPCBlockPublicAccessExclusion)
...
type VPCBlockPublicAccessExclusion struct {
	...
	// InternetGatewayExclusionMode AWS CloudFormation Property
	// Required: true
	...
	InternetGatewayExclusionMode string `json:"InternetGatewayExclusionMode"`
...
func (r *VPCBlockPublicAccessExclusion) AWSCloudFormationType() string {
	return "AWS::EC2::VPCBlockPublicAccessExclusion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r VPCBlockPublicAccessExclusion) MarshalJSON() ([]byte, error) {
	type Properties VPCBlockPublicAccessExclusion
...
func (r *VPCBlockPublicAccessExclusion) UnmarshalJSON(b []byte) error {
	type Properties VPCBlockPublicAccessExclusion
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = VPCBlockPublicAccessExclusion(*res.Properties)
	}
