...
// EC2Fleet_IamInstanceProfileSpecification AWS CloudFormation Resource (AWS::EC2::EC2Fleet.IamInstanceProfileSpecification)
...
type EC2Fleet_IamInstanceProfileSpecification struct {
...
func (r *EC2Fleet_IamInstanceProfileSpecification) AWSCloudFormationType() string {
	return "AWS::EC2::EC2Fleet.IamInstanceProfileSpecification"
}
