...
// IpPoolRouteTableAssociation AWS CloudFormation Resource (AWS::EC2::IpPoolRouteTableAssociation)
...
func (r *IpPoolRouteTableAssociation) AWSCloudFormationType() string {
	return "AWS::EC2::IpPoolRouteTableAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r IpPoolRouteTableAssociation) MarshalJSON() ([]byte, error) {
	type Properties IpPoolRouteTableAssociation
...
func (r *IpPoolRouteTableAssociation) UnmarshalJSON(b []byte) error {
	type Properties IpPoolRouteTableAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = IpPoolRouteTableAssociation(*res.Properties)
	}
