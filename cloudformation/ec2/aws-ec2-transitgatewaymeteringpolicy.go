...
// TransitGatewayMeteringPolicy AWS CloudFormation Resource (AWS::EC2::TransitGatewayMeteringPolicy)
...
type TransitGatewayMeteringPolicy struct {
	...
	// MiddleboxAttachmentIds AWS CloudFormation Property
	// Required: false
...
func (r *TransitGatewayMeteringPolicy) AWSCloudFormationType() string {
	return "AWS::EC2::TransitGatewayMeteringPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TransitGatewayMeteringPolicy) MarshalJSON() ([]byte, error) {
	type Properties TransitGatewayMeteringPolicy
...
func (r *TransitGatewayMeteringPolicy) UnmarshalJSON(b []byte) error {
	type Properties TransitGatewayMeteringPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TransitGatewayMeteringPolicy(*res.Properties)
	}
