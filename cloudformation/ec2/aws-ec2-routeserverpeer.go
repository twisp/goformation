...
// RouteServerPeer AWS CloudFormation Resource (AWS::EC2::RouteServerPeer)
...
type RouteServerPeer struct {
	...
	BgpOptions *RouteServerPeer_BgpOptions `json:"BgpOptions"`
	...
	// RouteServerEndpointId AWS CloudFormation Property
	// Required: true
	...
	RouteServerEndpointId string `json:"RouteServerEndpointId"`
...
func (r *RouteServerPeer) AWSCloudFormationType() string {
	return "AWS::EC2::RouteServerPeer"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r RouteServerPeer) MarshalJSON() ([]byte, error) {
	type Properties RouteServerPeer
...
func (r *RouteServerPeer) UnmarshalJSON(b []byte) error {
	type Properties RouteServerPeer
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = RouteServerPeer(*res.Properties)
	}
