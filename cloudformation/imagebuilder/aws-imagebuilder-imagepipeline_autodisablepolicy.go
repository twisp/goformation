...
// ImagePipeline_AutoDisablePolicy AWS CloudFormation Resource (AWS::ImageBuilder::ImagePipeline.AutoDisablePolicy)
...
type ImagePipeline_AutoDisablePolicy struct {
	...
	// FailureCount AWS CloudFormation Property
	// Required: true
...
func (r *ImagePipeline_AutoDisablePolicy) AWSCloudFormationType() string {
	return "AWS::ImageBuilder::ImagePipeline.AutoDisablePolicy"
}
