...
// Image_DeletionSettings AWS CloudFormation Resource (AWS::ImageBuilder::Image.DeletionSettings)
...
func (r *Image_DeletionSettings) AWSCloudFormationType() string {
	return "AWS::ImageBuilder::Image.DeletionSettings"
}
