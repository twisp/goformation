...
// VectorBucketPolicy AWS CloudFormation Resource (AWS::S3Vectors::VectorBucketPolicy)
...
func (r *VectorBucketPolicy) AWSCloudFormationType() string {
	return "AWS::S3Vectors::VectorBucketPolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r VectorBucketPolicy) MarshalJSON() ([]byte, error) {
	type Properties VectorBucketPolicy
...
func (r *VectorBucketPolicy) UnmarshalJSON(b []byte) error {
	type Properties VectorBucketPolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = VectorBucketPolicy(*res.Properties)
	}
