...
// AnycastIpList AWS CloudFormation Resource (AWS::CloudFront::AnycastIpList)
...
type AnycastIpList struct {
	...
	// IpamCidrConfigs AWS CloudFormation Property
	// Required: false
...
func (r *AnycastIpList) AWSCloudFormationType() string {
	return "AWS::CloudFront::AnycastIpList"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AnycastIpList) MarshalJSON() ([]byte, error) {
	type Properties AnycastIpList
...
func (r *AnycastIpList) UnmarshalJSON(b []byte) error {
	type Properties AnycastIpList
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AnycastIpList(*res.Properties)
	}
