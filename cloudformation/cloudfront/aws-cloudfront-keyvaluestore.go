...
// KeyValueStore AWS CloudFormation Resource (AWS::CloudFront::KeyValueStore)
...
type KeyValueStore struct {
	...
	// ImportSource AWS CloudFormation Property
	// Required: false
...
func (r *KeyValueStore) AWSCloudFormationType() string {
	return "AWS::CloudFront::KeyValueStore"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r KeyValueStore) MarshalJSON() ([]byte, error) {
	type Properties KeyValueStore
...
func (r *KeyValueStore) UnmarshalJSON(b []byte) error {
	type Properties KeyValueStore
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = KeyValueStore(*res.Properties)
	}
