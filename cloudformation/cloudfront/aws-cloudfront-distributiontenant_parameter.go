...
// DistributionTenant_Parameter AWS CloudFormation Resource (AWS::CloudFront::DistributionTenant.Parameter)
...
func (r *DistributionTenant_Parameter) AWSCloudFormationType() string {
	return "AWS::CloudFront::DistributionTenant.Parameter"
}
