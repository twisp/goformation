...
// DistributionTenant_DomainResult AWS CloudFormation Resource (AWS::CloudFront::DistributionTenant.DomainResult)
...
func (r *DistributionTenant_DomainResult) AWSCloudFormationType() string {
	return "AWS::CloudFront::DistributionTenant.DomainResult"
}
