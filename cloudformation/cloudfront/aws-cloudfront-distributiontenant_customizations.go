...
// DistributionTenant_Customizations AWS CloudFormation Resource (AWS::CloudFront::DistributionTenant.Customizations)
...
type DistributionTenant_Customizations struct {
	...
	// GeoRestrictions AWS CloudFormation Property
	// Required: false
	...
	// WebAcl AWS CloudFormation Property
	// Required: false
...
func (r *DistributionTenant_Customizations) AWSCloudFormationType() string {
	return "AWS::CloudFront::DistributionTenant.Customizations"
}
