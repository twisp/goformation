...
// Distribution_ConnectionFunctionAssociation AWS CloudFormation Resource (AWS::CloudFront::Distribution.ConnectionFunctionAssociation)
...
func (r *Distribution_ConnectionFunctionAssociation) AWSCloudFormationType() string {
	return "AWS::CloudFront::Distribution.ConnectionFunctionAssociation"
}
