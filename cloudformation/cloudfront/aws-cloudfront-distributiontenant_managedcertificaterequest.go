...
// DistributionTenant_ManagedCertificateRequest AWS CloudFormation Resource (AWS::CloudFront::DistributionTenant.ManagedCertificateRequest)
...
type DistributionTenant_ManagedCertificateRequest struct {
	...
	// PrimaryDomainName AWS CloudFormation Property
	// Required: false
	...
	// ValidationTokenHost AWS CloudFormation Property
	// Required: false
...
func (r *DistributionTenant_ManagedCertificateRequest) AWSCloudFormationType() string {
	return "AWS::CloudFront::DistributionTenant.ManagedCertificateRequest"
}
