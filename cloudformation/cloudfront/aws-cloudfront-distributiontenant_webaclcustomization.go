...
// DistributionTenant_WebAclCustomization AWS CloudFormation Resource (AWS::CloudFront::DistributionTenant.WebAclCustomization)
...
func (r *DistributionTenant_WebAclCustomization) AWSCloudFormationType() string {
	return "AWS::CloudFront::DistributionTenant.WebAclCustomization"
}
