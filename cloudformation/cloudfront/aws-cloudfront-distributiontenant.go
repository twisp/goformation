...
// DistributionTenant AWS CloudFormation Resource (AWS::CloudFront::DistributionTenant)
...
type DistributionTenant struct {
	...
	// ConnectionGroupId AWS CloudFormation Property
	// Required: false
	...
	// Customizations AWS CloudFormation Property
	// Required: false
	...
	// ManagedCertificateRequest AWS CloudFormation Property
	// Required: false
...
func (r *DistributionTenant) AWSCloudFormationType() string {
	return "AWS::CloudFront::DistributionTenant"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DistributionTenant) MarshalJSON() ([]byte, error) {
	type Properties DistributionTenant
...
func (r *DistributionTenant) UnmarshalJSON(b []byte) error {
	type Properties DistributionTenant
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DistributionTenant(*res.Properties)
	}
