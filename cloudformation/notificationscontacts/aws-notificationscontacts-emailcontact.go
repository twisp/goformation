...
// EmailContact AWS CloudFormation Resource (AWS::NotificationsContacts::EmailContact)
...
func (r *EmailContact) AWSCloudFormationType() string {
	return "AWS::NotificationsContacts::EmailContact"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EmailContact) MarshalJSON() ([]byte, error) {
	type Properties EmailContact
...
func (r *EmailContact) UnmarshalJSON(b []byte) error {
	type Properties EmailContact
	res := &struct {
		Type                string
		Properties          *Properties
