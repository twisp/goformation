...
// MatchingWorkflow_CustomerProfilesIntegrationConfig AWS CloudFormation Resource (AWS::EntityResolution::MatchingWorkflow.CustomerProfilesIntegrationConfig)
...
type MatchingWorkflow_CustomerProfilesIntegrationConfig struct {
	...
	// ObjectTypeArn AWS CloudFormation Property
	// Required: true
	...
	ObjectTypeArn string `json:"ObjectTypeArn"`
...
func (r *MatchingWorkflow_CustomerProfilesIntegrationConfig) AWSCloudFormationType() string {
	return "AWS::EntityResolution::MatchingWorkflow.CustomerProfilesIntegrationConfig"
}
