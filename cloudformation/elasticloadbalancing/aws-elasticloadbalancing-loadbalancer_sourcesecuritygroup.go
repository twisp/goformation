...
// LoadBalancer_SourceSecurityGroup AWS CloudFormation Resource (AWS::ElasticLoadBalancing::LoadBalancer.SourceSecurityGroup)
...
type LoadBalancer_SourceSecurityGroup struct {
	...
	// OwnerAlias AWS CloudFormation Property
	// Required: false
...
func (r *LoadBalancer_SourceSecurityGroup) AWSCloudFormationType() string {
	return "AWS::ElasticLoadBalancing::LoadBalancer.SourceSecurityGroup"
}
