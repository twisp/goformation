...
// EventDataStore_ContextKeySelector AWS CloudFormation Resource (AWS::CloudTrail::EventDataStore.ContextKeySelector)
...
func (r *EventDataStore_ContextKeySelector) AWSCloudFormationType() string {
	return "AWS::CloudTrail::EventDataStore.ContextKeySelector"
}
