...
// WorkspacesPool AWS CloudFormation Resource (AWS::WorkSpaces::WorkspacesPool)
...
type WorkspacesPool struct {
	...
	Capacity *WorkspacesPool_Capacity `json:"Capacity"`
	...
	// TimeoutSettings AWS CloudFormation Property
	// Required: false
...
func (r *WorkspacesPool) AWSCloudFormationType() string {
	return "AWS::WorkSpaces::WorkspacesPool"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r WorkspacesPool) MarshalJSON() ([]byte, error) {
	type Properties WorkspacesPool
...
func (r *WorkspacesPool) UnmarshalJSON(b []byte) error {
	type Properties WorkspacesPool
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = WorkspacesPool(*res.Properties)
	}
