...
// ImageBuilder_VolumeConfig AWS CloudFormation Resource (AWS::AppStream::ImageBuilder.VolumeConfig)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-appstream-imagebuilder-volumeconfig.html
type ImageBuilder_VolumeConfig struct {
...
func (r *ImageBuilder_VolumeConfig) AWSCloudFormationType() string {
	return "AWS::AppStream::ImageBuilder.VolumeConfig"
}
