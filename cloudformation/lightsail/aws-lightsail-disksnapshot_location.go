...
// DiskSnapshot_Location AWS CloudFormation Resource (AWS::Lightsail::DiskSnapshot.Location)
...
func (r *DiskSnapshot_Location) AWSCloudFormationType() string {
	return "AWS::Lightsail::DiskSnapshot.Location"
}
