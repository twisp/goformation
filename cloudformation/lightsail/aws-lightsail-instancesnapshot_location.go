...
// InstanceSnapshot_Location AWS CloudFormation Resource (AWS::Lightsail::InstanceSnapshot.Location)
...
func (r *InstanceSnapshot_Location) AWSCloudFormationType() string {
	return "AWS::Lightsail::InstanceSnapshot.Location"
}
