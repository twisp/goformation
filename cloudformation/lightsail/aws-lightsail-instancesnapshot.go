...
// InstanceSnapshot AWS CloudFormation Resource (AWS::Lightsail::InstanceSnapshot)
...
type InstanceSnapshot struct {
	...
	// InstanceSnapshotName AWS CloudFormation Property
	// Required: true
...
func (r *InstanceSnapshot) AWSCloudFormationType() string {
	return "AWS::Lightsail::InstanceSnapshot"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r InstanceSnapshot) MarshalJSON() ([]byte, error) {
	type Properties InstanceSnapshot
...
func (r *InstanceSnapshot) UnmarshalJSON(b []byte) error {
	type Properties InstanceSnapshot
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = InstanceSnapshot(*res.Properties)
	}
