...
// Domain_Location AWS CloudFormation Resource (AWS::Lightsail::Domain.Location)
...
func (r *Domain_Location) AWSCloudFormationType() string {
	return "AWS::Lightsail::Domain.Location"
}
