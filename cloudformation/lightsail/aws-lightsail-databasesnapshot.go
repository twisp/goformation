...
// DatabaseSnapshot AWS CloudFormation Resource (AWS::Lightsail::DatabaseSnapshot)
...
type DatabaseSnapshot struct {
	...
	// RelationalDatabaseSnapshotName AWS CloudFormation Property
	// Required: true
...
func (r *DatabaseSnapshot) AWSCloudFormationType() string {
	return "AWS::Lightsail::DatabaseSnapshot"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DatabaseSnapshot) MarshalJSON() ([]byte, error) {
	type Properties DatabaseSnapshot
...
func (r *DatabaseSnapshot) UnmarshalJSON(b []byte) error {
	type Properties DatabaseSnapshot
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DatabaseSnapshot(*res.Properties)
	}
