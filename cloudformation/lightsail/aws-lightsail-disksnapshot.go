...
// DiskSnapshot AWS CloudFormation Resource (AWS::Lightsail::DiskSnapshot)
...
type DiskSnapshot struct {
	...
	// DiskSnapshotName AWS CloudFormation Property
	// Required: true
...
func (r *DiskSnapshot) AWSCloudFormationType() string {
	return "AWS::Lightsail::DiskSnapshot"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DiskSnapshot) MarshalJSON() ([]byte, error) {
	type Properties DiskSnapshot
...
func (r *DiskSnapshot) UnmarshalJSON(b []byte) error {
	type Properties DiskSnapshot
	res := &struct {
		Type                string
		Properties          *Properties
