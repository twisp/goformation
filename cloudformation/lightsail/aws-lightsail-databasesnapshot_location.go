...
// DatabaseSnapshot_Location AWS CloudFormation Resource (AWS::Lightsail::DatabaseSnapshot.Location)
...
func (r *DatabaseSnapshot_Location) AWSCloudFormationType() string {
	return "AWS::Lightsail::DatabaseSnapshot.Location"
}
