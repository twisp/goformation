...
// WorkspaceInstance_EC2ManagedInstance AWS CloudFormation Resource (AWS::WorkspacesInstances::WorkspaceInstance.EC2ManagedInstance)
...
func (r *WorkspaceInstance_EC2ManagedInstance) AWSCloudFormationType() string {
	return "AWS::WorkspacesInstances::WorkspaceInstance.EC2ManagedInstance"
}
