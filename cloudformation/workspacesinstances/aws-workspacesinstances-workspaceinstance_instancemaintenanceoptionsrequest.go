...
// WorkspaceInstance_InstanceMaintenanceOptionsRequest AWS CloudFormation Resource (AWS::WorkspacesInstances::WorkspaceInstance.InstanceMaintenanceOptionsRequest)
...
func (r *WorkspaceInstance_InstanceMaintenanceOptionsRequest) AWSCloudFormationType() string {
	return "AWS::WorkspacesInstances::WorkspaceInstance.InstanceMaintenanceOptionsRequest"
}
