...
// WorkspaceInstance_TagSpecification AWS CloudFormation Resource (AWS::WorkspacesInstances::WorkspaceInstance.TagSpecification)
...
func (r *WorkspaceInstance_TagSpecification) AWSCloudFormationType() string {
	return "AWS::WorkspacesInstances::WorkspaceInstance.TagSpecification"
}
