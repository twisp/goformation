...
// WorkspaceInstance_CreditSpecificationRequest AWS CloudFormation Resource (AWS::WorkspacesInstances::WorkspaceInstance.CreditSpecificationRequest)
...
func (r *WorkspaceInstance_CreditSpecificationRequest) AWSCloudFormationType() string {
	return "AWS::WorkspacesInstances::WorkspaceInstance.CreditSpecificationRequest"
}
