...
// WorkspaceInstance_LicenseConfigurationRequest AWS CloudFormation Resource (AWS::WorkspacesInstances::WorkspaceInstance.LicenseConfigurationRequest)
...
func (r *WorkspaceInstance_LicenseConfigurationRequest) AWSCloudFormationType() string {
	return "AWS::WorkspacesInstances::WorkspaceInstance.LicenseConfigurationRequest"
}
