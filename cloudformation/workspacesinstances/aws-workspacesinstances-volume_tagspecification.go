...
// Volume_TagSpecification AWS CloudFormation Resource (AWS::WorkspacesInstances::Volume.TagSpecification)
...
func (r *Volume_TagSpecification) AWSCloudFormationType() string {
	return "AWS::WorkspacesInstances::Volume.TagSpecification"
}
