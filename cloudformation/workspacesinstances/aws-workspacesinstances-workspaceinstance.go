...
// WorkspaceInstance AWS CloudFormation Resource (AWS::WorkspacesInstances::WorkspaceInstance)
...
type WorkspaceInstance struct {
	...
	// ManagedInstance AWS CloudFormation Property
	// Required: false
...
func (r *WorkspaceInstance) AWSCloudFormationType() string {
	return "AWS::WorkspacesInstances::WorkspaceInstance"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r WorkspaceInstance) MarshalJSON() ([]byte, error) {
	type Properties WorkspaceInstance
...
func (r *WorkspaceInstance) UnmarshalJSON(b []byte) error {
	type Properties WorkspaceInstance
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = WorkspaceInstance(*res.Properties)
	}
