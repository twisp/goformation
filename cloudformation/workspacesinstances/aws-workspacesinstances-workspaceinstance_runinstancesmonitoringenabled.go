...
// WorkspaceInstance_RunInstancesMonitoringEnabled AWS CloudFormation Resource (AWS::WorkspacesInstances::WorkspaceInstance.RunInstancesMonitoringEnabled)
...
func (r *WorkspaceInstance_RunInstancesMonitoringEnabled) AWSCloudFormationType() string {
	return "AWS::WorkspacesInstances::WorkspaceInstance.RunInstancesMonitoringEnabled"
}
