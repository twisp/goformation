...
// WorkspaceInstance_InstanceMarketOptionsRequest AWS CloudFormation Resource (AWS::WorkspacesInstances::WorkspaceInstance.InstanceMarketOptionsRequest)
...
func (r *WorkspaceInstance_InstanceMarketOptionsRequest) AWSCloudFormationType() string {
	return "AWS::WorkspacesInstances::WorkspaceInstance.InstanceMarketOptionsRequest"
}
