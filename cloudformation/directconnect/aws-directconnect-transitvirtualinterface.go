...
// TransitVirtualInterface AWS CloudFormation Resource (AWS::DirectConnect::TransitVirtualInterface)
...
type TransitVirtualInterface struct {
	...
	// AllocateTransitVirtualInterfaceRoleArn AWS CloudFormation Property
	// Required: false
	...
	BgpPeers []TransitVirtualInterface_BgpPeer `json:"BgpPeers"`
...
func (r *TransitVirtualInterface) AWSCloudFormationType() string {
	return "AWS::DirectConnect::TransitVirtualInterface"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TransitVirtualInterface) MarshalJSON() ([]byte, error) {
	type Properties TransitVirtualInterface
...
func (r *TransitVirtualInterface) UnmarshalJSON(b []byte) error {
	type Properties TransitVirtualInterface
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TransitVirtualInterface(*res.Properties)
	}
