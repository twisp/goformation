...
// PrivateVirtualInterface AWS CloudFormation Resource (AWS::DirectConnect::PrivateVirtualInterface)
...
type PrivateVirtualInterface struct {
	...
	// AllocatePrivateVirtualInterfaceRoleArn AWS CloudFormation Property
	// Required: false
	...
	// BgpPeers AWS CloudFormation Property
	// Required: true
	...
	BgpPeers []PrivateVirtualInterface_BgpPeer `json:"BgpPeers"`
	...
	// DirectConnectGatewayId AWS CloudFormation Property
	// Required: false
	...
	// EnableSiteLink AWS CloudFormation Property
	// Required: false
	...
	// VirtualGatewayId AWS CloudFormation Property
	// Required: false
	...
	// VirtualInterfaceName AWS CloudFormation Property
	// Required: true
	...
	// Vlan AWS CloudFormation Property
	// Required: true
...
func (r *PrivateVirtualInterface) AWSCloudFormationType() string {
	return "AWS::DirectConnect::PrivateVirtualInterface"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PrivateVirtualInterface) MarshalJSON() ([]byte, error) {
	type Properties PrivateVirtualInterface
...
func (r *PrivateVirtualInterface) UnmarshalJSON(b []byte) error {
	type Properties PrivateVirtualInterface
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PrivateVirtualInterface(*res.Properties)
	}
