...
// DirectConnectGateway AWS CloudFormation Resource (AWS::DirectConnect::DirectConnectGateway)
...
type DirectConnectGateway struct {
	...
	// DirectConnectGatewayName AWS CloudFormation Property
	// Required: true
...
func (r *DirectConnectGateway) AWSCloudFormationType() string {
	return "AWS::DirectConnect::DirectConnectGateway"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DirectConnectGateway) MarshalJSON() ([]byte, error) {
	type Properties DirectConnectGateway
...
func (r *DirectConnectGateway) UnmarshalJSON(b []byte) error {
	type Properties DirectConnectGateway
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DirectConnectGateway(*res.Properties)
	}
