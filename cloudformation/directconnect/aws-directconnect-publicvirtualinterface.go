...
// PublicVirtualInterface AWS CloudFormation Resource (AWS::DirectConnect::PublicVirtualInterface)
...
type PublicVirtualInterface struct {
	...
	// AllocatePublicVirtualInterfaceRoleArn AWS CloudFormation Property
	// Required: false
	...
	BgpPeers []PublicVirtualInterface_BgpPeer `json:"BgpPeers"`
...
func (r *PublicVirtualInterface) AWSCloudFormationType() string {
	return "AWS::DirectConnect::PublicVirtualInterface"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PublicVirtualInterface) MarshalJSON() ([]byte, error) {
	type Properties PublicVirtualInterface
...
func (r *PublicVirtualInterface) UnmarshalJSON(b []byte) error {
	type Properties PublicVirtualInterface
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PublicVirtualInterface(*res.Properties)
	}
