...
// AccessGrantsLocation AWS CloudFormation Resource (AWS::S3::AccessGrantsLocation)
...
func (r *AccessGrantsLocation) AWSCloudFormationType() string {
	return "AWS::S3::AccessGrantsLocation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AccessGrantsLocation) MarshalJSON() ([]byte, error) {
	type Properties AccessGrantsLocation
...
func (r *AccessGrantsLocation) UnmarshalJSON(b []byte) error {
	type Properties AccessGrantsLocation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AccessGrantsLocation(*res.Properties)
	}
