...
// Bucket_MetadataConfiguration AWS CloudFormation Resource (AWS::S3::Bucket.MetadataConfiguration)
...
type Bucket_MetadataConfiguration struct {
	...
	// AnnotationTableConfiguration AWS CloudFormation Property
	// Required: false
	...
	AnnotationTableConfiguration *Bucket_AnnotationTableConfiguration `json:"AnnotationTableConfiguration,omitempty"`
	...
	// InventoryTableConfiguration AWS CloudFormation Property
	// Required: false
	...
	// JournalTableConfiguration AWS CloudFormation Property
	// Required: true
	...
	JournalTableConfiguration *Bucket_JournalTableConfiguration `json:"JournalTableConfiguration"`
...
func (r *Bucket_MetadataConfiguration) AWSCloudFormationType() string {
	return "AWS::S3::Bucket.MetadataConfiguration"
}
