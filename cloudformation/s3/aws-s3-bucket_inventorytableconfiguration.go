...
// Bucket_InventoryTableConfiguration AWS CloudFormation Resource (AWS::S3::Bucket.InventoryTableConfiguration)
...
func (r *Bucket_InventoryTableConfiguration) AWSCloudFormationType() string {
	return "AWS::S3::Bucket.InventoryTableConfiguration"
}
