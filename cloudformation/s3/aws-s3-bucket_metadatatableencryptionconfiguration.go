...
// Bucket_MetadataTableEncryptionConfiguration AWS CloudFormation Resource (AWS::S3::Bucket.MetadataTableEncryptionConfiguration)
...
func (r *Bucket_MetadataTableEncryptionConfiguration) AWSCloudFormationType() string {
	return "AWS::S3::Bucket.MetadataTableEncryptionConfiguration"
}
