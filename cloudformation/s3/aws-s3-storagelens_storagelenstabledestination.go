...
// StorageLens_StorageLensTableDestination AWS CloudFormation Resource (AWS::S3::StorageLens.StorageLensTableDestination)
...
func (r *StorageLens_StorageLensTableDestination) AWSCloudFormationType() string {
	return "AWS::S3::StorageLens.StorageLensTableDestination"
}
