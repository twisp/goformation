...
// Bucket_BlockedEncryptionTypes AWS CloudFormation Resource (AWS::S3::Bucket.BlockedEncryptionTypes)
...
func (r *Bucket_BlockedEncryptionTypes) AWSCloudFormationType() string {
	return "AWS::S3::Bucket.BlockedEncryptionTypes"
}
