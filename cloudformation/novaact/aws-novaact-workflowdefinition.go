...
// WorkflowDefinition AWS CloudFormation Resource (AWS::NovaAct::WorkflowDefinition)
...
type WorkflowDefinition struct {
	...
	ExportConfig *WorkflowDefinition_WorkflowExportConfig `json:"ExportConfig,omitempty"`
...
func (r *WorkflowDefinition) AWSCloudFormationType() string {
	return "AWS::NovaAct::WorkflowDefinition"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r WorkflowDefinition) MarshalJSON() ([]byte, error) {
	type Properties WorkflowDefinition
...
func (r *WorkflowDefinition) UnmarshalJSON(b []byte) error {
	type Properties WorkflowDefinition
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = WorkflowDefinition(*res.Properties)
	}
