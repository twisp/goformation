...
// Application AWS CloudFormation Resource (AWS::SecurityAgent::Application)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-securityagent-application.html
type Application struct {

	// DefaultKmsKeyId AWS CloudFormation Property
	// Required: false
	...
	// IdCConfiguration AWS CloudFormation Property
	// Required: false
	...
	IdCConfiguration *Application_IdCConfiguration `json:"IdCConfiguration,omitempty"`
...
func (r *Application) AWSCloudFormationType() string {
	return "AWS::SecurityAgent::Application"
}
