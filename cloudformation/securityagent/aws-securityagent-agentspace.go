...
// AgentSpace AWS CloudFormation Resource (AWS::SecurityAgent::AgentSpace)
...
type AgentSpace struct {
	...
	// AwsResources AWS CloudFormation Property
	// Required: false
	...
	AwsResources *AgentSpace_AWSResources `json:"AwsResources,omitempty"`

	// CodeReviewSettings AWS CloudFormation Property
	// Required: false
	...
	CodeReviewSettings *AgentSpace_CodeReviewSettings `json:"CodeReviewSettings,omitempty"`
	...
	// IntegratedResources AWS CloudFormation Property
	// Required: false
	...
	IntegratedResources []AgentSpace_IntegratedResource `json:"IntegratedResources,omitempty"`
	...
	// TargetDomainIds AWS CloudFormation Property
	// Required: false
...
func (r *AgentSpace) AWSCloudFormationType() string {
	return "AWS::SecurityAgent::AgentSpace"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AgentSpace) MarshalJSON() ([]byte, error) {
	type Properties AgentSpace
...
func (r *AgentSpace) UnmarshalJSON(b []byte) error {
	type Properties AgentSpace
	res := &struct {
		Type                string
		Properties          *Properties
