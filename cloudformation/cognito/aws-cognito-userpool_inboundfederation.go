...
// UserPool_InboundFederation AWS CloudFormation Resource (AWS::Cognito::UserPool.InboundFederation)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-cognito-userpool-inboundfederation.html
type UserPool_InboundFederation struct {
...
func (r *UserPool_InboundFederation) AWSCloudFormationType() string {
	return "AWS::Cognito::UserPool.InboundFederation"
}
