...
// ManagedLoginBranding AWS CloudFormation Resource (AWS::Cognito::ManagedLoginBranding)
...
type ManagedLoginBranding struct {
	...
	// Assets AWS CloudFormation Property
	// Required: false
	...
	// ReturnMergedResources AWS CloudFormation Property
	// Required: false
	...
	// UseCognitoProvidedValues AWS CloudFormation Property
	// Required: false
...
func (r *ManagedLoginBranding) AWSCloudFormationType() string {
	return "AWS::Cognito::ManagedLoginBranding"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ManagedLoginBranding) MarshalJSON() ([]byte, error) {
	type Properties ManagedLoginBranding
...
func (r *ManagedLoginBranding) UnmarshalJSON(b []byte) error {
	type Properties ManagedLoginBranding
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ManagedLoginBranding(*res.Properties)
	}
