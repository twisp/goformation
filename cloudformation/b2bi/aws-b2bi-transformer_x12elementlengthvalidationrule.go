...
// Transformer_X12ElementLengthValidationRule AWS CloudFormation Resource (AWS::B2BI::Transformer.X12ElementLengthValidationRule)
...
func (r *Transformer_X12ElementLengthValidationRule) AWSCloudFormationType() string {
	return "AWS::B2BI::Transformer.X12ElementLengthValidationRule"
}
