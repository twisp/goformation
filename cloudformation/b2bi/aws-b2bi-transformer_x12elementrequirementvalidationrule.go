...
// Transformer_X12ElementRequirementValidationRule AWS CloudFormation Resource (AWS::B2BI::Transformer.X12ElementRequirementValidationRule)
...
type Transformer_X12ElementRequirementValidationRule struct {
	...
	// ElementPosition AWS CloudFormation Property
	// Required: true
	...
	ElementPosition string `json:"ElementPosition"`
...
func (r *Transformer_X12ElementRequirementValidationRule) AWSCloudFormationType() string {
	return "AWS::B2BI::Transformer.X12ElementRequirementValidationRule"
}
