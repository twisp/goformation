...
// Plan_LambdaUngraceful AWS CloudFormation Resource (AWS::ARCRegionSwitch::Plan.LambdaUngraceful)
...
func (r *Plan_LambdaUngraceful) AWSCloudFormationType() string {
	return "AWS::ARCRegionSwitch::Plan.LambdaUngraceful"
}
