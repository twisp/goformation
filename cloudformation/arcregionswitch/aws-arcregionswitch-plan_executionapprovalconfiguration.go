...
// Plan_ExecutionApprovalConfiguration AWS CloudFormation Resource (AWS::ARCRegionSwitch::Plan.ExecutionApprovalConfiguration)
...
type Plan_ExecutionApprovalConfiguration struct {
	...
	// ApprovalRole AWS CloudFormation Property
	// Required: true
	...
	ApprovalRole string `json:"ApprovalRole"`
...
func (r *Plan_ExecutionApprovalConfiguration) AWSCloudFormationType() string {
	return "AWS::ARCRegionSwitch::Plan.ExecutionApprovalConfiguration"
}
