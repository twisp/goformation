...
// Plan_Route53ResourceRecordSet AWS CloudFormation Resource (AWS::ARCRegionSwitch::Plan.Route53ResourceRecordSet)
...
type Plan_Route53ResourceRecordSet struct {
	...
	// RecordSetIdentifier AWS CloudFormation Property
	// Required: false
	...
	RecordSetIdentifier *string `json:"RecordSetIdentifier,omitempty"`
...
func (r *Plan_Route53ResourceRecordSet) AWSCloudFormationType() string {
	return "AWS::ARCRegionSwitch::Plan.Route53ResourceRecordSet"
}
