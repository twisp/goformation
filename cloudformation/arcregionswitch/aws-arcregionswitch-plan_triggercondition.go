...
// Plan_TriggerCondition AWS CloudFormation Resource (AWS::ARCRegionSwitch::Plan.TriggerCondition)
...
type Plan_TriggerCondition struct {
	...
	// AssociatedAlarmName AWS CloudFormation Property
	// Required: true
	...
	AssociatedAlarmName string `json:"AssociatedAlarmName"`
...
func (r *Plan_TriggerCondition) AWSCloudFormationType() string {
	return "AWS::ARCRegionSwitch::Plan.TriggerCondition"
}
