...
// Plan_RdsPromoteReadReplicaConfiguration AWS CloudFormation Resource (AWS::ARCRegionSwitch::Plan.RdsPromoteReadReplicaConfiguration)
...
type Plan_RdsPromoteReadReplicaConfiguration struct {
...
func (r *Plan_RdsPromoteReadReplicaConfiguration) AWSCloudFormationType() string {
	return "AWS::ARCRegionSwitch::Plan.RdsPromoteReadReplicaConfiguration"
}
