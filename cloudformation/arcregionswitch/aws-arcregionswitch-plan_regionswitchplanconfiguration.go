...
// Plan_RegionSwitchPlanConfiguration AWS CloudFormation Resource (AWS::ARCRegionSwitch::Plan.RegionSwitchPlanConfiguration)
...
func (r *Plan_RegionSwitchPlanConfiguration) AWSCloudFormationType() string {
	return "AWS::ARCRegionSwitch::Plan.RegionSwitchPlanConfiguration"
}
