...
// Pipeline_EnvironmentVariable AWS CloudFormation Resource (AWS::CodePipeline::Pipeline.EnvironmentVariable)
...
func (r *Pipeline_EnvironmentVariable) AWSCloudFormationType() string {
	return "AWS::CodePipeline::Pipeline.EnvironmentVariable"
}
