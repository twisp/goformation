...
// Service_NewRelicServiceDetails AWS CloudFormation Resource (AWS::DevOpsAgent::Service.NewRelicServiceDetails)
...
type Service_NewRelicServiceDetails struct {
	...
	AuthorizationConfig *Service_NewRelicAuthorizationConfig `json:"AuthorizationConfig"`
...
func (r *Service_NewRelicServiceDetails) AWSCloudFormationType() string {
	return "AWS::DevOpsAgent::Service.NewRelicServiceDetails"
}
