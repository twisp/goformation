...
type Association struct {
	...
	Configuration *Association_ServiceConfiguration `json:"Configuration"`

	// LinkedAssociationIds AWS CloudFormation Property
	// Required: false
