...
// Association_ServiceNowConfiguration AWS CloudFormation Resource (AWS::DevOpsAgent::Association.ServiceNowConfiguration)
...
func (r *Association_ServiceNowConfiguration) AWSCloudFormationType() string {
	return "AWS::DevOpsAgent::Association.ServiceNowConfiguration"
}
