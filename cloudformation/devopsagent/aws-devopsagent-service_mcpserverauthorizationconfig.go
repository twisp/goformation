...
// Service_MCPServerAuthorizationConfig AWS CloudFormation Resource (AWS::DevOpsAgent::Service.MCPServerAuthorizationConfig)
...
type Service_MCPServerAuthorizationConfig struct {
	...
	OAuthClientCredentials *Service_MCPServerOAuthClientCredentialsConfig `json:"OAuthClientCredentials,omitempty"`
...
func (r *Service_MCPServerAuthorizationConfig) AWSCloudFormationType() string {
	return "AWS::DevOpsAgent::Service.MCPServerAuthorizationConfig"
}
