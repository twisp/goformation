...
// Association_KeyValuePair AWS CloudFormation Resource (AWS::DevOpsAgent::Association.KeyValuePair)
...
func (r *Association_KeyValuePair) AWSCloudFormationType() string {
	return "AWS::DevOpsAgent::Association.KeyValuePair"
}
