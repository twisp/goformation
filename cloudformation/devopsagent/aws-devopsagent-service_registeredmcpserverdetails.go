...
// Service_RegisteredMCPServerDetails AWS CloudFormation Resource (AWS::DevOpsAgent::Service.RegisteredMCPServerDetails)
...
type Service_RegisteredMCPServerDetails struct {
...
func (r *Service_RegisteredMCPServerDetails) AWSCloudFormationType() string {
	return "AWS::DevOpsAgent::Service.RegisteredMCPServerDetails"
}
