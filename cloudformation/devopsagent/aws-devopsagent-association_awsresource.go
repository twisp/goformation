...
// Association_AWSResource AWS CloudFormation Resource (AWS::DevOpsAgent::Association.AWSResource)
...
type Association_AWSResource struct {
	...
	// ResourceMetadata AWS CloudFormation Property
	// Required: false
	...
	ResourceMetadata interface{} `json:"ResourceMetadata,omitempty"`
...
func (r *Association_AWSResource) AWSCloudFormationType() string {
	return "AWS::DevOpsAgent::Association.AWSResource"
}
