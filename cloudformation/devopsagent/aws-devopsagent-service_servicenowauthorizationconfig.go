...
// Service_ServiceNowAuthorizationConfig AWS CloudFormation Resource (AWS::DevOpsAgent::Service.ServiceNowAuthorizationConfig)
...
type Service_ServiceNowAuthorizationConfig struct {
...
func (r *Service_ServiceNowAuthorizationConfig) AWSCloudFormationType() string {
	return "AWS::DevOpsAgent::Service.ServiceNowAuthorizationConfig"
}
