...
// AgentSpace AWS CloudFormation Resource (AWS::DevOpsAgent::AgentSpace)
...
type AgentSpace struct {
	...
	// OperatorApp AWS CloudFormation Property
	// Required: false
	...
	OperatorApp *AgentSpace_OperatorApp `json:"OperatorApp,omitempty"`
