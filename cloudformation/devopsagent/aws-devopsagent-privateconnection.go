...
// PrivateConnection AWS CloudFormation Resource (AWS::DevOpsAgent::PrivateConnection)
...
type PrivateConnection struct {
	...
	ConnectionConfiguration *PrivateConnection_ConnectionConfiguration `json:"ConnectionConfiguration"`
...
func (r *PrivateConnection) AWSCloudFormationType() string {
	return "AWS::DevOpsAgent::PrivateConnection"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PrivateConnection) MarshalJSON() ([]byte, error) {
	type Properties PrivateConnection
...
func (r *PrivateConnection) UnmarshalJSON(b []byte) error {
	type Properties PrivateConnection
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PrivateConnection(*res.Properties)
	}
