...
// APIKey_AppleApp AWS CloudFormation Resource (AWS::Location::APIKey.AppleApp)
...
func (r *APIKey_AppleApp) AWSCloudFormationType() string {
	return "AWS::Location::APIKey.AppleApp"
}
