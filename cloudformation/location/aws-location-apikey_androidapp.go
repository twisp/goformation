...
// APIKey_AndroidApp AWS CloudFormation Resource (AWS::Location::APIKey.AndroidApp)
...
type APIKey_AndroidApp struct {
	...
	// CertificateFingerprint AWS CloudFormation Property
	// Required: true
	...
	// Package AWS CloudFormation Property
	// Required: true
...
func (r *APIKey_AndroidApp) AWSCloudFormationType() string {
	return "AWS::Location::APIKey.AndroidApp"
}
