...
// ConfiguredModelAlgorithmAssociation AWS CloudFormation Resource (AWS::CleanRoomsML::ConfiguredModelAlgorithmAssociation)
...
type ConfiguredModelAlgorithmAssociation struct {
	...
	// ConfiguredModelAlgorithmArn AWS CloudFormation Property
	// Required: true
	...
	ConfiguredModelAlgorithmArn string `json:"ConfiguredModelAlgorithmArn"`
	...
	// PrivacyConfiguration AWS CloudFormation Property
	// Required: false
	...
	PrivacyConfiguration *ConfiguredModelAlgorithmAssociation_PrivacyConfiguration `json:"PrivacyConfiguration,omitempty"`
...
func (r *ConfiguredModelAlgorithmAssociation) AWSCloudFormationType() string {
	return "AWS::CleanRoomsML::ConfiguredModelAlgorithmAssociation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ConfiguredModelAlgorithmAssociation) MarshalJSON() ([]byte, error) {
	type Properties ConfiguredModelAlgorithmAssociation
...
func (r *ConfiguredModelAlgorithmAssociation) UnmarshalJSON(b []byte) error {
	type Properties ConfiguredModelAlgorithmAssociation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ConfiguredModelAlgorithmAssociation(*res.Properties)
	}
