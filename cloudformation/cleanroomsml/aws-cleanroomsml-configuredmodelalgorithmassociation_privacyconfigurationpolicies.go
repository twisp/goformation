...
// ConfiguredModelAlgorithmAssociation_PrivacyConfigurationPolicies AWS CloudFormation Resource (AWS::CleanRoomsML::ConfiguredModelAlgorithmAssociation.PrivacyConfigurationPolicies)
...
type ConfiguredModelAlgorithmAssociation_PrivacyConfigurationPolicies struct {

	// TrainedModelExports AWS CloudFormation Property
	// Required: false
	...
	TrainedModelExports *ConfiguredModelAlgorithmAssociation_TrainedModelExportsConfigurationPolicy `json:"TrainedModelExports,omitempty"`

	// TrainedModelInferenceJobs AWS CloudFormation Property
	// Required: false
	...
	TrainedModelInferenceJobs *ConfiguredModelAlgorithmAssociation_TrainedModelInferenceJobsConfigurationPolicy `json:"TrainedModelInferenceJobs,omitempty"`

	// TrainedModels AWS CloudFormation Property
	// Required: false
	...
	TrainedModels *ConfiguredModelAlgorithmAssociation_TrainedModelsConfigurationPolicy `json:"TrainedModels,omitempty"`
...
func (r *ConfiguredModelAlgorithmAssociation_PrivacyConfigurationPolicies) AWSCloudFormationType() string {
	return "AWS::CleanRoomsML::ConfiguredModelAlgorithmAssociation.PrivacyConfigurationPolicies"
}
