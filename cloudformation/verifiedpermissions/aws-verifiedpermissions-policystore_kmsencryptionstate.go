...
// PolicyStore_KmsEncryptionState AWS CloudFormation Resource (AWS::VerifiedPermissions::PolicyStore.KmsEncryptionState)
...
type PolicyStore_KmsEncryptionState struct {
...
func (r *PolicyStore_KmsEncryptionState) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::PolicyStore.KmsEncryptionState"
}
