...
// PolicyStoreAlias AWS CloudFormation Resource (AWS::VerifiedPermissions::PolicyStoreAlias)
...
func (r *PolicyStoreAlias) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::PolicyStoreAlias"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PolicyStoreAlias) MarshalJSON() ([]byte, error) {
	type Properties PolicyStoreAlias
...
func (r *PolicyStoreAlias) UnmarshalJSON(b []byte) error {
	type Properties PolicyStoreAlias
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PolicyStoreAlias(*res.Properties)
	}
