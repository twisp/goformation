...
// PolicyStore_KmsEncryptionSettings AWS CloudFormation Resource (AWS::VerifiedPermissions::PolicyStore.KmsEncryptionSettings)
...
type PolicyStore_KmsEncryptionSettings struct {

	// EncryptionContext AWS CloudFormation Property
	// Required: false
...
func (r *PolicyStore_KmsEncryptionSettings) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::PolicyStore.KmsEncryptionSettings"
}
