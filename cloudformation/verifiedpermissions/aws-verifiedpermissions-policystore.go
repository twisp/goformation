...
type PolicyStore struct {
	...
	// EncryptionSettings AWS CloudFormation Property
	// Required: false
	...
	EncryptionSettings *PolicyStore_EncryptionSettings `json:"EncryptionSettings,omitempty"`
	...
	ValidationSettings *PolicyStore_ValidationSettings `json:"ValidationSettings"`
...
func (r *PolicyStore) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::PolicyStore"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PolicyStore) MarshalJSON() ([]byte, error) {
	type Properties PolicyStore
...
func (r *PolicyStore) UnmarshalJSON(b []byte) error {
	type Properties PolicyStore
	res := &struct {
		Type                string
		Properties          *Properties
