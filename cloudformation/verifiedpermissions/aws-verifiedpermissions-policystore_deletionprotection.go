...
// PolicyStore_DeletionProtection AWS CloudFormation Resource (AWS::VerifiedPermissions::PolicyStore.DeletionProtection)
...
func (r *PolicyStore_DeletionProtection) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::PolicyStore.DeletionProtection"
}
