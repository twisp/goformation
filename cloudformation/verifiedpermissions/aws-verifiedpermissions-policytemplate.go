...
// PolicyTemplate AWS CloudFormation Resource (AWS::VerifiedPermissions::PolicyTemplate)
...
func (r *PolicyTemplate) AWSCloudFormationType() string {
	return "AWS::VerifiedPermissions::PolicyTemplate"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r PolicyTemplate) MarshalJSON() ([]byte, error) {
	type Properties PolicyTemplate
...
func (r *PolicyTemplate) UnmarshalJSON(b []byte) error {
	type Properties PolicyTemplate
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = PolicyTemplate(*res.Properties)
	}
