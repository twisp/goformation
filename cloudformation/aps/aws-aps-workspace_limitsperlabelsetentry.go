...
// Workspace_LimitsPerLabelSetEntry AWS CloudFormation Resource (AWS::APS::Workspace.LimitsPerLabelSetEntry)
...
type Workspace_LimitsPerLabelSetEntry struct {
	...
	// MaxSeries AWS CloudFormation Property
	// Required: false
...
func (r *Workspace_LimitsPerLabelSetEntry) AWSCloudFormationType() string {
	return "AWS::APS::Workspace.LimitsPerLabelSetEntry"
}
