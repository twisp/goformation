...
// AnomalyDetector_Label AWS CloudFormation Resource (AWS::APS::AnomalyDetector.Label)
...
func (r *AnomalyDetector_Label) AWSCloudFormationType() string {
	return "AWS::APS::AnomalyDetector.Label"
}
