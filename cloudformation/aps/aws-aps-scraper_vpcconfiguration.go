...
// Scraper_VpcConfiguration AWS CloudFormation Resource (AWS::APS::Scraper.VpcConfiguration)
...
func (r *Scraper_VpcConfiguration) AWSCloudFormationType() string {
	return "AWS::APS::Scraper.VpcConfiguration"
}
