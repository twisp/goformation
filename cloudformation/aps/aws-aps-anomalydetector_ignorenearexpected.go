...
// AnomalyDetector_IgnoreNearExpected AWS CloudFormation Resource (AWS::APS::AnomalyDetector.IgnoreNearExpected)
...
type AnomalyDetector_IgnoreNearExpected struct {
	...
	// Ratio AWS CloudFormation Property
	// Required: false
...
func (r *AnomalyDetector_IgnoreNearExpected) AWSCloudFormationType() string {
	return "AWS::APS::AnomalyDetector.IgnoreNearExpected"
}
