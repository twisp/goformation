...
// Workspace_CloudWatchLogDestination AWS CloudFormation Resource (AWS::APS::Workspace.CloudWatchLogDestination)
...
func (r *Workspace_CloudWatchLogDestination) AWSCloudFormationType() string {
	return "AWS::APS::Workspace.CloudWatchLogDestination"
}
