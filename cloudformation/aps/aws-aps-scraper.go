...
// Scraper AWS CloudFormation Resource (AWS::APS::Scraper)
...
type Scraper struct {
	...
	Destination *Scraper_Destination `json:"Destination"`

	// RoleConfiguration AWS CloudFormation Property
	// Required: false
	...
	// ScrapeConfiguration AWS CloudFormation Property
	// Required: true
	...
	Source *Scraper_Source `json:"Source"`
...
func (r *Scraper) AWSCloudFormationType() string {
	return "AWS::APS::Scraper"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Scraper) MarshalJSON() ([]byte, error) {
	type Properties Scraper
...
func (r *Scraper) UnmarshalJSON(b []byte) error {
	type Properties Scraper
	res := &struct {
		Type                string
		Properties          *Properties
