...
// AnomalyDetector_MissingDataAction AWS CloudFormation Resource (AWS::APS::AnomalyDetector.MissingDataAction)
...
type AnomalyDetector_MissingDataAction struct {
	...
	// MarkAsAnomaly AWS CloudFormation Property
	// Required: false
	...
	// Skip AWS CloudFormation Property
	// Required: false
...
func (r *AnomalyDetector_MissingDataAction) AWSCloudFormationType() string {
	return "AWS::APS::AnomalyDetector.MissingDataAction"
}
