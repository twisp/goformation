...
// Scraper_RoleConfiguration AWS CloudFormation Resource (AWS::APS::Scraper.RoleConfiguration)
...
func (r *Scraper_RoleConfiguration) AWSCloudFormationType() string {
	return "AWS::APS::Scraper.RoleConfiguration"
}
