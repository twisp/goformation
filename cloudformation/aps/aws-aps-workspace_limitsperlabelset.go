...
// Workspace_LimitsPerLabelSet AWS CloudFormation Resource (AWS::APS::Workspace.LimitsPerLabelSet)
...
type Workspace_LimitsPerLabelSet struct {
	...
	// LabelSet AWS CloudFormation Property
	// Required: true
	...
	LabelSet []Workspace_Label `json:"LabelSet"`
	...
	Limits *Workspace_LimitsPerLabelSetEntry `json:"Limits"`
...
func (r *Workspace_LimitsPerLabelSet) AWSCloudFormationType() string {
	return "AWS::APS::Workspace.LimitsPerLabelSet"
}
