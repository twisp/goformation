...
// DomainConfiguration_ServerCertificateConfig AWS CloudFormation Resource (AWS::IoT::DomainConfiguration.ServerCertificateConfig)
...
type DomainConfiguration_ServerCertificateConfig struct {
	...
	// EnableOCSPCheck AWS CloudFormation Property
	// Required: false
	...
	// OcspAuthorizedResponderArn AWS CloudFormation Property
	// Required: false
	...
	// OcspLambdaArn AWS CloudFormation Property
	// Required: false
...
func (r *DomainConfiguration_ServerCertificateConfig) AWSCloudFormationType() string {
	return "AWS::IoT::DomainConfiguration.ServerCertificateConfig"
}
