...
// EncryptionConfiguration AWS CloudFormation Resource (AWS::IoT::EncryptionConfiguration)
...
type EncryptionConfiguration struct {
	...
	// KmsAccessRoleArn AWS CloudFormation Property
	// Required: false
...
func (r *EncryptionConfiguration) AWSCloudFormationType() string {
	return "AWS::IoT::EncryptionConfiguration"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r EncryptionConfiguration) MarshalJSON() ([]byte, error) {
	type Properties EncryptionConfiguration
...
func (r *EncryptionConfiguration) UnmarshalJSON(b []byte) error {
	type Properties EncryptionConfiguration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = EncryptionConfiguration(*res.Properties)
	}
