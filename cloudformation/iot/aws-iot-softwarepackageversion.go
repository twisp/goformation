...
// SoftwarePackageVersion AWS CloudFormation Resource (AWS::IoT::SoftwarePackageVersion)
...
type SoftwarePackageVersion struct {
	...
	// Artifact AWS CloudFormation Property
	// Required: false
	...
	// Sbom AWS CloudFormation Property
	// Required: false
...
func (r *SoftwarePackageVersion) AWSCloudFormationType() string {
	return "AWS::IoT::SoftwarePackageVersion"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SoftwarePackageVersion) MarshalJSON() ([]byte, error) {
	type Properties SoftwarePackageVersion
...
func (r *SoftwarePackageVersion) UnmarshalJSON(b []byte) error {
	type Properties SoftwarePackageVersion
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SoftwarePackageVersion(*res.Properties)
	}
