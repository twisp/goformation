...
type Command struct {
	...
	// Deprecated AWS CloudFormation Property
	// Required: false
	...
	// MandatoryParameters AWS CloudFormation Property
	// Required: false
...
func (r *Command) AWSCloudFormationType() string {
...
func (r *Command) UnmarshalJSON(b []byte) error {
	type Properties Command
	res := &struct {
		Type                string
		Properties          *Properties
