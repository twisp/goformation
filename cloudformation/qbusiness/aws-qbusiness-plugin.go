...
// Plugin AWS CloudFormation Resource (AWS::QBusiness::Plugin)
...
type Plugin struct {
	...
	AuthConfiguration *Plugin_PluginAuthConfiguration `json:"AuthConfiguration"`

	// CustomPluginConfiguration AWS CloudFormation Property
	// Required: false
...
func (r *Plugin) AWSCloudFormationType() string {
	return "AWS::QBusiness::Plugin"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Plugin) MarshalJSON() ([]byte, error) {
	type Properties Plugin
...
func (r *Plugin) UnmarshalJSON(b []byte) error {
	type Properties Plugin
	res := &struct {
		Type                string
		Properties          *Properties
