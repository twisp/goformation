...
// Application_IframeConfig AWS CloudFormation Resource (AWS::AppIntegrations::Application.IframeConfig)
...
type Application_IframeConfig struct {
	...
	// Sandbox AWS CloudFormation Property
	// Required: false
...
func (r *Application_IframeConfig) AWSCloudFormationType() string {
	return "AWS::AppIntegrations::Application.IframeConfig"
}
