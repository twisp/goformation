...
// UserJourney AWS CloudFormation Resource (AWS::ResilienceHubV2::UserJourney)
...
type UserJourney struct {
	...
	// SystemIdentifier AWS CloudFormation Property
	// Required: true
...
func (r *UserJourney) AWSCloudFormationType() string {
	return "AWS::ResilienceHubV2::UserJourney"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r UserJourney) MarshalJSON() ([]byte, error) {
	type Properties UserJourney
...
func (r *UserJourney) UnmarshalJSON(b []byte) error {
	type Properties UserJourney
	res := &struct {
		Type                string
		Properties          *Properties
