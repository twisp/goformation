...
// Service_PermissionModel AWS CloudFormation Resource (AWS::ResilienceHubV2::Service.PermissionModel)
...
type Service_PermissionModel struct {
	...
	CrossAccountRoleArns []Service_CrossAccountRoleConfiguration `json:"CrossAccountRoleArns,omitempty"`
	...
	InvokerRoleName string `json:"InvokerRoleName"`
...
func (r *Service_PermissionModel) AWSCloudFormationType() string {
	return "AWS::ResilienceHubV2::Service.PermissionModel"
}
