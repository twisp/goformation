...
// Policy AWS CloudFormation Resource (AWS::ResilienceHubV2::Policy)
...
type Policy struct {
	...
	AvailabilitySlo *Policy_AvailabilitySlo `json:"AvailabilitySlo,omitempty"`

	// DataRecovery AWS CloudFormation Property
	// Required: false
	...
	DataRecovery *Policy_DataRecoveryTargets `json:"DataRecovery,omitempty"`
	...
	MultiAz *Policy_MultiAzTargets `json:"MultiAz,omitempty"`
	...
	MultiRegion *Policy_MultiRegionTargets `json:"MultiRegion,omitempty"`
...
func (r *Policy) AWSCloudFormationType() string {
	return "AWS::ResilienceHubV2::Policy"
}
