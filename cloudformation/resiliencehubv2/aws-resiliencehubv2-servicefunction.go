...
// ServiceFunction AWS CloudFormation Resource (AWS::ResilienceHubV2::ServiceFunction)
...
func (r *ServiceFunction) AWSCloudFormationType() string {
	return "AWS::ResilienceHubV2::ServiceFunction"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r ServiceFunction) MarshalJSON() ([]byte, error) {
	type Properties ServiceFunction
...
func (r *ServiceFunction) UnmarshalJSON(b []byte) error {
	type Properties ServiceFunction
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = ServiceFunction(*res.Properties)
	}
