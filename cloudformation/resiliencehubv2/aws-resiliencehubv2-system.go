...
// System AWS CloudFormation Resource (AWS::ResilienceHubV2::System)
...
func (r *System) AWSCloudFormationType() string {
	return "AWS::ResilienceHubV2::System"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r System) MarshalJSON() ([]byte, error) {
	type Properties System
...
func (r *System) UnmarshalJSON(b []byte) error {
	type Properties System
	res := &struct {
		Type                string
		Properties          *Properties
