...
type Service struct {
	...
	Assertions []Service_AssertionDefinition `json:"Assertions,omitempty"`

	// AssociatedSystems AWS CloudFormation Property
	// Required: false
	...
	AssociatedSystems []Service_AssociatedSystem `json:"AssociatedSystems,omitempty"`

	// DependencyDiscovery AWS CloudFormation Property
	// Required: false
	...
	// InputSources AWS CloudFormation Property
	// Required: false
	...
	InputSources []Service_InputSourceDefinition `json:"InputSources,omitempty"`
	...
	PermissionModel *Service_PermissionModel `json:"PermissionModel,omitempty"`
	...
	// ReportConfiguration AWS CloudFormation Property
	// Required: false
	...
	ReportConfiguration *Service_ServiceReportConfiguration `json:"ReportConfiguration,omitempty"`
