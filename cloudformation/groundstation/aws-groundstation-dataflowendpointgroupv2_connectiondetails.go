...
// DataflowEndpointGroupV2_ConnectionDetails AWS CloudFormation Resource (AWS::GroundStation::DataflowEndpointGroupV2.ConnectionDetails)
...
type DataflowEndpointGroupV2_ConnectionDetails struct {
	...
	SocketAddress *DataflowEndpointGroupV2_SocketAddress `json:"SocketAddress"`
...
func (r *DataflowEndpointGroupV2_ConnectionDetails) AWSCloudFormationType() string {
	return "AWS::GroundStation::DataflowEndpointGroupV2.ConnectionDetails"
}
