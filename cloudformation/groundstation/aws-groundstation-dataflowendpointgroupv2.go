...
// DataflowEndpointGroupV2 AWS CloudFormation Resource (AWS::GroundStation::DataflowEndpointGroupV2)
...
func (r *DataflowEndpointGroupV2) AWSCloudFormationType() string {
	return "AWS::GroundStation::DataflowEndpointGroupV2"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DataflowEndpointGroupV2) MarshalJSON() ([]byte, error) {
	type Properties DataflowEndpointGroupV2
...
func (r *DataflowEndpointGroupV2) UnmarshalJSON(b []byte) error {
	type Properties DataflowEndpointGroupV2
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DataflowEndpointGroupV2(*res.Properties)
	}
