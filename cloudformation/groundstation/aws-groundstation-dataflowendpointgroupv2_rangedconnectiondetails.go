...
// DataflowEndpointGroupV2_RangedConnectionDetails AWS CloudFormation Resource (AWS::GroundStation::DataflowEndpointGroupV2.RangedConnectionDetails)
...
type DataflowEndpointGroupV2_RangedConnectionDetails struct {
	...
	SocketAddress *DataflowEndpointGroupV2_RangedSocketAddress `json:"SocketAddress"`
...
func (r *DataflowEndpointGroupV2_RangedConnectionDetails) AWSCloudFormationType() string {
	return "AWS::GroundStation::DataflowEndpointGroupV2.RangedConnectionDetails"
}
