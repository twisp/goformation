...
// Membership_MembershipProtectedJobResultConfiguration AWS CloudFormation Resource (AWS::CleanRooms::Membership.MembershipProtectedJobResultConfiguration)
...
type Membership_MembershipProtectedJobResultConfiguration struct {
	...
	OutputConfiguration *Membership_MembershipProtectedJobOutputConfiguration `json:"OutputConfiguration"`
...
func (r *Membership_MembershipProtectedJobResultConfiguration) AWSCloudFormationType() string {
	return "AWS::CleanRooms::Membership.MembershipProtectedJobResultConfiguration"
}
