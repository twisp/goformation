...
// ConfiguredTable_SnowflakeTableSchemaV1 AWS CloudFormation Resource (AWS::CleanRooms::ConfiguredTable.SnowflakeTableSchemaV1)
...
func (r *ConfiguredTable_SnowflakeTableSchemaV1) AWSCloudFormationType() string {
	return "AWS::CleanRooms::ConfiguredTable.SnowflakeTableSchemaV1"
}
