...
// Membership AWS CloudFormation Resource (AWS::CleanRooms::Membership)
...
func (r *Membership) AWSCloudFormationType() string {
	return "AWS::CleanRooms::Membership"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Membership) MarshalJSON() ([]byte, error) {
	type Properties Membership
...
func (r *Membership) UnmarshalJSON(b []byte) error {
	type Properties Membership
	res := &struct {
		Type                string
		Properties          *Properties
