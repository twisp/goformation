...
// ConfiguredTable_GlueTableReference AWS CloudFormation Resource (AWS::CleanRooms::ConfiguredTable.GlueTableReference)
...
func (r *ConfiguredTable_GlueTableReference) AWSCloudFormationType() string {
	return "AWS::CleanRooms::ConfiguredTable.GlueTableReference"
}
