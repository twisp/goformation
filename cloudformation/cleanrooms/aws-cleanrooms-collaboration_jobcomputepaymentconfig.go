...
// Collaboration_JobComputePaymentConfig AWS CloudFormation Resource (AWS::CleanRooms::Collaboration.JobComputePaymentConfig)
...
func (r *Collaboration_JobComputePaymentConfig) AWSCloudFormationType() string {
	return "AWS::CleanRooms::Collaboration.JobComputePaymentConfig"
}
