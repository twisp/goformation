...
// Collaboration AWS CloudFormation Resource (AWS::CleanRooms::Collaboration)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cleanrooms-collaboration.html
type Collaboration struct {

	// AllowedResultRegions AWS CloudFormation Property
	// Required: false
...
func (r *Collaboration) UnmarshalJSON(b []byte) error {
	type Properties Collaboration
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = Collaboration(*res.Properties)
	}
