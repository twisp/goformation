...
// AnalysisTemplate_ErrorMessageConfiguration AWS CloudFormation Resource (AWS::CleanRooms::AnalysisTemplate.ErrorMessageConfiguration)
...
func (r *AnalysisTemplate_ErrorMessageConfiguration) AWSCloudFormationType() string {
	return "AWS::CleanRooms::AnalysisTemplate.ErrorMessageConfiguration"
}
