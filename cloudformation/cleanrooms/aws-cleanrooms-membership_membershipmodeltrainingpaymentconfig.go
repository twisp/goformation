...
// Membership_MembershipModelTrainingPaymentConfig AWS CloudFormation Resource (AWS::CleanRooms::Membership.MembershipModelTrainingPaymentConfig)
...
func (r *Membership_MembershipModelTrainingPaymentConfig) AWSCloudFormationType() string {
	return "AWS::CleanRooms::Membership.MembershipModelTrainingPaymentConfig"
}
