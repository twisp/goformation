...
// Membership_MembershipModelInferencePaymentConfig AWS CloudFormation Resource (AWS::CleanRooms::Membership.MembershipModelInferencePaymentConfig)
...
func (r *Membership_MembershipModelInferencePaymentConfig) AWSCloudFormationType() string {
	return "AWS::CleanRooms::Membership.MembershipModelInferencePaymentConfig"
}
