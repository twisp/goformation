...
// DeliveryStream_DatabaseSourceVPCConfiguration AWS CloudFormation Resource (AWS::KinesisFirehose::DeliveryStream.DatabaseSourceVPCConfiguration)
...
type DeliveryStream_DatabaseSourceVPCConfiguration struct {
	...
	// VpcEndpointServiceName AWS CloudFormation Property
	// Required: true
...
func (r *DeliveryStream_DatabaseSourceVPCConfiguration) AWSCloudFormationType() string {
	return "AWS::KinesisFirehose::DeliveryStream.DatabaseSourceVPCConfiguration"
}
