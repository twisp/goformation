...
// DeliveryStream_PartitionField AWS CloudFormation Resource (AWS::KinesisFirehose::DeliveryStream.PartitionField)
...
func (r *DeliveryStream_PartitionField) AWSCloudFormationType() string {
	return "AWS::KinesisFirehose::DeliveryStream.PartitionField"
}
