...
// DeliveryStream_CatalogConfiguration AWS CloudFormation Resource (AWS::KinesisFirehose::DeliveryStream.CatalogConfiguration)
...
type DeliveryStream_CatalogConfiguration struct {
	...
	// WarehouseLocation AWS CloudFormation Property
	// Required: false
...
func (r *DeliveryStream_CatalogConfiguration) AWSCloudFormationType() string {
	return "AWS::KinesisFirehose::DeliveryStream.CatalogConfiguration"
}
