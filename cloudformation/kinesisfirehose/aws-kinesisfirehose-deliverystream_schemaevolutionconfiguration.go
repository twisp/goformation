...
// DeliveryStream_SchemaEvolutionConfiguration AWS CloudFormation Resource (AWS::KinesisFirehose::DeliveryStream.SchemaEvolutionConfiguration)
...
func (r *DeliveryStream_SchemaEvolutionConfiguration) AWSCloudFormationType() string {
	return "AWS::KinesisFirehose::DeliveryStream.SchemaEvolutionConfiguration"
}
