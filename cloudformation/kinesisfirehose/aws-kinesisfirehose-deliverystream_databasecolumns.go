...
// DeliveryStream_DatabaseColumns AWS CloudFormation Resource (AWS::KinesisFirehose::DeliveryStream.DatabaseColumns)
...
func (r *DeliveryStream_DatabaseColumns) AWSCloudFormationType() string {
	return "AWS::KinesisFirehose::DeliveryStream.DatabaseColumns"
}
