...
// DeliveryStream_DatabaseTables AWS CloudFormation Resource (AWS::KinesisFirehose::DeliveryStream.DatabaseTables)
...
func (r *DeliveryStream_DatabaseTables) AWSCloudFormationType() string {
	return "AWS::KinesisFirehose::DeliveryStream.DatabaseTables"
}
