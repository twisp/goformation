...
// Campaign_ProgressiveConfig AWS CloudFormation Resource (AWS::ConnectCampaignsV2::Campaign.ProgressiveConfig)
...
func (r *Campaign_ProgressiveConfig) AWSCloudFormationType() string {
	return "AWS::ConnectCampaignsV2::Campaign.ProgressiveConfig"
}
