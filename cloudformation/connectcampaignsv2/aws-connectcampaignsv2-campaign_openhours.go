...
// Campaign_OpenHours AWS CloudFormation Resource (AWS::ConnectCampaignsV2::Campaign.OpenHours)
...
type Campaign_OpenHours struct {
	...
	// DailyHours AWS CloudFormation Property
	// Required: true
	...
	DailyHours []Campaign_DailyHour `json:"DailyHours"`
...
func (r *Campaign_OpenHours) AWSCloudFormationType() string {
	return "AWS::ConnectCampaignsV2::Campaign.OpenHours"
}
