...
// Campaign_Schedule AWS CloudFormation Resource (AWS::ConnectCampaignsV2::Campaign.Schedule)
...
type Campaign_Schedule struct {
	...
	// RefreshFrequency AWS CloudFormation Property
	// Required: false
...
func (r *Campaign_Schedule) AWSCloudFormationType() string {
	return "AWS::ConnectCampaignsV2::Campaign.Schedule"
}
