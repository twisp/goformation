...
// Campaign_SmsOutboundConfig AWS CloudFormation Resource (AWS::ConnectCampaignsV2::Campaign.SmsOutboundConfig)
...
func (r *Campaign_SmsOutboundConfig) AWSCloudFormationType() string {
	return "AWS::ConnectCampaignsV2::Campaign.SmsOutboundConfig"
}
