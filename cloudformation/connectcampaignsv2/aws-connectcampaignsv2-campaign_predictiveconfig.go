...
// Campaign_PredictiveConfig AWS CloudFormation Resource (AWS::ConnectCampaignsV2::Campaign.PredictiveConfig)
...
func (r *Campaign_PredictiveConfig) AWSCloudFormationType() string {
	return "AWS::ConnectCampaignsV2::Campaign.PredictiveConfig"
}
