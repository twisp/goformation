...
// Campaign_DailyHour AWS CloudFormation Resource (AWS::ConnectCampaignsV2::Campaign.DailyHour)
...
func (r *Campaign_DailyHour) AWSCloudFormationType() string {
	return "AWS::ConnectCampaignsV2::Campaign.DailyHour"
}
