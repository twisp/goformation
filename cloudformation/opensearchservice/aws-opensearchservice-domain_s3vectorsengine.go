...
// Domain_S3VectorsEngine AWS CloudFormation Resource (AWS::OpenSearchService::Domain.S3VectorsEngine)
...
func (r *Domain_S3VectorsEngine) AWSCloudFormationType() string {
	return "AWS::OpenSearchService::Domain.S3VectorsEngine"
}
