...
// Domain_IAMFederationOptions AWS CloudFormation Resource (AWS::OpenSearchService::Domain.IAMFederationOptions)
...
func (r *Domain_IAMFederationOptions) AWSCloudFormationType() string {
	return "AWS::OpenSearchService::Domain.IAMFederationOptions"
}
