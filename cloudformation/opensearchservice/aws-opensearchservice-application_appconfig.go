...
// Application_AppConfig AWS CloudFormation Resource (AWS::OpenSearchService::Application.AppConfig)
...
func (r *Application_AppConfig) AWSCloudFormationType() string {
	return "AWS::OpenSearchService::Application.AppConfig"
}
