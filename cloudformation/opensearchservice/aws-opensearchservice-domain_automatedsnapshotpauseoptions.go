...
// Domain_AutomatedSnapshotPauseOptions AWS CloudFormation Resource (AWS::OpenSearchService::Domain.AutomatedSnapshotPauseOptions)
...
type Domain_AutomatedSnapshotPauseOptions struct {
...
func (r *Domain_AutomatedSnapshotPauseOptions) AWSCloudFormationType() string {
	return "AWS::OpenSearchService::Domain.AutomatedSnapshotPauseOptions"
}
