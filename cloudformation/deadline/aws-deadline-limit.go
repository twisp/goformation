...
// Limit AWS CloudFormation Resource (AWS::Deadline::Limit)
// See: http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-deadline-limit.html
type Limit struct {

	// AmountRequirementName AWS CloudFormation Property
	// Required: true
	...
	AmountRequirementName string `json:"AmountRequirementName"`
...
func (r *Limit) AWSCloudFormationType() string {
	return "AWS::Deadline::Limit"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r Limit) MarshalJSON() ([]byte, error) {
...
func (r *Limit) UnmarshalJSON(b []byte) error {
	type Properties Limit
	res := &struct {
		Type                string
		Properties          *Properties
