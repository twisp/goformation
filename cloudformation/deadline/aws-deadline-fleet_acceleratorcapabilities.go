...
// Fleet_AcceleratorCapabilities AWS CloudFormation Resource (AWS::Deadline::Fleet.AcceleratorCapabilities)
...
type Fleet_AcceleratorCapabilities struct {
	...
	// Selections AWS CloudFormation Property
	// Required: true
	...
	Selections []Fleet_AcceleratorSelection `json:"Selections"`
...
func (r *Fleet_AcceleratorCapabilities) AWSCloudFormationType() string {
	return "AWS::Deadline::Fleet.AcceleratorCapabilities"
}
