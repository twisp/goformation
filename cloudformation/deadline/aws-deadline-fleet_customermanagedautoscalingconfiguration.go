...
// Fleet_CustomerManagedAutoScalingConfiguration AWS CloudFormation Resource (AWS::Deadline::Fleet.CustomerManagedAutoScalingConfiguration)
...
type Fleet_CustomerManagedAutoScalingConfiguration struct {
...
func (r *Fleet_CustomerManagedAutoScalingConfiguration) AWSCloudFormationType() string {
	return "AWS::Deadline::Fleet.CustomerManagedAutoScalingConfiguration"
}
