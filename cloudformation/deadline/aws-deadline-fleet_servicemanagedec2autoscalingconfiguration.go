...
// Fleet_ServiceManagedEc2AutoScalingConfiguration AWS CloudFormation Resource (AWS::Deadline::Fleet.ServiceManagedEc2AutoScalingConfiguration)
...
type Fleet_ServiceManagedEc2AutoScalingConfiguration struct {

	// ScaleOutWorkersPerMinute AWS CloudFormation Property
	// Required: false
	...
	ScaleOutWorkersPerMinute *int `json:"ScaleOutWorkersPerMinute,omitempty"`

	// StandbyWorkerCount AWS CloudFormation Property
	// Required: false
	...
	StandbyWorkerCount *int `json:"StandbyWorkerCount,omitempty"`

	// WorkerIdleDurationSeconds AWS CloudFormation Property
	// Required: false
	...
	WorkerIdleDurationSeconds *int `json:"WorkerIdleDurationSeconds,omitempty"`
...
func (r *Fleet_ServiceManagedEc2AutoScalingConfiguration) AWSCloudFormationType() string {
	return "AWS::Deadline::Fleet.ServiceManagedEc2AutoScalingConfiguration"
}
