...
// Fleet_HostConfiguration AWS CloudFormation Resource (AWS::Deadline::Fleet.HostConfiguration)
...
type Fleet_HostConfiguration struct {
	...
	// ScriptBody AWS CloudFormation Property
	// Required: true
	...
	// ScriptTimeoutSeconds AWS CloudFormation Property
	// Required: false
...
func (r *Fleet_HostConfiguration) AWSCloudFormationType() string {
	return "AWS::Deadline::Fleet.HostConfiguration"
}
