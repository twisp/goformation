...
// DataProvider_IbmDb2zOsSettings AWS CloudFormation Resource (AWS::DMS::DataProvider.IbmDb2zOsSettings)
...
func (r *DataProvider_IbmDb2zOsSettings) AWSCloudFormationType() string {
	return "AWS::DMS::DataProvider.IbmDb2zOsSettings"
}
