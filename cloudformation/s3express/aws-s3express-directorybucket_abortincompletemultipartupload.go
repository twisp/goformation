...
// DirectoryBucket_AbortIncompleteMultipartUpload AWS CloudFormation Resource (AWS::S3Express::DirectoryBucket.AbortIncompleteMultipartUpload)
...
func (r *DirectoryBucket_AbortIncompleteMultipartUpload) AWSCloudFormationType() string {
	return "AWS::S3Express::DirectoryBucket.AbortIncompleteMultipartUpload"
}
