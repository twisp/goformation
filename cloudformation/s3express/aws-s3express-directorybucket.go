...
// DirectoryBucket AWS CloudFormation Resource (AWS::S3Express::DirectoryBucket)
...
type DirectoryBucket struct {
	...
	// DataRedundancy AWS CloudFormation Property
	// Required: true
...
func (r *DirectoryBucket) AWSCloudFormationType() string {
	return "AWS::S3Express::DirectoryBucket"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r DirectoryBucket) MarshalJSON() ([]byte, error) {
	type Properties DirectoryBucket
...
func (r *DirectoryBucket) UnmarshalJSON(b []byte) error {
	type Properties DirectoryBucket
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = DirectoryBucket(*res.Properties)
	}
