...
type Workspace struct {
	...
	DataResidency *Workspace_DataResidency `json:"DataResidency,omitempty"`
...
func (r *Workspace) AWSCloudFormationType() string {
	return "AWS::AWSExternalAnthropic::Workspace"
}
